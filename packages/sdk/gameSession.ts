...
class GameSession {
  declare static _cacheCardsBy: any;
  ...
  static _buildCachesIfNeeded(systemTime?) {
    ...
    if (
      ...
      const factionsHash = {};
      for (var faction of Array.from<any>(FactionFactory.getAllFactions())) {
      ...
      const cacheRecursive = function (
        ...
        var cache = (cacheInto[cacheByMasterKey] = {
          ...
          getCardById(cardId) {
            ...
            const cardsById = {};
            for (var card of Array.from<any>(this.cards)) {
      ...
      var createSubCache = function (cache, cacheByData, cardsToCache, cacheByRemaining) {
        ...
        // group cards
        for (var card of Array.from<any>(cardsToCache)) {
        ...
        for (var subCacheByData of Array.from<any>(cacheByRemaining)) {
...
var CardSet = require('@duelyst/sdk/cards/cardSetLookup');
var CardSetFactory = require('@duelyst/sdk/cards/cardSetFactory');
var CardType = require('./cards/cardType');
var Cards = require('@duelyst/sdk/cards/cardsLookupComplete');
var FactionFactory = require('@duelyst/sdk/cards/factionFactory');
var Factions = require('@duelyst/sdk/cards/factionsLookup');
var Races = require('@duelyst/sdk/cards/racesLookup');
var Rarity = require('@duelyst/sdk/cards/rarityLookup');
...
class _GameSession extends SDKObject {
  declare aiDifficulty: any;
  declare aiPlayerId: any;
  declare board: any;
  declare cardsByIndex: any;
  declare createdAt: any;
  declare currentTurn: any;
  declare battleMapTemplate: any;
  declare gameId: any;
  declare gameType: any;
  declare gameFormat: any;
  declare index: any;
  declare lastActionTimestamp: any;
  declare modifiersByIndex: any;
  declare players: any;
  declare gameSetupData: any;
  declare status: any;
  declare swapPlayersOnNewTurn: any;
  declare turns: any;
  declare updatedAt: any;
  declare getLocalPlayer: any;
  ...
  constructor() {
    ...
    super(null);
    this._private.gameSession = this;
  ...
  syncState() {
    ...
    for (var modifierIndex of Array.from<any>(modifierIndices)) {
  ...
  _validateGameOverRequest() {
    ...
    if (!this.isOver() && !this.getIsBufferingEvents()) {
      ...
      const deadGenerals = [];
      for (player of Array.from<any>(this.players)) {
  ...
  getPlayerById(playerId) {
    if (playerId != null) {
      for (var player of Array.from<any>(this.players)) {
  ...
  _executeActionForStep(actionToExecute, step) {
    ...
    for (var modifier of Array.from<any>(changedByModifiers)) {
  ...
  p_resolveStep() {
    ...
    if (actionsToResolve.length > 0) {
      ...
      if (this.isNew() && this._getIsActionQueueEmpty()) {
        ...
        for (var p of Array.from<any>(this.players)) {
  ...
  getSteps() {
    ...
    for (var index of Array.from<any>(stepIndices)) {
  ...
  deserializeSessionFromFirebase(sessionData) {
    ...
    if (sessionData.cardsByIndex != null) {
      ...
      for (index of Array.from<any>(cardIndices)) {
    ...
    if (sessionData.turns != null) {
      for (var turnData of Array.from<any>(sessionData.turns)) {
    ...
    for (turn of Array.from<any>(turns)) {
      for (var step of Array.from<any>(turn.getSteps())) {
    ...
    for (var cardIndex of Array.from<any>(this.board.getCardIndices())) {
