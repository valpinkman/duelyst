...
const ModifierReplaceWatchDamageEnemy = require('./modifierReplaceWatchDamageEnemy');
const ModifierReplaceWatchBuffSelf = require('./modifierReplaceWatchBuffSelf');
const ModifierBuffSelfOnReplace = require('./modifierBuffSelfOnReplace');
const ModifierSummonSelfOnReplace = require('./modifierSummonSelfOnReplace');
const ModifierTakeDamageWatchDispel = require('./modifierTakeDamageWatchDispel');
const ModifierTakeDamageWatchPutCardInHand = require('./modifierTakeDamageWatchPutCardInHand');
const ModifierOpeningGambitDrawCardBothPlayers = require('./modifierOpeningGambitDrawCardBothPlayers');
const ModifierSurviveDamageWatchReturnToHand = require('./modifierSurviveDamageWatchReturnToHand');
const ModifierOpeningGambitDamageNearbyForAttack = require('./modifierOpeningGambitDamageNearbyForAttack');
const ModifierMyAttackOrAttackedWatchDrawCard = require('./modifierMyAttackOrAttackedWatchDrawCard');
const ModifierForcefieldAbsorb = require('./modifierForcefieldAbsorb');
const ModifierUnseven = require('./modifierUnseven');
const ModifierDoubleDamageToGenerals = require('./modifierDoubleDamageToGenerals');
const ModifierShadowScar = require('@duelyst/sdk/modifiers/modifierShadowScar');
const ModifierStackingShadowsDebuff = require('@duelyst/sdk/modifiers/modifierStackingShadowsDebuff');
const ModifierEndTurnWatchApplyModifiers = require('@duelyst/sdk/modifiers/modifierEndTurnWatchApplyModifiers');
...
const ModifierCannotMove = require('@duelyst/sdk/modifiers/modifierCannotMove');
const ModifierOpeningGambitDrawRandomBattlePet = require('@duelyst/sdk/modifiers/modifierOpeningGambitDrawRandomBattlePet');
const ModifierDyingWishDamageNearbyEnemies = require('@duelyst/sdk/modifiers/modifierDyingWishDamageNearbyEnemies');
const ModifierDealDamageWatchKillNeutralTarget = require('@duelyst/sdk/modifiers/modifierDealDamageWatchKillNeutralTarget');
const ModifierTakeDamageWatchSpawnRandomBattlePet = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchSpawnRandomBattlePet');
const ModifierDyingWishDrawMechazorCard = require('@duelyst/sdk/modifiers/modifierDyingWishDrawMechazorCard');
const ModifierOpeningGambitApplyModifiersByRaceId = require('@duelyst/sdk/modifiers/modifierOpeningGambitApplyModifiersByRaceId');
const ModifierOpeningGambitApplyModifiersToGeneral = require('@duelyst/sdk/modifiers/modifierOpeningGambitApplyModifiersToGeneral');
const ModifierOpeningGambitDrawCard = require('@duelyst/sdk/modifiers/modifierOpeningGambitDrawCard');
const ModifierEndTurnWatchApplyModifiersRandomly = require('@duelyst/sdk/modifiers/modifierEndTurnWatchApplyModifiersRandomly');
const ModifierBandingChangeCardDraw = require('@duelyst/sdk/modifiers/modifierBandingChangeCardDraw');
const ModifierTakeDamageWatchDamageAllEnemies = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchDamageAllEnemies');
const ModifierDyingWishXho = require('@duelyst/sdk/modifiers/modifierDyingWishXho');
const ModifierDyingWishDrawRandomBattlePet = require('@duelyst/sdk/modifiers/modifierDyingWishDrawRandomBattlePet');
const ModifierAnyDrawCardWatchBuffSelf = require('@duelyst/sdk/modifiers/modifierAnyDrawCardWatchBuffSelf');
const ModifierTakeDamageWatchDestroy = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchDestroy');
const ModifierDyingWishSpawnRandomEntity = require('@duelyst/sdk/modifiers/modifierDyingWishSpawnRandomEntity');
const ModifierTakeDamageWatchSpawnEntity = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchSpawnEntity');
const ModifierPantheran = require('@duelyst/sdk/modifiers/modifierPantheran');
const ModifierEndTurnWatchSwapAllegiance = require('@duelyst/sdk/modifiers/modifierEndTurnWatchSwapAllegiance');
const ModifierDyingWishCorpseCombustion = require('@duelyst/sdk/modifiers/modifierDyingWishCorpseCombustion');
const ModifierOpeningGambitApplyModifiersToWraithlings = require('@duelyst/sdk/modifiers/modifierOpeningGambitApplyModifiersToWraithlings');
const ModifierInkhornGaze = require('@duelyst/sdk/modifiers/modifierInkhornGaze');
const ModifierDeathWatchBuffRandomMinionInHand = require('@duelyst/sdk/modifiers/modifierDeathWatchBuffRandomMinionInHand');
const ModifierOpeningGambitHatchFriendlyEggs = require('@duelyst/sdk/modifiers/modifierOpeningGambitHatchFriendlyEggs');
const ModifierGrowOnBothTurns = require('@duelyst/sdk/modifiers/modifierGrowOnBothTurns');
const ModifierSummonWatchFromEggApplyModifiers = require('@duelyst/sdk/modifiers/modifierSummonWatchFromEggApplyModifiers');
const ModifierAnySummonWatchFromActionBarApplyModifiersToSelf = require('@duelyst/sdk/modifiers/modifierAnySummonWatchFromActionBarApplyModifiersToSelf');
const ModifierSnowRippler = require('@duelyst/sdk/modifiers/modifierSnowRippler');
const ModifierSurviveDamageWatchBur = require('@duelyst/sdk/modifiers/modifierSurviveDamageWatchBur');
const ModifierSummonWatchByRaceHealToFull = require('@duelyst/sdk/modifiers/modifierSummonWatchByRaceHealToFull');
const ModifierSummonWatchByCardBuffTarget = require('@duelyst/sdk/modifiers/modifierSummonWatchByCardBuffTarget');
const ModifierOpeningGambitDamageEnemiesNearShadowCreep = require('@duelyst/sdk/modifiers/modifierOpeningGambitDamageEnemiesNearShadowCreep');
const ModifierMyAttackOrAttackedWatchSpawnMinionNearby = require('@duelyst/sdk/modifiers/modifierMyAttackOrAttackedWatchSpawnMinionNearby');
const ModifierSummonWatchDreadnaught = require('@duelyst/sdk/modifiers/modifierSummonWatchDreadnaught');
const ModifierReplaceWatchSpawnEntity = require('@duelyst/sdk/modifiers/modifierReplaceWatchSpawnEntity');
const ModifierDynamicCountModifySelfCostByBattlePetsOnBoard = require('@duelyst/sdk/modifiers/modifierDynamicCountModifySelfCostByBattlePetsOnBoard');
const ModifierApplyMinionToBoardWatchApplyModifiersToTarget = require('@duelyst/sdk/modifiers/modifierApplyMinionToBoardWatchApplyModifiersToTarget');
const ModifierKillWatchSpawnEnemyEntity = require('@duelyst/sdk/modifiers/modifierKillWatchSpawnEnemyEntity');
const ModifierEndEveryTurnWatchDamageOwner = require('@duelyst/sdk/modifiers/modifierEndEveryTurnWatchDamageOwner');
const ModifierMyTeamMoveWatchAnyReason = require('@duelyst/sdk/modifiers/modifierMyTeamMoveWatchAnyReason');
const ModifierMyTeamMoveWatchAnyReasonBuffTarget = require('@duelyst/sdk/modifiers/modifierMyTeamMoveWatchAnyReasonBuffTarget');
const ModifierEndTurnWatchRefreshArtifacts = require('@duelyst/sdk/modifiers/modifierEndTurnWatchRefreshArtifacts');
const ModifierGainAttackWatchBuffSelfBySameThisTurn = require('@duelyst/sdk/modifiers/modifierGainAttackWatchBuffSelfBySameThisTurn');
const ModifierInquisitorKron = require('@duelyst/sdk/modifiers/modifierInquisitorKron');
const ModifierTakeDamageWatchSpawnShadowCreep = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchSpawnShadowCreep');
const ModifierDyingWishApplyModifiersRandomly = require('@duelyst/sdk/modifiers/modifierDyingWishApplyModifiersRandomly');
const ModifierOpeningGambitBuffSelfByBattlePetsHandStats = require('@duelyst/sdk/modifiers/modifierOpeningGambitBuffSelfByBattlePetsHandStats');
const ModifierHealWatchBuffGeneral = require('@duelyst/sdk/modifiers/modifierHealWatchBuffGeneral');
const ModifierDealDamageWatchHatchEggs = require('@duelyst/sdk/modifiers/modifierDealDamageWatchHatchEggs');
const ModifierDyingWishDispelNearestEnemy = require('@duelyst/sdk/modifiers/modifierDyingWishDispelNearestEnemy');
const ModifierSpawnedFromEgg = require('@duelyst/sdk/modifiers/modifierSpawnedFromEgg');
const ModifierTamedBattlePet = require('@duelyst/sdk/modifiers/modifierTamedBattlePet');
const ModifierFriendlyDeathWatchForBattlePetDrawCard = require('@duelyst/sdk/modifiers/modifierFriendlyDeathWatchForBattlePetDrawCard');
const ModifierDyingWishSpawnTileAnywhere = require('@duelyst/sdk/modifiers/modifierDyingWishSpawnTileAnywhere');
...
const ModifierMyAttackWatchGetSonghaiSpells = require('@duelyst/sdk/modifiers/modifierMyAttackWatchGetSonghaiSpells');
const ModifierBondSpawnEntity = require('@duelyst/sdk/modifiers/modifierBondSpawnEntity');
const ModifierHealWatchDamageRandomEnemy = require('@duelyst/sdk/modifiers/modifierHealWatchDamageRandomEnemy');
const ModifierOpeningGambitSirocco = require('@duelyst/sdk/modifiers/modifierOpeningGambitSirocco');
const ModifierBondNightshroud = require('@duelyst/sdk/modifiers/modifierBondNightshroud');
const ModifierSpellWatchPutCardInHand = require('@duelyst/sdk/modifiers/modifierSpellWatchPutCardInHand');
const ModifierNocturne = require('@duelyst/sdk/modifiers/modifierNocturne');
const ModifierOpeningGambitDeathKnell = require('@duelyst/sdk/modifiers/modifierOpeningGambitDeathKnell');
const ModifierBondHealMyGeneral = require('@duelyst/sdk/modifiers/modifierBondHealMyGeneral');
const ModifierTakeDamageWatchJuggernaut = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchJuggernaut');
let ModifierKillWatchSpawnCopyNearby = require('@duelyst/sdk/modifiers/modifierKillWatchSpawnCopyNearby');
const ModifierOnRemoveSpawnRandomDeadEntity = require('@duelyst/sdk/modifiers/modifierOnRemoveSpawnRandomDeadEntity');
const ModifierGrowPermanent = require('@duelyst/sdk/modifiers/modifierGrowPermanent');
const ModifierShatteringHeart = require('@duelyst/sdk/modifiers/modifierShatteringHeart');
const ModifierOpeningGambitEquipArtifact = require('@duelyst/sdk/modifiers/modifierOpeningGambitEquipArtifact');
const ModifierFeralu = require('@duelyst/sdk/modifiers/modifierFeralu');
ModifierKillWatchSpawnCopyNearby = require('@duelyst/sdk/modifiers/modifierKillWatchSpawnCopyNearby');
const ModifierDispelAreaAttack = require('@duelyst/sdk/modifiers/modifierDispelAreaAttack');
const ModifierSelfDamageAreaAttack = require('@duelyst/sdk/modifiers/modifierSelfDamageAreaAttack');
let ModifierSummonWatchAnyPlayer = require('@duelyst/sdk/modifiers/modifierSummonWatchAnyPlayer');
const ModifierSummonWatchAnyPlayerApplyModifiers = require('@duelyst/sdk/modifiers/modifierSummonWatchAnyPlayerApplyModifiers');
const ModifierSummonWatchNearbyAnyPlayerApplyModifiers = require('@duelyst/sdk/modifiers/modifierSummonWatchNearbyAnyPlayerApplyModifiers');
const ModifierOpponentSummonWatchOpponentDrawCard = require('@duelyst/sdk/modifiers/modifierOpponentSummonWatchOpponentDrawCard');
const ModifierOpponentDrawCardWatchOverdrawSummonEntity = require('@duelyst/sdk/modifiers/modifierOpponentDrawCardWatchOverdrawSummonEntity');
const ModifierEndTurnWatchDamagePlayerBasedOnRemainingMana = require('@duelyst/sdk/modifiers/modifierEndTurnWatchDamagePlayerBasedOnRemainingMana');
const ModifierHPChange = require('@duelyst/sdk/modifiers/modifierHPChange');
const ModifierHPThresholdGainModifiers = require('@duelyst/sdk/modifiers/modifierHPThresholdGainModifiers');
const ModifierExtraDamageOnCounterattack = require('@duelyst/sdk/modifiers/modifierExtraDamageOnCounterattack');
const ModifierOnOpponentDeathWatch = require('@duelyst/sdk/modifiers/modifierOnOpponentDeathWatch');
const ModifierOnOpponentDeathWatchSpawnEntityOnSpace = require('@duelyst/sdk/modifiers/modifierOnOpponentDeathWatchSpawnEntityOnSpace');
const ModifierDyingWishSpawnEgg = require('@duelyst/sdk/modifiers/modifierDyingWishSpawnEgg');
const ModifierSummonWatchFromActionBarApplyModifiers = require('@duelyst/sdk/modifiers/modifierSummonWatchFromActionBarApplyModifiers');
const ModifierTakeDamageWatchSpawnWraithlings = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchSpawnWraithlings');
const ModifierTakeDamageWatchDamageAttacker = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchDamageAttacker');
const ModifierStartTurnWatchTeleportRandomSpace = require('@duelyst/sdk/modifiers/modifierStartTurnWatchTeleportRandomSpace');
const ModifierSummonWatchFromActionBarAnyPlayerApplyModifiers = require('@duelyst/sdk/modifiers/modifierSummonWatchFromActionBarAnyPlayerApplyModifiers');
const ModifierSummonWatchFromActionBarAnyPlayer = require('@duelyst/sdk/modifiers/modifierSummonWatchFromActionBarAnyPlayer');
const ModifierStartTurnWatchDamageGeneralEqualToMinionsOwned = require('@duelyst/sdk/modifiers/modifierStartTurnWatchDamageGeneralEqualToMinionsOwned');
const ModifierHPChangeSummonEntity = require('@duelyst/sdk/modifiers/modifierHPChangeSummonEntity');
const ModifierStartTurnWatchDamageAndBuffSelf = require('@duelyst/sdk/modifiers/modifierStartTurnWatchDamageAndBuffSelf');
const ModifierEnemyTeamMoveWatch = require('@duelyst/sdk/modifiers/modifierEnemyTeamMoveWatch');
const ModifierEnemyTeamMoveWatchSummonEntityBehind = require('@duelyst/sdk/modifiers/modifierEnemyTeamMoveWatchSummonEntityBehind');
const ModifierDyingWishLoseGame = require('@duelyst/sdk/modifiers/modifierDyingWishLoseGame');
const ModifierAttacksDamageAllEnemyMinions = require('@duelyst/sdk/modifiers/modifierAttacksDamageAllEnemyMinions');
const ModifierATKThresholdDie = require('@duelyst/sdk/modifiers/modifierATKThresholdDie');
...
const PlayerModifierAncestralPact = require('@duelyst/sdk/playerModifiers/playerModifierAncestralPact');
const PlayerModifierMechazorBuildProgress = require('@duelyst/sdk/playerModifiers/playerModifierMechazorBuildProgress');
const PlayerModifierMechazorSummoned = require('@duelyst/sdk/playerModifiers/playerModifierMechazorSummoned');
const PlayerModifierSpellDamageModifier = require('@duelyst/sdk/playerModifiers/playerModifierSpellDamageModifier');
const PlayerModifierDamageNextUnitPlayedFromHand = require('@duelyst/sdk/playerModifiers/playerModifierDamageNextUnitPlayedFromHand');
const PlayerModifierCardDrawModifier = require('@duelyst/sdk/playerModifiers/playerModifierCardDrawModifier');
const PlayerModiferCanSummonAnywhere = require('@duelyst/sdk/playerModifiers/playerModiferCanSummonAnywhere');
const PlayerModifierSummonWatchApplyModifiers = require('@duelyst/sdk/playerModifiers/playerModifierSummonWatchApplyModifiers');
const PlayerModifierReplaceCardModifier = require('@duelyst/sdk/playerModifiers/playerModifierReplaceCardModifier');
const PlayerModifierEndTurnRespawnEntityWithBuff = require('@duelyst/sdk/playerModifiers/playerModifierEndTurnRespawnEntityWithBuff');
const PlayerModifierPreventSpellDamage = require('@duelyst/sdk/playerModifiers/playerModifierPreventSpellDamage');
const PlayerModifierManaModifierOncePerTurn = require('@duelyst/sdk/playerModifiers/playerModifierManaModifierOncePerTurn');
const PlayerModifierMyDeathwatchDrawCard = require('@duelyst/sdk/playerModifiers/playerModifierMyDeathwatchDrawCard');
const PlayerModifierBattlePetManager = require('@duelyst/sdk/playerModifiers/playerModifierBattlePetManager');
const PlayerModifierCannotReplace = require('@duelyst/sdk/playerModifiers/playerModifierCannotReplace');
const PlayerModifierChangeSignatureCard = require('@duelyst/sdk/playerModifiers/playerModifierChangeSignatureCard');
const PlayerModifierSignatureCardAlwaysReady = require('@duelyst/sdk/playerModifiers/playerModifierSignatureCardAlwaysReady');
const PlayerModifierManaModifierNextCard = require('@duelyst/sdk/playerModifiers/playerModifierManaModifierNextCard');
const PlayerModifierFlashReincarnation = require('@duelyst/sdk/playerModifiers/playerModifierFlashReincarnation');
const PlayerModifierFriendlyAttackWatch = require('@duelyst/sdk/playerModifiers/playerModifierFriendlyAttackWatch');
const PlayerModifierSummonWatch = require('@duelyst/sdk/playerModifiers/playerModifierSummonWatch');
const PlayerModifierSummonWatchIfFlyingDrawFlyingMinion = require('@duelyst/sdk/playerModifiers/playerModifierSummonWatchIfFlyingDrawFlyingMinion');
const PlayerModifierOpponentSummonWatch = require('@duelyst/sdk/playerModifiers/playerModifierOpponentSummonWatch');
const PlayerModifierOpponentSummonWatchSwapGeneral = require('@duelyst/sdk/playerModifiers/playerModifierOpponentSummonWatchSwapGeneral');
const PlayerModifierSummonWatchFromActionBar = require('@duelyst/sdk/playerModifiers/playerModifierSummonWatchFromActionBar');
...
const PlayerModifierTeamAlwaysBackstabbed = require('@duelyst/sdk/playerModifiers/playerModifierTeamAlwaysBackstabbed');
const PlayerModifierEmblem = require('@duelyst/sdk/playerModifiers/playerModifierEmblem');
const PlayerModifierEmblemSummonWatch = require('@duelyst/sdk/playerModifiers/playerModifierEmblemSummonWatch');
const PlayerModifierEmblemSummonWatchSingletonQuest = require('@duelyst/sdk/playerModifiers/playerModifierEmblemSummonWatchSingletonQuest');
const PlayerModifierEmblemEndTurnWatch = require('@duelyst/sdk/playerModifiers/playerModifierEmblemEndTurnWatch');
const PlayerModifierEmblemEndTurnWatchLyonarSmallMinionQuest = require('@duelyst/sdk/playerModifiers/playerModifierEmblemEndTurnWatchLyonarSmallMinionQuest');
const PlayerModifierSpellWatch = require('@duelyst/sdk/playerModifiers/playerModifierSpellWatch');
const PlayerModifierSpellWatchHollowVortex = require('@duelyst/sdk/playerModifiers/playerModifierSpellWatchHollowVortex');
...
const PlayerModifierEmblemSituationalVetQuestFrenzy = require('@duelyst/sdk/playerModifiers/playerModifierEmblemSituationalVetQuestFrenzy');
const PlayerModifierEmblemSituationalVetQuestFlying = require('@duelyst/sdk/playerModifiers/playerModifierEmblemSituationalVetQuestFlying');
const PlayerModifierEmblemSituationalVetQuestCelerity = require('@duelyst/sdk/playerModifiers/playerModifierEmblemSituationalVetQuestCelerity');
const PlayerModifierEndTurnWatchRevertBBS = require('@duelyst/sdk/playerModifiers/playerModifierEndTurnWatchRevertBBS');
const PlayerModifierEmblemSummonWatchFromHandMagmarBuffQuest = require('@duelyst/sdk/playerModifiers/playerModifierEmblemSummonWatchFromHandMagmarBuffQuest');
const PlayerModifierEmblemSummonWatchSonghaiMeltdownQuest = require('@duelyst/sdk/playerModifiers/playerModifierEmblemSummonWatchSonghaiMeltdownQuest');
const PlayerModifierEmblemSummonWatchAbyssUndyingQuest = require('@duelyst/sdk/playerModifiers/playerModifierEmblemSummonWatchAbyssUndyingQuest');
const PlayerModifierEmblemGainMinionOrLoseControlWatch = require('@duelyst/sdk/playerModifiers/playerModifierEmblemGainMinionOrLoseControlWatch');

const GameSessionModifier = require('@duelyst/sdk/gameSessionModifiers/gameSessionModifier');
const GameSessionModifierFestiveSpirit = require('@duelyst/sdk/gameSessionModifiers/gameSessionModifierFestiveSpirit');
