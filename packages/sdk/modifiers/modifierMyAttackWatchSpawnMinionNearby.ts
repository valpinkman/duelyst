...
class ModifierMyAttackWatchSpawnMinionNearby extends ModifierMyAttackWatch {
  ...
  static type = 'ModifierMyAttackWatchSpawnMinionNearby';
  static modifierName = 'Attack Watch and Spawn Minion';
  static description = 'Whenever this minion attacks, summon %X nearby';
  ...
  onMyAttackWatch(action) {
    ...
    if (this.getGameSession().getIsRunningAsAuthoritative()) {
      ...
      const spawnPositions = UtilsGameSession.getRandomNonConflictingSmartSpawnPositionsForModifier(
        this,
        ModifierMyAttackWatchSpawnMinionNearby,
      );
      return (() => {
        const result = [];
...
ModifierMyAttackWatchSpawnMinionNearby.prototype.type = 'ModifierMyAttackWatchSpawnMinionNearby';
ModifierMyAttackWatchSpawnMinionNearby.prototype.fxResource = ['FX.Modifiers.ModifierGenericSpawn'];
ModifierMyAttackWatchSpawnMinionNearby.prototype.cardDataOrIndexToSpawn = null;
