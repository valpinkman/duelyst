...
const ModifierUntargetable = require('@duelyst/sdk/modifiers/modifierUntargetable');
const ModifierObstructing = require('@duelyst/sdk/modifiers/modifierObstructing');
const ModifierProvoked = require('@duelyst/sdk/modifiers/modifierProvoked');
const ModifierCustomSpawn = require('@duelyst/sdk/modifiers/modifierCustomSpawn');
...
const ModifierRangedProvoked = require('@duelyst/sdk/modifiers/modifierRangedProvoked');
...
class Entity extends Card {
  ...
  declare isGeneral: any;
  declare isObstructing: any;
  declare isTargetable: any;
  declare lastDmg: any;
  declare lastHeal: any;
  declare maxHP: any;
  declare moves: any;
  declare movesMade: any;
  declare reach: any;
  declare speed: any;
  declare wasGeneral: any;
  declare signatureCardData: any;
