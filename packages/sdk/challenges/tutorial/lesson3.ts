...
class LessonThree extends Challenge {
  ...
  setupOpponentAgent(gameSession) {
    ...
    this._opponentAgent.addActionForTurn(
      0,
      AgentActions.createAgentActionPlayCard(0, { x: 1, y: 1 }),
    );
    this._opponentAgent.addActionForTurn(
      0,
    ...
    this._opponentAgent.addActionForTurn(
      0,
      AgentActions.createAgentSoftActionTagUnitAtPosition('valuehunter', { x: 1, y: 1 }),
    );
    ...
    this._opponentAgent.addActionForTurn(
      1,
      AgentActions.createAgentActionPlayCard(1, { x: 4, y: 2 }),
    );
    this._opponentAgent.addActionForTurn(
      1,
      AgentActions.createAgentActionAttackWithUnit('valuehunter', { x: 6, y: 2 }, true),
    );
    this._opponentAgent.addActionForTurn(
      1,
      AgentActions.createAgentSoftActionShowInstructionLabels([
    ...
    this._opponentAgent.addActionForTurn(
      2,
      AgentActions.createAgentActionAttackWithUnit('general', { x: 1, y: 0 }, false),
    );
    this._opponentAgent.addActionForTurn(
      2,
      AgentActions.createAgentActionAttackWithUnit('valuehunter', { x: 5, y: 3 }, true),
    );
    this._opponentAgent.addActionForTurn(
      2,
      AgentActions.createAgentSoftActionShowInstructionLabels([
    ...
    this._opponentAgent.addActionForTurn(
      2,
      AgentActions.createAgentActionPlayCard(2, { x: 4, y: 2 }),
    );
    this._opponentAgent.addActionForTurn(
      2,
      AgentActions.createAgentSoftActionTagUnitAtPosition('provoker', { x: 4, y: 2 }),
    );
    ...
    this._opponentAgent.addActionForTurn(
      3,
      AgentActions.createAgentActionAttackWithUnit('general', { x: 0, y: -1 }, false),
    );
    this._opponentAgent.addActionForTurn(
      3,
      AgentActions.createAgentSoftActionShowInstructionLabels([
    ...
    this._opponentAgent.addActionForTurn(
      3,
      AgentActions.createAgentActionPlayCard(3, { x: 4, y: 4 }),
    );
    this._opponentAgent.addActionForTurn(
      3,
      AgentActions.createAgentActionPlayCard(4, { x: 6, y: 3 }),
    );
    this._opponentAgent.addActionForTurn(
      3,
      AgentActions.createAgentSoftActionTagUnitAtPosition('provoker2', { x: 6, y: 3 }),
    );
    this._opponentAgent.addActionForTurn(
      3,
      AgentActions.createAgentActionMoveUnit('provoker', { x: 2, y: 0 }),
    );
    this._opponentAgent.addActionForTurn(
      3,
      AgentActions.createAgentSoftActionShowInstructionLabels([
    ...
    return this._opponentAgent.addActionForTurn(
      4,
      AgentActions.createAgentActionAttackWithUnit('provoker2', { x: 1, y: 0 }, false),
    );
  }
}
