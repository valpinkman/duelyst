...
class LessonOne extends Challenge {
  ...
  setupOpponentAgent(gameSession) {
    ...
    this._opponentAgent.addActionForTurn(
      0,
      AgentActions.createAgentActionPlayCard(0, { x: 6, y: 1 }),
    );
    this._opponentAgent.addActionForTurn(
      0,
      AgentActions.createAgentSoftActionTagUnitAtPosition('golem', { x: 6, y: 1 }),
    );

    // turn 2
    this._opponentAgent.addActionForTurn(
      1,
      AgentActions.createAgentActionAttackWithUnit('golem', { x: -1, y: 0 }, false),
    );
    this._opponentAgent.addActionForTurn(
      1,
      AgentActions.createAgentSoftActionShowInstructionLabels([
    ...
    this._opponentAgent.addActionForTurn(
      1,
      AgentActions.createAgentActionPlayCard(1, { x: 5, y: 1 }),
    );
    this._opponentAgent.addActionForTurn(
      1,
      AgentActions.createAgentSoftActionTagUnitAtPosition('tutorialLion', { x: 5, y: 1 }),
    );
    ...
    this._opponentAgent.addActionForTurn(
      2,
      AgentActions.createAgentActionPlayCard(2, { x: 7, y: 1 }),
    );
    ...
    return this._opponentAgent.addActionForTurn(
      3,
      AgentActions.createAgentActionPlayCardFindPosition(3, () => [
...
LessonOne.prototype.otkChallengeFailureMessages = [i18next.t('tutorial.lesson_1_failure_message')];
