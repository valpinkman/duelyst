...
const SpellCrimsonCoil = require('@duelyst/sdk/spells/spellCrimsonCoil');
const SpellShadowWaltz = require('@duelyst/sdk/spells/spellShadowWaltz');
const SpellMirrorMeld = require('@duelyst/sdk/spells/spellMirrorMeld');
const SpellKoanOfHorns = require('@duelyst/sdk/spells/spellKoanOfHorns');
