...
const SpellRazorSkin = require('@duelyst/sdk/spells/spellRazorSkin');
const SpellLavaLance = require('@duelyst/sdk/spells/spellLavaLance');
const SpellNaturesConfluence = require('@duelyst/sdk/spells/spellNaturesConfluence');
const SpellFlamingStampede = require('@duelyst/sdk/spells/spellFlamingStampede');
...
const ModifierRemoveAndReplaceEntity = require('@duelyst/sdk/modifiers/modifierRemoveAndReplaceEntity');
