...
const SpellAstralFlood = require('@duelyst/sdk/spells/spellAstralFlood');
const SpellWhisperOfTheSands = require('@duelyst/sdk/spells/spellWhisperOfTheSands');
const SpellPsychicConduit = require('@duelyst/sdk/spells/spellPsychicConduit');
const SpellCircleOfDesiccation = require('@duelyst/sdk/spells/spellCircleOfDesiccation');
const SpellCorpseCombustion = require('@duelyst/sdk/spells/spellCorpseCombustion');
...
const ModifierPortal = require('@duelyst/sdk/modifiers/modifierPortal');
const ModifierDyingWishSpawnEntity = require('@duelyst/sdk/modifiers/modifierDyingWishSpawnEntity');
const ModifierStartTurnWatchSummonDervish = require('@duelyst/sdk/modifiers/modifierStartTurnWatchSummonDervish');
let ModifierOpeningGambitApplyModifiersRandomly = require('@duelyst/sdk/modifiers/modifierOpeningGambitApplyModifiersRandomly');
let ModifierImmuneToSpellDamage = require('@duelyst/sdk/modifiers/modifierImmuneToSpellDamage');
let ModifierSummonWatchFromActionBarByOpeningGambitBuffSelf = require('@duelyst/sdk/modifiers/modifierSummonWatchFromActionBarByOpeningGambitBuffSelf');
ModifierSummonWatchFromActionBarByOpeningGambitBuffSelf = require('@duelyst/sdk/modifiers/modifierSummonWatchFromActionBarByOpeningGambitBuffSelf');
ModifierOpeningGambitApplyModifiersRandomly = require('@duelyst/sdk/modifiers/modifierOpeningGambitApplyModifiersRandomly');
ModifierImmuneToSpellDamage = require('@duelyst/sdk/modifiers/modifierImmuneToSpellDamage');
const ModifierOpeningGambitApplyModifiersToHand = require('@duelyst/sdk/modifiers/modifierOpeningGambitApplyModifiersToHand');
