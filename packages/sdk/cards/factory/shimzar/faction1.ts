...
const SpellSkyBurial = require('@duelyst/sdk/spells/spellSkyBurial');
const SpellFightingSpirit = require('@duelyst/sdk/spells/spellFightingSpirit');
const SpellLucentBeam = require('@duelyst/sdk/spells/spellLucentBeam');
const SpellAfterblaze = require('@duelyst/sdk/spells/spellAfterblaze');
