...
const SpellWailingOverdrive = require('@duelyst/sdk/spells/spellWailingOverdrive');
const SpellVespyricCall = require('@duelyst/sdk/spells/spellVespyricCall');
const SpellLightningBlitz = require('@duelyst/sdk/spells/spellLightningBlitz');
const SpellWintersWake = require('@duelyst/sdk/spells/spellWintersWake');
const SpellAlteredBeast = require('@duelyst/sdk/spells/spellAlteredBeast');
