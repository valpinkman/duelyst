...
const SpellGotatsu = require('@duelyst/sdk/spells/spellGotatsu');
const SpellRefreshFriendlyRanged = require('@duelyst/sdk/spells/spellRefreshFriendlyRanged');
const SpellTeleportGeneralBehindEnemy = require('@duelyst/sdk/spells/spellTeleportGeneralBehindEnemy');
const SpellZodiacTriad = require('@duelyst/sdk/spells/spellZodiacTriad');
const SpellFirestormOfAgony = require('@duelyst/sdk/spells/spellFirestormOfAgony');
const SpellSpiralCounter = require('@duelyst/sdk/spells/spellSpiralCounter');

const Modifier = require('@duelyst/sdk/modifiers/modifier');
const ModifierEndTurnWatchTransformNearbyEnemies = require('@duelyst/sdk/modifiers/modifierEndTurnWatchTransformNearbyEnemies');
const ModifierBackstabWatchStealSpellFromDeck = require('@duelyst/sdk/modifiers/modifierBackstabWatchStealSpellFromDeck');
...
const ModifierSentinelOpponentSummonDamageIt = require('@duelyst/sdk/modifiers/modifierSentinelOpponentSummonDamageIt');
...
const ModifierMyMoveWatchAnyReasonDamageNearbyEnemyMinions = require('@duelyst/sdk/modifiers/modifierMyMoveWatchAnyReasonDamageNearbyEnemyMinions');
