...
const ModifierOpeningGambitSpawnEnemyMinionNearOpponent = require('@duelyst/sdk/modifiers/modifierOpeningGambitSpawnEnemyMinionNearOpponent');
const ModifierFlying = require('@duelyst/sdk/modifiers/modifierFlying');
const ModifierEnemySpellWatchCopySpell = require('@duelyst/sdk/modifiers/modifierEnemySpellWatchCopySpell');
const ModifierOpeningGambitPutCardInHand = require('@duelyst/sdk/modifiers/modifierOpeningGambitPutCardInHand');
const ModifierImmuneToAttacks = require('@duelyst/sdk/modifiers/modifierImmuneToAttacks');
const ModifierOpeningGambitRemoveArtifactToDrawArtifactFromFaction = require('@duelyst/sdk/modifiers/modifierOpeningGambitRemoveArtifactToDrawArtifactFromFaction');
const ModifierFrenzy = require('@duelyst/sdk/modifiers/modifierFrenzy');
const ModifierWildTahr = require('@duelyst/sdk/modifiers/modifierWildTahr');
const ModifierCannotCastSpellsByCost = require('@duelyst/sdk/modifiers/modifierCannotCastSpellsByCost');
const ModifierKillWatchBounceEnemyToActionBar = require('@duelyst/sdk/modifiers/modifierKillWatchBounceEnemyToActionBar');
const ModifierRanged = require('@duelyst/sdk/modifiers/modifierRanged');
const ModifierMyGeneralAttackWatchSpawnEntity = require('@duelyst/sdk/modifiers/modifierMyGeneralAttackWatchSpawnEntity');
const ModifierFirstBlood = require('@duelyst/sdk/modifiers/modifierFirstBlood');
const ModifierOpeningGambitReplaceHand = require('@duelyst/sdk/modifiers/modifierOpeningGambitReplaceHand');
const ModifierDealDamageWatchDamageJoinedEnemies = require('@duelyst/sdk/modifiers/modifierDealDamageWatchDamageJoinedEnemies');
const ModifierOpeningGambitSpawnPartyAnimals = require('@duelyst/sdk/modifiers/modifierOpeningGambitSpawnPartyAnimals');
const ModifierDealDamageWatchIfMinionHealMyGeneral = require('@duelyst/sdk/modifiers/modifierDealDamageWatchIfMinionHealMyGeneral');
const ModifierSprigginDiesBuffSelf = require('@duelyst/sdk/modifiers/modifierSprigginDiesBuffSelf');
const ModifierSituationalBuffSelfIfSpriggin = require('@duelyst/sdk/modifiers/modifierSituationalBuffSelfIfSpriggin');
const ModifierCustomSpawnOnOtherUnit = require('@duelyst/sdk/modifiers/modifierCustomSpawnOnOtherUnit');
const ModifierOpeningGambitDagona = require('@duelyst/sdk/modifiers/modifierOpeningGambitDagona');
const ModifierDyingWishDagona = require('@duelyst/sdk/modifiers/modifierDyingWishDagona');
const ModifierMyAttackWatchGamble = require('@duelyst/sdk/modifiers/modifierMyAttackWatchGamble');
