...
const SpellInklingSurge = require('@duelyst/sdk/spells/spellInklingSurge');
const SpellShadows = require('@duelyst/sdk/spells/spellShadows');
const SpellApplyModifiersToGeneral = require('@duelyst/sdk/spells/spellApplyModifiersToGeneral');
const SpellRequireUnoccupiedFriendlyCreep = require('@duelyst/sdk/spells/spellRequireUnoccupiedFriendlyCreep');
const SpellKillEnemyOnFriendlyCreep = require('@duelyst/sdk/spells/spellKillEnemyOnFriendlyCreep');
const SpellCurseOfShadows = require('@duelyst/sdk/spells/spellCurseOfShadows');

const Modifier = require('@duelyst/sdk/modifiers/modifier');
const ModifierOpponentSummonWatchBuffMinionInHand = require('@duelyst/sdk/modifiers/modifierOpponentSummonWatchBuffMinionInHand');
const ModifierDyingWishDrawMinionsWithDyingWish = require('@duelyst/sdk/modifiers/modifierDyingWishDrawMinionsWithDyingWish');
const ModifierDealDamageWatchControlEnemyMinionUntilEOT = require('@duelyst/sdk/modifiers/modifierDealDamageWatchControlEnemyMinionUntilEOT');
const ModifierOpeningGambitStealEnemyGeneralHealth = require('@duelyst/sdk/modifiers/modifierOpeningGambitStealEnemyGeneralHealth');
const ModifierDoomed3 = require('@duelyst/sdk/modifiers/modifierDoomed3');
const ModifierSentinelSetup = require('@duelyst/sdk/modifiers/modifierSentinelSetup');
const ModifierSentinelOpponentGeneralAttack = require('@duelyst/sdk/modifiers/modifierSentinelOpponentGeneralAttack');
const ModifierCardControlledPlayerModifiers = require('@duelyst/sdk/modifiers/modifierCardControlledPlayerModifiers');
const ModifierSentinelOpponentSummonCopyIt = require('@duelyst/sdk/modifiers/modifierSentinelOpponentSummonCopyIt');
const ModifierSentinelOpponentSpellCast = require('@duelyst/sdk/modifiers/modifierSentinelOpponentSpellCast');
const ModifierEnemySpellWatchPutCardInHand = require('@duelyst/sdk/modifiers/modifierEnemySpellWatchPutCardInHand');
const ModifierDyingWishPutCardInHand = require('@duelyst/sdk/modifiers/modifierDyingWishPutCardInHand');
