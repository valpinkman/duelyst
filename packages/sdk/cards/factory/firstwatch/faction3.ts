...
const SpellSpawnTilesInCenterColumn = require('@duelyst/sdk/spells/spellSpawnTilesInCenterColumn');
const SpellBounceToActionbarApplyModifiers = require('@duelyst/sdk/spells/spellBounceToActionBarApplyModifiers');
const SpellApplyPlayerModifiers = require('@duelyst/sdk/spells/spellApplyPlayerModifiers');
const SpellMirage = require('@duelyst/sdk/spells/spellMirage');
const SpellDropLift = require('@duelyst/sdk/spells/spellDropLift');

const Modifier = require('@duelyst/sdk/modifiers/modifier');
const ModifierOpponentDrawCardWatchGainKeyword = require('@duelyst/sdk/modifiers/modifierOpponentDrawCardWatchGainKeyword');
const ModifierStartTurnWatchSummonDervish = require('@duelyst/sdk/modifiers/modifierStartTurnWatchSummonDervish');
const ModifierStartTurnWatchDamageEnemiesInRow = require('@duelyst/sdk/modifiers/modifierStartTurnWatchDamageEnemiesInRow');
const ModifierPortal = require('@duelyst/sdk/modifiers/modifierPortal');
const ModifierStartTurnWatchDestroySelfAndEnemies = require('@duelyst/sdk/modifiers/modifierStartTurnWatchDestroySelfAndEnemies');
const ModifierSandPortal = require('@duelyst/sdk/modifiers/modifierSandPortal');
const ModifierDyingWish = require('@duelyst/sdk/modifiers/modifierDyingWish');
const ModifierDyingWishDrawWishCard = require('@duelyst/sdk/modifiers/modifierDyingWishDrawWishCard');
...
const ModifierKillWatchSpawnEntity = require('@duelyst/sdk/modifiers/modifierKillWatchSpawnEntity');
