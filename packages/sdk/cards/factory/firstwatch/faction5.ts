...
const SpellToothAndTrial = require('@duelyst/sdk/spells/spellToothAndTrial');
const SpellVaathsSpirit = require('@duelyst/sdk/spells/spellVaathsSpirit');
const SpellSpawnEntity = require('@duelyst/sdk/spells/spellSpawnEntity');
const SpellDinoParty = require('@duelyst/sdk/spells/spellDinoParty');
const SpellMassMojo = require('@duelyst/sdk/spells/spellMassMojo');
const SpellBloodRage = require('@duelyst/sdk/spells/spellBloodRage');

const ModifierOpponentSummonWatchSummonEgg = require('@duelyst/sdk/modifiers/modifierOpponentSummonWatchSummonEgg');
...
const ModifierSpellWatchDamageAllMinions = require('@duelyst/sdk/modifiers/modifierSpellWatchDamageAllMinions');
...
const ModifierPrimalTile = require('@duelyst/sdk/modifiers/modifierPrimalTile');
