...
const SpellTectonicSpikes = require('@duelyst/sdk/spells/spellTectonicSpikes');
const SpellDamageEnemyGeneralBothDrawCard = require('@duelyst/sdk/spells/spellDamageEnemyGeneralBothDrawCard');
const SpellSpawnEntity = require('@duelyst/sdk/spells/spellSpawnEntity');

const Modifier = require('@duelyst/sdk/modifiers/modifier');
const ModifierSynergizeApplyModifiersToGeneral = require('@duelyst/sdk/modifiers/modifierSynergizeApplyModifiersToGeneral');
const ModifierDoubleAttackStat = require('@duelyst/sdk/modifiers/modifierDoubleAttackStat');
const ModifierSynergizeApplyModifiers = require('@duelyst/sdk/modifiers/modifierSynergizeApplyModifiers');
const ModifierMyGeneralDamagedWatchBuffSelfAttackForSame = require('@duelyst/sdk/modifiers/modifierMyGeneralDamagedWatchBuffSelfAttackForSame');
const ModifierOnSpawnCopyMyGeneral = require('@duelyst/sdk/modifiers/modifierOnSpawnCopyMyGeneral');
