...
const ModifierSynergizeSpawnVanarToken = require('@duelyst/sdk/modifiers/modifierSynergizeSpawnVanarToken');
const ModifierKillWatchRefreshExhaustion = require('@duelyst/sdk/modifiers/modifierKillWatchRefreshExhaustion');
const ModifierDealDamageWatchRefreshSignatureCard = require('@duelyst/sdk/modifiers/modifierDealDamageWatchRefreshSignatureCard');
...
const ModifierOpeningGambitSpawnVanarTokensAroundGeneral = require('@duelyst/sdk/modifiers/modifierOpeningGambitSpawnVanarTokensAroundGeneral');
