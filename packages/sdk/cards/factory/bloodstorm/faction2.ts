...
const SpellApplyModifiersToUnitAndGeneral = require('@duelyst/sdk/spells/spellApplyModifiersToUnitAndGeneral');
const SpellDamageUnitAndGeneral = require('@duelyst/sdk/spells/spellDamageUnitAndGeneral');
...
const ModifierSynergizeDamageEnemyGeneral = require('@duelyst/sdk/modifiers/modifierSynergizeDamageEnemyGeneral');
const ModifierSynergizeTeleportRandomEnemy = require('@duelyst/sdk/modifiers/modifierSynergizeTeleportRandomEnemy');
