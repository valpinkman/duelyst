...
const ModifierDoubleHealthStat = require('@duelyst/sdk/modifiers/modifierDoubleHealthStat');
const ModifierBandingApplyModifiers = require('@duelyst/sdk/modifiers/modifierBandingApplyModifiers');
