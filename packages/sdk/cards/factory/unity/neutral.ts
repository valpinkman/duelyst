...
const ModifierBondApplyModifiers = require('@duelyst/sdk/modifiers/modifierBondApplyModifiers');
const ModifierOpeningGambitGoleminate = require('@duelyst/sdk/modifiers/modifierOpeningGambitGoleminate');
const ModifierSpellWatchDrawRandomArcanyst = require('@duelyst/sdk/modifiers/modifierSpellWatchDrawRandomArcanyst');
const ModifierOpeningGambitSpawnTribal = require('@duelyst/sdk/modifiers/modifierOpeningGambitSpawnTribal');
const ModifierDyingWishSpawnTribal = require('@duelyst/sdk/modifiers/modifierDyingWishSpawnTribal');
const ModifierDrawCardWatchCopySpell = require('@duelyst/sdk/modifiers/modifierDrawCardWatchCopySpell');
const ModifierBondPutCardsInHand = require('@duelyst/sdk/modifiers/modifierBondPutCardsInHand');
const ModifierFlying = require('@duelyst/sdk/modifiers/modifierFlying');
const ModifierBond = require('@duelyst/sdk/modifiers/modifierBond');
