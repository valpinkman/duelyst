...
const SpellRemoveTargetSpawnEntity = require('@duelyst/sdk/spells/spellRemoveTargetSpawnEntity');

const Modifier = require('@duelyst/sdk/modifiers/modifier');
const ModifierBond = require('@duelyst/sdk/modifiers/modifierBond');
const ModifierBondDrawCards = require('@duelyst/sdk/modifiers/modifierBondDrawCards');
...
const ModifierKillWatchSpawnCopyNearby = require('@duelyst/sdk/modifiers/modifierKillWatchSpawnCopyNearby');
