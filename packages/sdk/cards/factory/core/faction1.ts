...
const MovementRange = require('@duelyst/sdk/entities/movementRange');
...
const SpellBuffAttributeByOtherAttribute = require('@duelyst/sdk/spells/spellBuffAttributeByOtherAttribute');
const SpellApplyModifiers = require('@duelyst/sdk/spells/spellApplyModifiers');
const SpellHeal = require('@duelyst/sdk/spells/spellHeal');
const SpellSilence = require('@duelyst/sdk/spells/spellSilence');
const SpellHolyImmolation = require('@duelyst/sdk/spells/spellHolyImmolation');
...
const SpellLifeSurge = require('@duelyst/sdk/spells/spellLifeSurge');
const SpellDecimate = require('@duelyst/sdk/spells/spellDecimate');
const SpellKneel = require('@duelyst/sdk/spells/spellKneel');
const SpellSpawnEntityInFrontOfGeneral = require('@duelyst/sdk/spells/spellSpawnEntityInFrontOfGeneral');
...
const ModifierBandingAttack = require('@duelyst/sdk/modifiers/modifierBandingAttack');
const ModifierBandingHeal = require('@duelyst/sdk/modifiers/modifierBandingHeal');
...
const ModifierDispelOnAttack = require('@duelyst/sdk/modifiers/modifierDispelOnAttack');
...
const ModifierBandingDealDamageWatchDrawCard = require('@duelyst/sdk/modifiers/modifierBandingDealDamageWatchDrawCard');
const ModifierHealWatchBuffSelf = require('@duelyst/sdk/modifiers/modifierHealWatchBuffSelf');
const ModifierHealWatchDamageNearbyEnemies = require('@duelyst/sdk/modifiers/modifierHealWatchDamageNearbyEnemies');
const ModifierBandingProvoke = require('@duelyst/sdk/modifiers/modifierBandingProvoke');
...
class CardFactory_CoreSet_Faction1 {
  ...
  static cardForIdentifier(identifier, gameSession) {
    ...
    if (identifier === Cards.Faction1.ArclyteSentinel) {
      ...
      followupModifierContextObject.appliedName = i18next.t(
        'modifiers.faction_1_arclyte_buff_applied_name',
      );
      card.setFollowups([
        {
          id: Cards.Spell.ApplyModifiers,
          targetModifiersContextObjects: [followupModifierContextObject],
          _private: {
    ...
    if (identifier === Cards.Faction1.Lightchaser) {
      ...
      card.setInherentModifiersContextObjects([
        ModifierHealWatchBuffSelf.createContextObject(1, 1),
      ]);
    }
    ...
    if (identifier === Cards.Faction1.ElyxStormblade) {
      ...
      speedBuffContextObject.appliedDescription = i18next.t(
        'modifiers.faction_1_elyx_buff_applied_desc',
      );
    ...
    if (identifier === Cards.Faction1.Sunriser) {
      ...
      card.setInherentModifiersContextObjects([
        ModifierHealWatchDamageNearbyEnemies.createContextObject(2),
      ]);
    }
    ...
    if (identifier === Cards.Faction1.KingsGuard) {
      ...
      card.maxHP = 2;
      card.manaCost = 1;
      card.setInherentModifiersContextObjects([ModifierBandingProvoke.createContextObject()]);
      card.addKeywordClassToInclude(ModifierProvoke);
    ...
    if (identifier === Cards.Spell.AurynNexus) {
      ...
      card.setTargetModifiersContextObjects([healthBuff]);
    ...
    if (identifier === Cards.Spell.LastingJudgement) {
      ...
      statModifierContextObject.appliedName = i18next.t(
        'modifiers.faction_1_spell_lasting_judgement_1',
      );
    ...
    if (identifier === Cards.Spell.LionheartBlessing) {
      ...
      card.setTargetModifiersContextObjects([
        ModifierBandingDealDamageWatchDrawCard.createContextObject(),
      ]);
      card.spellFilterType = SpellFilterType.AllyDirect;
    ...
    if (identifier === Cards.Spell.AegisBarrier) {
      ...
      card.rarityId = Rarity.Legendary;
      card.spellFilterType = SpellFilterType.AllyDirect;
      card.setTargetModifiersContextObjects([ModifierImmuneToSpellsByEnemy.createContextObject()]);
    ...
    if (identifier === Cards.Artifact.IndomitableWill) {
      ...
      attackBuffContextObject.appliedName = i18next.t(
        'cards.faction_1_artifact_skywind_glaives_name',
      );
      card.setTargetModifiersContextObjects([
        Modifier.createContextObjectWithAuraForNearbyAllies(
          ...
          null,
          null,
          i18next.t('modifiers.faction_1_artifact_skywind_glaives_1'),
        ),
      ]);
