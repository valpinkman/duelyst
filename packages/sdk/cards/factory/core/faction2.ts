...
const SpellTwinStrike = require('@duelyst/sdk/spells/spellTwinStrike');
const SpellRemoveAndReplaceEntity = require('@duelyst/sdk/spells/spellRemoveAndReplaceEntity');
const SpellMartyrdom = require('@duelyst/sdk/spells/spellMartyrdom');
const SpellRemoveArtifacts = require('@duelyst/sdk/spells/spellRemoveArtifacts');
const SpellApplyPlayerModifiers = require('@duelyst/sdk/spells/spellApplyPlayerModifiers');
const SpellHeavensEclipse = require('@duelyst/sdk/spells/spellHeavensEclipse');
const SpellInnerFocus = require('@duelyst/sdk/spells/spellInnerFocus');
const SpellMistWalking = require('@duelyst/sdk/spells/spellMistWalking');
const SpellKillingEdge = require('@duelyst/sdk/spells/spellKillingEdge');
const SpellJuxtaposition = require('@duelyst/sdk/spells/spellJuxtaposition');
const SpellSpawnEntityNearbyGeneral = require('@duelyst/sdk/spells/spellSpawnEntityNearbyGeneral');
const SpellAncestralDivination = require('@duelyst/sdk/spells/spellAncestralDivination');
const SpellSwordsBBS = require('@duelyst/sdk/spells/spellSwordsBBS');
const SpellApplyModifiersToGeneral = require('@duelyst/sdk/spells/spellApplyModifiersToGeneral');
const SpellDrawCardEndOfTurn = require('@duelyst/sdk/spells/spellDrawCardEndOfTurn');

const Modifier = require('@duelyst/sdk/modifiers/modifier');
const ModifierRanged = require('@duelyst/sdk/modifiers/modifierRanged');
const ModifierImmuneToAttacks = require('@duelyst/sdk/modifiers/modifierImmuneToAttacks');
...
const ModifierSpellWatchApplyModifiers = require('@duelyst/sdk/modifiers/modifierSpellWatchApplyModifiers');
const ModifierSpellWatchDamageGeneral = require('@duelyst/sdk/modifiers/modifierSpellWatchDamageGeneral');
const ModifierStartTurnWatchDamageMyGeneral = require('@duelyst/sdk/modifiers/modifierStartTurnWatchDamageMyGeneral');
const ModifierBackstab = require('@duelyst/sdk/modifiers/modifierBackstab');
const ModifierMyAttackWatchBuffSelf = require('@duelyst/sdk/modifiers/modifierMyAttackWatchBuffSelf');
const ModifierDealDamageWatchKillTarget = require('@duelyst/sdk/modifiers/modifierDealDamageWatchKillTarget');
const ModifierSpellWatchBloodLeech = require('@duelyst/sdk/modifiers/modifierSpellWatchBloodLeech');
const ModifierOpeningGambitApplyPlayerModifiers = require('@duelyst/sdk/modifiers/modifierOpeningGambitApplyPlayerModifiers');
const ModifierStartTurnWatchBounceToActionBar = require('@duelyst/sdk/modifiers/modifierStartTurnWatchBounceToActionBar');
const ModifierTakeDamageWatchDamageEnemy = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchDamageEnemy');
const ModifierSpellDamageWatchPutCardInHand = require('@duelyst/sdk/modifiers/modifierSpellDamageWatchPutCardInHand');
const ModifierTakeDamageWatchPutCardInHand = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchPutCardInHand');
