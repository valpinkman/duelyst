...
const SpellNetherSummoning = require('@duelyst/sdk/spells/spellNetherSummoning');
const SpellChokingShadows = require('@duelyst/sdk/spells/spellChokingShadows');
const SpellVoidPulse = require('@duelyst/sdk/spells/spellVoidPulse');
const SpellDarkSacrifice = require('@duelyst/sdk/spells/spellDarkSacrifice');
const SpellKillTargetSpawnEntity = require('@duelyst/sdk/spells/spellKillTargetSpawnEntity');
const SpellSpawnEntity = require('@duelyst/sdk/spells/spellSpawnEntity');
const SpellBreathOfTheUnborn = require('@duelyst/sdk/spells/spellBreathOfTheUnborn');
const SpellRiteOfTheUndervault = require('@duelyst/sdk/spells/spellRiteOfTheUndervault');
const SpellDarkSeed = require('@duelyst/sdk/spells/spellDarkSeed');
const SpellConsumingRebirth = require('@duelyst/sdk/spells/spellConsumingRebirth');
const SpellShadowspawn = require('@duelyst/sdk/spells/spellShadowspawn');
const SpellAbyssalScar = require('@duelyst/sdk/spells/spellAbyssalScar');
const SpellSacrificeBBS = require('@duelyst/sdk/spells/spellSacrificeBBS');
...
const ModifierOpeningGambitSpawnEntity = require('@duelyst/sdk/modifiers/modifierOpeningGambitSpawnEntity');
const ModifierDeathWatchSpawnEntity = require('@duelyst/sdk/modifiers/modifierDeathWatchSpawnEntity');
const ModifierOpeningGambitSacrificeNearbyBuffSelf = require('@duelyst/sdk/modifiers/modifierOpeningGambitSacrificeNearbyBuffSelf');
const ModifierDyingWishSpawnEntityAnywhere = require('@duelyst/sdk/modifiers/modifierDyingWishSpawnEntityAnywhere');
const ModifierDamageGeneralOnAttack = require('@duelyst/sdk/modifiers/modifierDamageGeneralOnAttack');
...
const ModifierDyingWishSpawnUnitFromOpponentsDeck = require('@duelyst/sdk/modifiers/modifierDyingWishSpawnUnitFromOpponentsDeck');
const ModifierDealDamageWatchSpawnEntity = require('@duelyst/sdk/modifiers/modifierDealDamageWatchSpawnEntity');
const ModifierWraithlingFury = require('@duelyst/sdk/modifiers/modifierWraithlingFury');
const ModifierDyingWishDamageNearbyAllies = require('@duelyst/sdk/modifiers/modifierDyingWishDamageNearbyAllies');
const ModifierKillWatchHealSelf = require('@duelyst/sdk/modifiers/modifierKillWatchHealSelf');
const ModifierShadowScar = require('@duelyst/sdk/modifiers/modifierShadowScar');
const ModifierStackingShadowsBonusDamage = require('@duelyst/sdk/modifiers/modifierStackingShadowsBonusDamage');
const ModifierDynamicCountModifySelfByShadowTilesOnBoard = require('@duelyst/sdk/modifiers/modifierDynamicCountModifySelfByShadowTilesOnBoard');
const ModifierEndTurnWatchSpawnTile = require('@duelyst/sdk/modifiers/modifierEndTurnWatchSpawnTile');
