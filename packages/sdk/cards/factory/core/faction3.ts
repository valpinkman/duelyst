...
const SpellEnslave = require('@duelyst/sdk/spells/spellEnslave');
const SpellStarsFury = require('@duelyst/sdk/spells/spellStarsFury');
const SpellRashasCurse = require('@duelyst/sdk/spells/spellRashasCurse');
const SpellRashasCurseFollowup = require('@duelyst/sdk/spells/spellRashasCurseFollowup');
const SpellAurorasTears = require('@duelyst/sdk/spells/spellAurorasTears');
let SpellTimeMaelstrom = require('@duelyst/sdk/spells/spellTimeMaelstrom');
const SpellBoneSwarm = require('@duelyst/sdk/spells/spellBoneSwarm');
const SpellFountainOfYouth = require('@duelyst/sdk/spells/spellFountainOfYouth');
SpellTimeMaelstrom = require('@duelyst/sdk/spells/spellTimeMaelstrom');
const SpellWindShroud = require('@duelyst/sdk/spells/spellWindShroud');
...
const ModifierSilence = require('@duelyst/sdk/modifiers/modifierSilence');
...
const ModifierBlastAttackStrong = require('@duelyst/sdk/modifiers/modifierBlastAttackStrong');
const ModifierDyingWishDamageEnemyGeneralHealGeneral = require('@duelyst/sdk/modifiers/modifierDyingWishDamageEnemyGeneralHealGeneral');
const ModifierOpeningGambitRefreshArtifacts = require('@duelyst/sdk/modifiers/modifierOpeningGambitRefreshArtifacts');
...
const ModifierSummonWatchBuffSelf = require('@duelyst/sdk/modifiers/modifierSummonWatchBuffSelf');
const ModifierDyingWishEquipArtifactFromDeck = require('@duelyst/sdk/modifiers/modifierDyingWishEquipArtifactFromDeck');
