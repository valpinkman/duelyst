...
const ModifierImmuneToDamageByGeneral = require('@duelyst/sdk/modifiers/modifierImmuneToDamageByGeneral');
...
const ModifierOpeningGambitDispel = require('@duelyst/sdk/modifiers/modifierOpeningGambitDispel');
...
const ModifierSpellWatchSpawnEntity = require('@duelyst/sdk/modifiers/modifierSpellWatchSpawnEntity');
const ModifierOpeningGambitRetrieveMostRecentSpell = require('@duelyst/sdk/modifiers/modifierOpeningGambitRetrieveMostRecentSpell');
const ModifierOpeningGambitRetrieveRandomSpell = require('@duelyst/sdk/modifiers/modifierOpeningGambitRetrieveRandomSpell');
...
const ModifierOpeningGambitDamageNearby = require('@duelyst/sdk/modifiers/modifierOpeningGambitDamageNearby');
const ModifierStartTurnWatchDamageEnemyGeneralBuffSelf = require('@duelyst/sdk/modifiers/modifierStartTurnWatchDamageEnemyGeneralBuffSelf');
const ModifierDyingWishApplyModifiers = require('@duelyst/sdk/modifiers/modifierDyingWishApplyModifiers');
const ModifierOpeningGambitDamageBothGenerals = require('@duelyst/sdk/modifiers/modifierOpeningGambitDamageBothGenerals');
const ModifierOpeningGambitDamageInFront = require('@duelyst/sdk/modifiers/modifierOpeningGambitDamageInFront');
const ModifierOpeningGambitApplyPlayerModifiers = require('@duelyst/sdk/modifiers/modifierOpeningGambitApplyPlayerModifiers');
const ModifierOpeningGambitApplyMechazorPlayerModifiers = require('@duelyst/sdk/modifiers/modifierOpeningGambitApplyMechazorPlayerModifiers');
const ModifierMyGeneralDamagedWatchBuffSelf = require('@duelyst/sdk/modifiers/modifierMyGeneralDamagedWatchBuffSelf');
const ModifierMyGeneralDamagedWatchHealSelf = require('@duelyst/sdk/modifiers/modifierMyGeneralDamagedWatchHealSelf');
const ModifierMyGeneralDamagedWatchDamageNearby = require('@duelyst/sdk/modifiers/modifierMyGeneralDamagedWatchDamageNearby');
const ModifierDoubleDamageToMinions = require('@duelyst/sdk/modifiers/modifierDoubleDamageToMinions');
const ModifierDealDamageWatchHealMyGeneral = require('@duelyst/sdk/modifiers/modifierDealDamageWatchHealMyGeneral');
const ModifierOpponentSummonWatchBuffSelf = require('@duelyst/sdk/modifiers/modifierOpponentSummonWatchBuffSelf');
const ModifierOpeningGambitDamageNearbyMinions = require('@duelyst/sdk/modifiers/modifierOpeningGambitDamageNearbyMinions');
const ModifierOpeningGambitSpawnCopiesOfEntityAnywhere = require('@duelyst/sdk/modifiers/modifierOpeningGambitSpawnCopiesOfEntityAnywhere');
const ModifierOpponentSummonWatchDamageEnemyGeneral = require('@duelyst/sdk/modifiers/modifierOpponentSummonWatchDamageEnemyGeneral');
const ModifierOpeningGambitDrawArtifactFromDeck = require('@duelyst/sdk/modifiers/modifierOpeningGambitDrawArtifactFromDeck');
const ModifierSummonWatchNearbyApplyModifiers = require('@duelyst/sdk/modifiers/modifierSummonWatchNearbyApplyModifiers');
const ModifierTakeDamageWatchRandomTeleport = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchRandomTeleport');
const ModifierOpeningGambitSpawnEntityInEachCorner = require('@duelyst/sdk/modifiers/modifierOpeningGambitSpawnEntityInEachCorner');
const ModifierOpeningGambitMindwarp = require('@duelyst/sdk/modifiers/modifierOpeningGambitMindwarp');
const ModifierEndTurnWatchSpawnRandomEntity = require('@duelyst/sdk/modifiers/modifierEndTurnWatchSpawnRandomEntity');
const ModifierOpeningGambitRemoveRandomArtifact = require('@duelyst/sdk/modifiers/modifierOpeningGambitRemoveRandomArtifact');
const ModifierEndTurnWatchHealNearby = require('@duelyst/sdk/modifiers/modifierEndTurnWatchHealNearby');
const ModifierDealDamageWatchTeleportToMe = require('@duelyst/sdk/modifiers/modifierDealDamageWatchTeleportToMe');
const ModifierDyingWishSpawnEntityNearbyGeneral = require('@duelyst/sdk/modifiers/modifierDyingWishSpawnEntityNearbyGeneral');
const ModifierOpeningGambitBuffSelfByOpponentHandCount = require('@duelyst/sdk/modifiers/modifierOpeningGambitBuffSelfByOpponentHandCount');
const ModifierTakeDamageWatchDamageEnemyGeneralForSame = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchDamageEnemyGeneralForSame');
const ModifierDealDamageWatchDrawCard = require('@duelyst/sdk/modifiers/modifierDealDamageWatchDrawCard');
const ModifierStartTurnWatchSwapStats = require('@duelyst/sdk/modifiers/modifierStartTurnWatchSwapStats');
const ModifierHealSelfWhenDealingDamage = require('@duelyst/sdk/modifiers/modifierHealSelfWhenDealingDamage');
const ModifierDealDamageWatchHealorDamageGeneral = require('@duelyst/sdk/modifiers/modifierDealDamageWatchHealorDamageGeneral');
const ModifierOpeningGambitLifeGive = require('@duelyst/sdk/modifiers/modifierOpeningGambitLifeGive');
const ModifierOpeningGambitTeleportAllNearby = require('@duelyst/sdk/modifiers/modifierOpeningGambitTeleportAllNearby');
const ModifierRook = require('@duelyst/sdk/modifiers/modifierRook');
const ModifierDyingWishReSpawnEntityAnywhere = require('@duelyst/sdk/modifiers/modifierDyingWishReSpawnEntityAnywhere');
const ModifierOpeningGambitApplyModifiersRandomly = require('@duelyst/sdk/modifiers/modifierOpeningGambitApplyModifiersRandomly');
const ModifierImmuneToSpellDamage = require('@duelyst/sdk/modifiers/modifierImmuneToSpellDamage');
const ModifierSummonWatchFromActionBarByOpeningGambitBuffSelf = require('@duelyst/sdk/modifiers/modifierSummonWatchFromActionBarByOpeningGambitBuffSelf');
const ModifierOpeningGambitDrawCardBothPlayers = require('@duelyst/sdk/modifiers/modifierOpeningGambitDrawCardBothPlayers');
const ModifierSurviveDamageWatchReturnToHand = require('@duelyst/sdk/modifiers/modifierSurviveDamageWatchReturnToHand');
const ModifierDoubleDamageToGenerals = require('@duelyst/sdk/modifiers/modifierDoubleDamageToGenerals');
const ModifierOpeningGambitHealBothGenerals = require('@duelyst/sdk/modifiers/modifierOpeningGambitHealBothGenerals');
