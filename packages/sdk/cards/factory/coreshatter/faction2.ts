...
const SpellDejaVu = require('@duelyst/sdk/spells/spellDejaVu');
const SpellDamage = require('@duelyst/sdk/spells/spellDamage');
const SpellSummonHighestCostMinion = require('@duelyst/sdk/spells/spellSummonHighestCostMinion');
const SpellPandaJail = require('@duelyst/sdk/spells/spellPandaJail');
const SpellCopyMinionToHand = require('@duelyst/sdk/spells/spellCopyMinionToHand');
const SpellIntensifyDealDamage = require('@duelyst/sdk/spells/spellIntensifyDealDamage');
const SpellDamageAndPutCardInHand = require('@duelyst/sdk/spells/spellDamageAndPutCardInHand');
...
let ModifierManaCostChange = require('@duelyst/sdk/modifiers/modifierManaCostChange');
const ModifierMyMoveWatchAnyReasonDrawCard = require('@duelyst/sdk/modifiers/modifierMyMoveWatchAnyReasonDrawCard');
const ModifierBackstab = require('@duelyst/sdk/modifiers/modifierBackstab');
const ModifierBackstabWatchSummonBackstabMinion = require('@duelyst/sdk/modifiers/modifierBackstabWatchSummonBackstabMinion');
const ModifierMyAttackWatchApplyModifiers = require('@duelyst/sdk/modifiers/modifierMyAttackWatchApplyModifiers');
const ModifierBackstabWatchApplyPlayerModifiers = require('@duelyst/sdk/modifiers/modifierBackstabWatchApplyPlayerModifiers');
const ModifierFlying = require('@duelyst/sdk/modifiers/modifierFlying');
const ModifierSummonWatchApplyModifiersToRanged = require('@duelyst/sdk/modifiers/modifierSummonWatchApplyModifiersToRanged');
...
ModifierManaCostChange = require('@duelyst/sdk/modifiers/modifierManaCostChange');
const ModifierSpellWatchAnywhereApplyModifiers = require('@duelyst/sdk/modifiers/modifierSpellWatchAnywhereApplyModifiers');
const ModifierDamageBothGeneralsOnReplace = require('@duelyst/sdk/modifiers/modifierDamageBothGeneralsOnReplace');
const ModifierIntensifyTempBuffNearbyMinion = require('@duelyst/sdk/modifiers/modifierIntensifyTempBuffNearbyMinion');
...
const ModifierFateSonghaiMinionQuest = require('@duelyst/sdk/modifiers/modifierFateSonghaiMinionQuest');
