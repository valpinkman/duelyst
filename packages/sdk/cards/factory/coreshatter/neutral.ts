...
const ModifierEnemySpellWatchHealMyGeneral = require('@duelyst/sdk/modifiers/modifierEnemySpellWatchHealMyGeneral');
const ModifierFirstBlood = require('@duelyst/sdk/modifiers/modifierFirstBlood');
const ModifierReplaceWatchApplyModifiersToReplaced = require('@duelyst/sdk/modifiers/modifierReplaceWatchApplyModifiersToReplaced');
const ModifierManaCostChange = require('@duelyst/sdk/modifiers/modifierManaCostChange');
const ModifierDyingWishDamageGeneral = require('@duelyst/sdk/modifiers/modifierDyingWishDamageGeneral');
...
const ModifierIntensifyDamageNearby = require('@duelyst/sdk/modifiers/modifierIntensifyDamageNearby');
const ModifierReplaceWatchShuffleCardIntoDeck = require('@duelyst/sdk/modifiers/modifierReplaceWatchShuffleCardIntoDeck');
const ModifierEndTurnWatchAnyPlayerPullRandomUnits = require('@duelyst/sdk/modifiers/modifierEndTurnWatchAnyPlayerPullRandomUnits');
const ModifierOpponentSummonWatchSummonMinionInFront = require('@duelyst/sdk/modifiers/modifierOpponentSummonWatchSummonMinionInFront');
const ModifierProvoke = require('@duelyst/sdk/modifiers/modifierProvoke');
const ModifierEndTurnWatchGainLastSpellPlayedThisTurn = require('@duelyst/sdk/modifiers/modifierEndTurnWatchGainLastSpellPlayedThisTurn');
const ModifierOnSummonFromHandApplyEmblems = require('@duelyst/sdk/modifiers/modifierOnSummonFromHandApplyEmblems');
const ModifierSummonWatchBurnOpponentCards = require('@duelyst/sdk/modifiers/modifierSummonWatchBurnOpponentCards');
const ModifierKillWatchAndSurviveScarzig = require('@duelyst/sdk/modifiers/modifierKillWatchAndSurviveScarzig');
const ModifierForcefield = require('@duelyst/sdk/modifiers/modifierForcefield');
const ModifierFateSingleton = require('@duelyst/sdk/modifiers/modifierFateSingleton');
...
const ModifierMyAttackWatchApplyModifiersToAllies = require('@duelyst/sdk/modifiers/modifierMyAttackWatchApplyModifiersToAllies');
const ModifierOpeningGambit = require('@duelyst/sdk/modifiers/modifierOpeningGambit');
const ModifierOpeningGambitTransformHandIntoLegendaries = require('@duelyst/sdk/modifiers/modifierOpeningGambitTransformHandIntoLegendaries');
const ModifierEndTurnWatchAnyPlayerHsuku = require('@duelyst/sdk/modifiers/modifierEndTurnWatchAnyPlayerHsuku');
...
const ModifierQuestBuffNeutral = require('@duelyst/sdk/modifiers/modifierQuestBuffNeutral');
