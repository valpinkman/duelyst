...
const SpellIntensifySpawnEntitiesNearGeneral = require('@duelyst/sdk/spells/spellIntensifySpawnEntitiesNearGeneral');
const SpellApplyModifiers = require('@duelyst/sdk/spells/spellApplyModifiers');
const SpellSummoningStones = require('@duelyst/sdk/spells/spellSummoningStones');
const SpellDrawArtifact = require('@duelyst/sdk/spells/spellDrawArtifact');
const SpellThoughtExchange = require('@duelyst/sdk/spells/spellThoughtExchange');
const SpellMetalworking = require('@duelyst/sdk/spells/spellMetalworking');
...
const ModifierStartOpponentsTurnWatchRemoveEntity = require('@duelyst/sdk/modifiers/modifierStartOpponentsTurnWatchRemoveEntity');
const ModifierEnemyCannotCastBBS = require('@duelyst/sdk/modifiers/modifierEnemyCannotCastBBS');
const ModifierStartTurnWatchRestoreChargeToArtifacts = require('@duelyst/sdk/modifiers/modifierStartTurnWatchRestoreChargeToArtifacts');
const ModifierIntensifyBuffSelf = require('@duelyst/sdk/modifiers/modifierIntensifyBuffSelf');
const ModifierIntensifyDamageEnemyGeneral = require('@duelyst/sdk/modifiers/modifierIntensifyDamageEnemyGeneral');
...
const ModifierMyAttackWatchScarabBlast = require('@duelyst/sdk/modifiers/modifierMyAttackWatchScarabBlast');
const ModifierEquipFriendlyArtifactWatchGainAttackEqualToCost = require('@duelyst/sdk/modifiers/modifierEquipFriendlyArtifactWatchGainAttackEqualToCost');
const ModifierOnSummonFromHandApplyEmblems = require('@duelyst/sdk/modifiers/modifierOnSummonFromHandApplyEmblems');
const ModifierDyingWishGoldenGuide = require('@duelyst/sdk/modifiers/modifierDyingWishGoldenGuide');
...
const ModifierFateVetruvianMovementQuest = require('@duelyst/sdk/modifiers/modifierFateVetruvianMovementQuest');
