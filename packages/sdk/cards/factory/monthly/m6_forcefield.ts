...
const ModifierOpeningGambitDamageNearbyForAttack = require('@duelyst/sdk/modifiers/modifierOpeningGambitDamageNearbyForAttack');
const ModifierMyAttackOrAttackedWatchDrawCard = require('@duelyst/sdk/modifiers/modifierMyAttackOrAttackedWatchDrawCard');
