...
const ModifierMyMinionAttackWatchHealGeneral = require('@duelyst/sdk/modifiers/modifierMyMinionAttackWatchHealGeneral');
const ModifierInvalidateRush = require('@duelyst/sdk/modifiers/modifierInvalidateRush');
const ModifierImmuneToDamageFromMinionsAndGenerals = require('@duelyst/sdk/modifiers/modifierImmuneToDamageFromMinionsAndGenerals');
const ModifierOpeningGambitDamageInFrontRow = require('@duelyst/sdk/modifiers/modifierOpeningGambitDamageInFrontRow');
