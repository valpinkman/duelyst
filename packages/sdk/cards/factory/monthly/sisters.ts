...
const ModifierHealWatchPutCardInHand = require('@duelyst/sdk/modifiers/modifierHealWatchPutCardInHand');
const ModifierEnemyTakeDamageWatchHealMyGeneral = require('@duelyst/sdk/modifiers/modifierEnemyTakeDamageWatchHealMyGeneral');
const ModifierTakeDamageWatchDamageNearbyEnemiesForSame = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchDamageNearbyEnemiesForSame');
const ModifierOpeningGambitDrawFactionCards = require('@duelyst/sdk/modifiers/modifierOpeningGambitDrawFactionCards');
