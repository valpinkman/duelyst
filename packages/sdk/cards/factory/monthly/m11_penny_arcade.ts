...
const SpellRiddle = require('@duelyst/sdk/spells/spellRiddle');
...
const ModifierElkowl = require('@duelyst/sdk/modifiers/modifierElkowl');
const ModifierOpeningGambitPutCardInOpponentHand = require('@duelyst/sdk/modifiers/modifierOpeningGambitPutCardInOpponentHand');
