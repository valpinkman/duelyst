...
const ModifierOpeningGambitHealMyGeneral = require('@duelyst/sdk/modifiers/modifierOpeningGambitHealMyGeneral');
const ModifierOpeningGambitSpawnCopiesOfEntityNearby = require('@duelyst/sdk/modifiers/modifierOpeningGambitSpawnCopiesOfEntityNearby');
const ModifierDyingWishDispelAllEnemyMinions = require('@duelyst/sdk/modifiers/modifierDyingWishDispelAllEnemyMinions');
const ModifierOpponentDrawCardWatchDamageEnemyGeneral = require('@duelyst/sdk/modifiers/modifierOpponentDrawCardWatchDamageEnemyGeneral');
