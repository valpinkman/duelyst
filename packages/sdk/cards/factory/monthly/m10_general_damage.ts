...
const ModifierCostChangeIfMyGeneralDamagedLastTurn = require('@duelyst/sdk/modifiers/modifierCostChangeIfMyGeneralDamagedLastTurn');
const ModifierMyGeneralDamagedWatchBuffSelfAndDrawACard = require('@duelyst/sdk/modifiers/modifierMyGeneralDamagedWatchBuffSelfAndDrawACard');
const ModifierCostEqualGeneralHealth = require('@duelyst/sdk/modifiers/modifierCostEqualGeneralHealth');
