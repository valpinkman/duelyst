...
const ModifierEnvyBaer = require('@duelyst/sdk/modifiers/modifierEnvyBaer');
const ModifierOpeningGambitGrincher = require('@duelyst/sdk/modifiers/modifierOpeningGambitGrincher');
const ModifierSpellWatchScientist = require('@duelyst/sdk/modifiers/modifierSpellWatchScientist');
