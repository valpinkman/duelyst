...
const ModifierReplaceWatchDamageEnemy = require('@duelyst/sdk/modifiers/modifierReplaceWatchDamageEnemy');
const ModifierReplaceWatchBuffSelf = require('@duelyst/sdk/modifiers/modifierReplaceWatchBuffSelf');
const ModifierBuffSelfOnReplace = require('@duelyst/sdk/modifiers/modifierBuffSelfOnReplace');
const ModifierSummonSelfOnReplace = require('@duelyst/sdk/modifiers/modifierSummonSelfOnReplace');
