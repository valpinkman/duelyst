...
const ModifierMyMoveWatchSpawnEntity = require('@duelyst/sdk/modifiers/modifierMyMoveWatchSpawnEntity');
const ModifierMyMoveWatchApplyModifiers = require('@duelyst/sdk/modifiers/modifierMyMoveWatchApplyModifiers');
const ModifierMyMoveWatchDrawCard = require('@duelyst/sdk/modifiers/modifierMyMoveWatchDrawCard');
