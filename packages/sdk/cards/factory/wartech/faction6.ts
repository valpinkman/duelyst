...
const SpellEssenceSculpt = require('@duelyst/sdk/spells/spellEssenceSculpt');
const SpellSpawnEntity = require('@duelyst/sdk/spells/spellSpawnEntity');
const SpellKillTargetWithModifierStunned = require('@duelyst/sdk/spells/spellKillTargetWithModifierStunned');
const SpellApplyModifiers = require('@duelyst/sdk/spells/spellApplyModifiers');
const SpellDoubleAttributeBuffs = require('@duelyst/sdk/spells/spellDoubleAttributeBuffs');
...
const ModifierSynergizeRazorArchitect = require('@duelyst/sdk/modifiers/modifierSynergizeRazorArchitect');
const ModifierAirdrop = require('@duelyst/sdk/modifiers/modifierAirdrop');
const ModifierDoubleDamageToStunnedEnemies = require('@duelyst/sdk/modifiers/modifierDoubleDamageToStunnedEnemies');
const ModifierMyAttackOrCounterattackWatchApplyModifiersToFriendlyMinions = require('@duelyst/sdk/modifiers/modifierMyAttackOrCounterattackWatchApplyModifiersToFriendlyMinions');
const ModifierDyingWish = require('@duelyst/sdk/modifiers/modifierDyingWish');
const ModifierDyingWishRespawnEntity = require('@duelyst/sdk/modifiers/modifierDyingWishRespawnEntity');
const ModifierBuildingSlowEnemies = require('@duelyst/sdk/modifiers/modifierBuildingSlowEnemies');
const ModifierAlwaysInfiltrated = require('@duelyst/sdk/modifiers/modifierAlwaysInfiltrated');
const ModifierProvidesAlwaysInfiltrated = require('@duelyst/sdk/modifiers/modifierProvidesAlwaysInfiltrated');
const ModifierSummonWatchByRaceSummonCopy = require('@duelyst/sdk/modifiers/modifierSummonWatchByRaceSummonCopy');
