...
const SpellThunderbomb = require('@duelyst/sdk/spells/spellThunderbomb');
const SpellAssassinationProtocol = require('@duelyst/sdk/spells/spellAssassinationProtocol');
const SpellSpawnEntitiesOnGeneralsDiagonals = require('@duelyst/sdk/spells/spellSpawnEntitiesOnGeneralsDiagonals');
const SpellBamboozle = require('@duelyst/sdk/spells/spellBamboozle');
const SpellFriendlyJux = require('@duelyst/sdk/spells/spellFriendlyJux');
...
const ModifierSpellWatchDrawCard = require('@duelyst/sdk/modifiers/modifierSpellWatchDrawCard');
...
const ModifierSynergizePutCardInHand = require('@duelyst/sdk/modifiers/modifierSynergizePutCardInHand');
const ModifierBackstabWatchAddCardToHand = require('@duelyst/sdk/modifiers/modifierBackstabWatchAddCardToHand');
const ModifierBuildCompleteGainTempMana = require('@duelyst/sdk/modifiers/modifierBuildCompleteGainTempMana');
const ModifierBackstabWatchTransformToBuilding = require('@duelyst/sdk/modifiers/modifierBackstabWatchTransformToBuilding');
