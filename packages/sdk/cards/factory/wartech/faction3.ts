...
const SpellGodMulligan = require('@duelyst/sdk/spells/spellGodMulligan');
const SpellSetHealthEqualToAttack = require('@duelyst/sdk/spells/spellSetHealthEqualToAttack');
const SpellDamageOwnGeneral = require('@duelyst/sdk/spells/spellDamageOwnGeneral');
const SpellLostInTheDesert = require('@duelyst/sdk/spells/spellLostInTheDesert');
const SpellNeurolink = require('@duelyst/sdk/spells/spellNeurolink');

const Modifier = require('@duelyst/sdk/modifiers/modifier');
const ModifierSynergizeSummonMinionNearby = require('@duelyst/sdk/modifiers/modifierSynergizeSummonMinionNearby');
...
const ModifierDyingWishDrawEnemyLegendaryArtifact = require('@duelyst/sdk/modifiers/modifierDyingWishDrawEnemyLegendaryArtifact');
const ModifierOpeningGambitSniperZen = require('@duelyst/sdk/modifiers/modifierOpeningGambitSniperZen');
...
const ModifierBuildCompleteReplicateAndSummonDervish = require('@duelyst/sdk/modifiers/modifierBuildCompleteReplicateAndSummonDervish');
const ModifierImmuneToDamage = require('@duelyst/sdk/modifiers/modifierImmuneToDamage');
const ModifierStartTurnWatchApplyTempArtifactModifier = require('@duelyst/sdk/modifiers/modifierStartTurnWatchApplyTempArtifactModifier');
