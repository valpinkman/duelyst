...
const SpellEggGrenade = require('@duelyst/sdk/spells/spellEggGrenade');
const SpellEmbryoticInsight = require('@duelyst/sdk/spells/spellEmbryoticInsight');
const SpellUpperHand = require('@duelyst/sdk/spells/spellUpperHand');
const SpellSaurianFinality = require('@duelyst/sdk/spells/spellSaurianFinality');
const SpellHomeostaticRebuke = require('@duelyst/sdk/spells/spellHomeostaticRebuke');
const SpellApplyModifiers = require('@duelyst/sdk/spells/spellApplyModifiers');
const SpellEffulgentInfusion = require('@duelyst/sdk/spells/spellEffulgentInfusion');

const Modifier = require('@duelyst/sdk/modifiers/modifier');
const ModifierOpeningGambitProgenitor = require('@duelyst/sdk/modifiers/modifierOpeningGambitProgenitor');
...
const ModifierSummonWatchFromActionBarByRaceBothPlayersDraw = require('@duelyst/sdk/modifiers/modifierSummonWatchFromActionBarByRaceBothPlayersDraw');
const ModifierSynergizeDamageClosestEnemy = require('@duelyst/sdk/modifiers/modifierSynergizeDamageClosestEnemy');
const ModifierRebirth = require('@duelyst/sdk/modifiers/modifierRebirth');
const ModifierMyAttackOrCounterattackWatchTransformIntoEgg = require('@duelyst/sdk/modifiers/modifierMyAttackOrCounterattackWatchTransformIntoEgg');
const ModifierKillWatchSpawnEgg = require('@duelyst/sdk/modifiers/modifierKillWatchSpawnEgg');
