...
const SpellForgeArtifact = require('@duelyst/sdk/spells/spellForgeArtifact');
...
const ModifierSynergizeDrawBloodboundSpell = require('@duelyst/sdk/modifiers/modifierSynergizeDrawBloodboundSpell');
const ModifierOpeningGambit = require('@duelyst/sdk/modifiers/modifierOpeningGambit');
const ModifierOpeningGambitDrawCopyFromDeck = require('@duelyst/sdk/modifiers/modifierOpeningGambitDrawCopyFromDeck');
const ModifierSummonWatchAnywhereByRaceBuffSelf = require('@duelyst/sdk/modifiers/modifierSummonWatchAnywhereByRaceBuffSelf');
const ModifierKillWatchDeceptibot = require('@duelyst/sdk/modifiers/modifierKillWatchDeceptibot');
...
const ModifierSynergizeBuffSelf = require('@duelyst/sdk/modifiers/modifierSynergizeBuffSelf');
const ModifierOpeningGambitRemoveCardsFromDecksByCost = require('@duelyst/sdk/modifiers/modifierOpeningGambitRemoveCardsFromDecksByCost');
const ModifierEnemyAttackWatchGainAttack = require('@duelyst/sdk/modifiers/modifierEnemyAttackWatchGainAttack');
const ModifierProvoke = require('@duelyst/sdk/modifiers/modifierProvoke');
const ModifierDeathWatchFriendlyMinionSwapAllegiance = require('@duelyst/sdk/modifiers/modifierDeathWatchFriendlyMinionSwapAllegiance');
const ModifierBuild = require('@duelyst/sdk/modifiers/modifierBuild');
const ModifierBuilding = require('@duelyst/sdk/modifiers/modifierBuilding');
const ModifierBuildCompleteHealGeneral = require('@duelyst/sdk/modifiers/modifierBuildCompleteHealGeneral');
const ModifierMyBuildWatchDrawCards = require('@duelyst/sdk/modifiers/modifierMyBuildWatchDrawCards');
const ModifierOpeningGambitProgressBuild = require('@duelyst/sdk/modifiers/modifierOpeningGambitProgressBuild');
const ModifierSummonWatchMechsShareKeywords = require('@duelyst/sdk/modifiers/modifierSummonWatchMechsShareKeywords');
const ModifierSituationalBuffSelfIfHaveMech = require('@duelyst/sdk/modifiers/modifierSituationalBuffSelfIfHaveMech');
