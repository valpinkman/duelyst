...
const SpellBetrayal = require('@duelyst/sdk/spells/spellBetrayal');
const SpellDamageAndApplyModifiers = require('@duelyst/sdk/spells/spellDamageAndApplyModifiers');
const SpellVellumscry = require('@duelyst/sdk/spells/spellVellumscry');
const SpellAbhorrentUnbirth = require('@duelyst/sdk/spells/spellAbhorrentUnbirth');
...
const ModifierDeathWatchBuffMinionsInHand = require('@duelyst/sdk/modifiers/modifierDeathWatchBuffMinionsInHand');
const ModifierDyingWishDestroyRandomEnemyNearby = require('@duelyst/sdk/modifiers/modifierDyingWishDestroyRandomEnemyNearby');
...
const ModifierDyingWishAddCardToDeck = require('@duelyst/sdk/modifiers/modifierDyingWishAddCardToDeck');
const ModifierOnDyingInfest = require('@duelyst/sdk/modifiers/modifierOnDyingInfest');
...
const ModifierEternalHeart = require('@duelyst/sdk/modifiers/modifierEternalHeart');
const ModifierDeathWatchSpawnRandomDemon = require('@duelyst/sdk/modifiers/modifierDeathWatchSpawnRandomDemon');
const ModifierWhenAttackedDestroyThis = require('@duelyst/sdk/modifiers/modifierWhenAttackedDestroyThis');
