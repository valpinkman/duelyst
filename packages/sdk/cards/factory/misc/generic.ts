...
const SpellKillTarget = require('@duelyst/sdk/spells/spellKillTarget');
const SpellFollowupTeleport = require('@duelyst/sdk/spells/spellFollowupTeleport');
const SpellFollowupTeleportToMe = require('@duelyst/sdk/spells/spellFollowupTeleportToMe');
const SpellFollowupTeleportMyGeneral = require('@duelyst/sdk/spells/spellFollowupTeleportMyGeneral');
const SpellSilence = require('@duelyst/sdk/spells/spellSilence');
const SpellSpawnEntity = require('@duelyst/sdk/spells/spellSpawnEntity');
const SpellCloneTargetEntity = require('@duelyst/sdk/spells/spellCloneTargetEntity');
const SpellCloneSourceEntity = require('@duelyst/sdk/spells/spellCloneSourceEntity');
const SpellKillTargetWithModifierRanged = require('@duelyst/sdk/spells/spellKillTargetWithModifierRanged');
const SpellDunecasterFollowup = require('@duelyst/sdk/spells/spellDunecasterFollowup');
const SpellFollowupSwapPositions = require('@duelyst/sdk/spells/spellFollowupSwapPositions');
const SpellFollowupDamage = require('@duelyst/sdk/spells/spellFollowupDamage');
const SpellFollowupHeal = require('@duelyst/sdk/spells/spellFollowupHeal');
const SpellMindControlByAttackValue = require('@duelyst/sdk/spells/spellMindControlByAttackValue');
const SpellFollowupRandomTeleport = require('@duelyst/sdk/spells/spellFollowupRandomTeleport');
const SpellFollowupKeeper = require('@duelyst/sdk/spells/spellFollowupKeeper');
const SpellFollowupHollowGroveKeeper = require('@duelyst/sdk/spells/spellFollowupHollowGroveKeeper');
const SpellFollowupKillTargetByAttack = require('@duelyst/sdk/spells/spellFollowupKillTargetByAttack');
const SpellCloneSourceEntityNearbyGeneral = require('@duelyst/sdk/spells/spellCloneSourceEntityNearbyGeneral');
const SpellDoubleAttackAndHealth = require('@duelyst/sdk/spells/spellDoubleAttackAndHealth');
const SpellHatchAnEgg = require('@duelyst/sdk/spells/spellHatchAnEgg');
const SpellFollowupActivateBattlePet = require('@duelyst/sdk/spells/spellFollowupActivateBattlePet');
const SpellSpawnEntityAndApplyPlayerModifiers = require('@duelyst/sdk/spells/spellSpawnEntityAndApplyPlayerModifiers');
const SpellFollowupTeleportMyGeneralBehindEnemy = require('@duelyst/sdk/spells/spellFollowupTeleportMyGeneralBehindEnemy');
const SpellFollowupTeleportInFrontOfAnyGeneral = require('@duelyst/sdk/spells/spellFollowupTeleportInFrontOfAnyGeneral');
const SpellSpawnNeutralEntity = require('@duelyst/sdk/spells/spellSpawnNeutralEntity');
const SpellFollowupFight = require('@duelyst/sdk/spells/spellFollowupFight');
const SpellOverwatch = require('@duelyst/sdk/spells/spellOverwatch');
const SpellBounceToActionBarSpawnEntity = require('@duelyst/sdk/spells/spellBounceToActionBarSpawnEntity');
const SpellFollowupTeleportToFriendlyCreep = require('@duelyst/sdk/spells/spellFollowupTeleportToFriendlyCreep');
const SpellFollowupTeleportNearMyGeneral = require('@duelyst/sdk/spells/spellFollowupTeleportNearMyGeneral');
const SpellBounceToActionbar = require('@duelyst/sdk/spells/spellBounceToActionbar');
const SpellDuplicator = require('@duelyst/sdk/spells/spellDuplicator');
const SpellApplyPlayerModifiers = require('@duelyst/sdk/spells/spellApplyPlayerModifiers');
const SpellFollowupSpawnEntityFromDeck = require('@duelyst/sdk/spells/spellFollowupSpawnEntityFromDeck');
const SpellDamageOrHeal = require('@duelyst/sdk/spells/spellDamageOrHeal');
