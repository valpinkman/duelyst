...
const ModifierCollectableBonusMana = require('@duelyst/sdk/modifiers/modifierCollectableBonusMana');
const ModifierHallowedGround = require('@duelyst/sdk/modifiers/modifierHallowedGround');
const ModifierHallowedGroundBuff = require('@duelyst/sdk/modifiers/modifierHallowedGroundBuff');
const ModifierSandPortal = require('@duelyst/sdk/modifiers/modifierSandPortal');
const ModifierPrimalProtection = require('@duelyst/sdk/modifiers/modifierPrimalProtection');
