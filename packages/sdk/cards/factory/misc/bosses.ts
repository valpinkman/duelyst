...
const SpellSpawnEntity = require('@duelyst/sdk/spells/spellSpawnEntity');
const SpellApplyModifiers = require('@duelyst/sdk/spells/spellApplyModifiers');
const SpellEquipBossArtifacts = require('@duelyst/sdk/spells/spellEquipBossArtifacts');
const SpellLaceratingFrost = require('@duelyst/sdk/spells/spellLaceratingFrost');
const SpellEntanglingShadows = require('@duelyst/sdk/spells/spellEntanglingShadows');
const SpellMoldingEarth = require('@duelyst/sdk/spells/spellMoldingEarth');
const SpellDamageAndSpawnEntitiesNearbyGeneral = require('@duelyst/sdk/spells/spellDamageAndSpawnEntitiesNearbyGeneral');
const SpellSilenceAndSpawnEntityNearby = require('@duelyst/sdk/spells/spellSilenceAndSpawnEntityNearby');
const SpellRestoringLight = require('@duelyst/sdk/spells/spellRestoringLight');
...
let ModifierProvoke = require('@duelyst/sdk/modifiers/modifierProvoke');
const ModifierEndTurnWatchDamageNearbyEnemy = require('@duelyst/sdk/modifiers/modifierEndTurnWatchDamageNearbyEnemy');
...
ModifierProvoke = require('@duelyst/sdk/modifiers/modifierProvoke');
...
const ModifierStartTurnWatchEquipArtifact = require('@duelyst/sdk/modifiers/modifierStartTurnWatchEquipArtifact');
const ModifierTakeDamageWatchSpawnRandomToken = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchSpawnRandomToken');
const ModifierDealDamageWatchKillTarget = require('@duelyst/sdk/modifiers/modifierDealDamageWatchKillTarget');
const ModifierStartTurnWatchPlaySpell = require('@duelyst/sdk/modifiers/modifierStartTurnWatchPlaySpell');
const ModifierDealDamageWatchModifyTarget = require('@duelyst/sdk/modifiers/modifierDealDamageWatchModifyTarget');
...
let ModifierCardControlledPlayerModifiers = require('@duelyst/sdk/modifiers/modifierCardControlledPlayerModifiers');
const ModifierBattlePet = require('@duelyst/sdk/modifiers/modifierBattlePet');
const ModifierImmuneToDamage = require('@duelyst/sdk/modifiers/modifierImmuneToDamage');
const ModifierStartTurnWatchDispelAllEnemyMinionsDrawCard = require('@duelyst/sdk/modifiers/modifierStartTurnWatchDispelAllEnemyMinionsDrawCard');
const ModifierImmuneToSpellsByEnemy = require('@duelyst/sdk/modifiers/modifierImmuneToSpellsByEnemy');
const ModifierAbsorbDamageGolems = require('@duelyst/sdk/modifiers/modifierAbsorbDamageGolems');
const ModifierExpireApplyModifiers = require('@duelyst/sdk/modifiers/modifierExpireApplyModifiers');
const ModifierSecondWind = require('@duelyst/sdk/modifiers/modifierSecondWind');
const ModifierKillWatchRespawnEntity = require('@duelyst/sdk/modifiers/modifierKillWatchRespawnEntity');
const ModifierOpponentSummonWatchSpawn1HealthClone = require('@duelyst/sdk/modifiers/modifierOpponentSummonWatchSpawn1HealthClone');
const ModifierDealOrTakeDamageWatchRandomTeleportOther = require('@duelyst/sdk/modifiers/modifierDealOrTakeDamageWatchRandomTeleportOther');
...
const ModifierEndTurnWatchTeleportCorner = require('@duelyst/sdk/modifiers/modifierEndTurnWatchTeleportCorner');
const ModifierBackstab = require('@duelyst/sdk/modifiers/modifierBackstab');
const ModifierDieSpawnNewGeneral = require('@duelyst/sdk/modifiers/modifierDieSpawnNewGeneral');
const ModifierKillWatchRefreshExhaustion = require('@duelyst/sdk/modifiers/modifierKillWatchRefreshExhaustion');
const ModifierEndTurnWatchDealDamageToSelfAndNearbyEnemies = require('@duelyst/sdk/modifiers/modifierEndTurnWatchDealDamageToSelfAndNearbyEnemies');
...
const ModifierMyMinionOrGeneralDamagedWatchBuffSelf = require('@duelyst/sdk/modifiers/modifierMyMinionOrGeneralDamagedWatchBuffSelf');
...
const ModifierHealSelfWhenDealingDamage = require('@duelyst/sdk/modifiers/modifierHealSelfWhenDealingDamage');
...
const ModifierAbsorbDamage = require('@duelyst/sdk/modifiers/modifierAbsorbDamage');
...
const ModifierDeathWatchDamageEnemyGeneralHealMyGeneral = require('@duelyst/sdk/modifiers/modifierDeathWatchDamageEnemyGeneralHealMyGeneral');
const ModifierRangedProvoke = require('@duelyst/sdk/modifiers/modifierRangedProvoke');
...
const ModifierMyTeamMoveWatchBuffTarget = require('@duelyst/sdk/modifiers/modifierMyTeamMoveWatchAnyReasonBuffTarget');
...
const ModifierDoubleDamageToGenerals = require('@duelyst/sdk/modifiers/modifierDoubleDamageToGenerals');
const ModifierATKThresholdDie = require('@duelyst/sdk/modifiers/modifierATKThresholdDie');
const ModifierDeathWatchDamageRandomMinionHealMyGeneral = require('@duelyst/sdk/modifiers/modifierDeathWatchDamageRandomMinionHealMyGeneral');
const ModifierStartTurnWatchSpawnTile = require('@duelyst/sdk/modifiers/modifierStartTurnWatchSpawnTile');
const ModifierStartTurnWatchSpawnEntity = require('@duelyst/sdk/modifiers/modifierStartTurnWatchSpawnEntity');
const ModifierEndTurnWatchGainTempBuff = require('@duelyst/sdk/modifiers/modifierEndTurnWatchGainTempBuff');
const ModifierSentinel = require('@duelyst/sdk/modifiers/modifierSentinel');
const ModifierSentinelSetup = require('@duelyst/sdk/modifiers/modifierSentinelSetup');
const ModifierSentinelOpponentGeneralAttackHealEnemyGeneralDrawCard = require('@duelyst/sdk/modifiers/modifierSentinelOpponentGeneralAttackHealEnemyGeneralDrawCard');
const ModifierSentinelOpponentSummonBuffItDrawCard = require('@duelyst/sdk/modifiers/modifierSentinelOpponentSummonBuffItDrawCard');
const ModifierSentinelOpponentSpellCastRefundManaDrawCard = require('@duelyst/sdk/modifiers/modifierSentinelOpponentSpellCastRefundManaDrawCard');
const ModifierTakeDamageWatchSpawnRandomHaunt = require('@duelyst/sdk/modifiers/modifierTakeDamageWatchSpawnRandomHaunt');
const ModifierDyingWishDrawCard = require('@duelyst/sdk/modifiers/modifierDyingWishDrawCard');
const ModifierCannotAttackGeneral = require('@duelyst/sdk/modifiers/modifierCannotAttackGeneral');
const ModifierCannotCastBBS = require('@duelyst/sdk/modifiers/modifierCannotCastBBS');
const ModifierStartTurnWatchPutCardInOpponentsHand = require('@duelyst/sdk/modifiers/modifierStartTurnWatchPutCardInOpponentsHand');
const ModifierEndTurnWatchHealSelf = require('@duelyst/sdk/modifiers/modifierEndTurnWatchHealSelf');
const ModifierBackupGeneral = require('@duelyst/sdk/modifiers/modifierBackupGeneral');
const ModifierStartTurnWatchRespawnClones = require('@duelyst/sdk/modifiers/modifierStartTurnWatchRespawnClones');
ModifierCardControlledPlayerModifiers = require('@duelyst/sdk/modifiers/modifierCardControlledPlayerModifiers');
const ModifierSwitchAllegiancesGainAttack = require('@duelyst/sdk/modifiers/modifierSwitchAllegiancesGainAttack');
const ModifierOpponentSummonWatchRandomTransform = require('@duelyst/sdk/modifiers/modifierOpponentSummonWatchRandomTransform');
const ModifierOnSpawnKillMyGeneral = require('@duelyst/sdk/modifiers/modifierOnSpawnKillMyGeneral');
const ModifierDeathWatchGainAttackEqualToEnemyAttack = require('@duelyst/sdk/modifiers/modifierDeathWatchGainAttackEqualToEnemyAttack');
const ModifierDyingWishBuffEnemyGeneral = require('@duelyst/sdk/modifiers/modifierDyingWishBuffEnemyGeneral');
const ModifierStartTurnWatchDamageRandom = require('@duelyst/sdk/modifiers/modifierStartTurnWatchDamageRandom');
const ModifierOpponentSummonWatchSwapGeneral = require('@duelyst/sdk/modifiers/modifierOpponentSummonWatchSwapGeneral');
const ModifierDyingWishPutCardInOpponentHand = require('@duelyst/sdk/modifiers/modifierDyingWishPutCardInOpponentHand');
const ModifierEnemySpellWatchGainRandomKeyword = require('@duelyst/sdk/modifiers/modifierEnemySpellWatchGainRandomKeyword');
const ModifierAnySummonWatchGainGeneralKeywords = require('@duelyst/sdk/modifiers/modifierAnySummonWatchGainGeneralKeywords');
