...
const ModifierFate = require('@duelyst/sdk/modifiers/modifierFate');
...
class Card extends SDKObject {
  declare type: any;
  declare name: any;
  declare appliedToDeckByActionIndex: any;
  declare appliedToHandByActionIndex: any;
  declare appliedToBoardByActionIndex: any;
  declare appliedToSignatureCardsByActionIndex: any;
  declare canBeAppliedAnywhere: any;
  declare factionId: any;
  declare hideAsCardId: any;
  declare id: any;
  declare index: any;
  declare isPlayed: any;
  declare isRemoved: any;
  declare location: any;
  declare manaCost: any;
  declare modifierIndices: any;
  declare modifiersAppliedFromContextObjects: any;
  declare modifiersContextObjects: any;
  declare ownerId: any;
  declare parentCardIndex: any;
  declare position: any;
  declare raceId: any;
  declare rarityId: any;
  declare removedFromDeckByActionIndex: any;
  declare removedFromHandByActionIndex: any;
  declare removedFromBoardByActionIndex: any;
  declare removedFromSignatureCardsByActionIndex: any;
  declare subCardIndices: any;
  declare isNotOwnedByPlayer: any;
  declare getDoesOwnerHaveEnoughManaToAct: any;
  declare cleanse: any;
  declare dispel: any;
  ...
  createCardData(existingCardData?) {
    ...
    for (var key of Array.from<any>(this.getCardDataKeysForCopy())) {
  ...
  */
  ...
  setInherentModifiersContextObjects(modifiersContextObjects) {
    ...
    for (var modifierContextObject of Array.from<any>(modifiersContextObjects)) {
  ...
  getVisibleModifierStacks() {
    ...
    for (var stackSortKey of Array.from<any>(stackSortKeys)) {
  ...
  _getBuffedAttributeFromModifiers(
    ...
    const normal = [];
    const auras = [];
    for (modifier of Array.from<any>(modifiers)) {
    ...
    if (!stopAtBase || stopAtModifier != null) {
      ...
      for (modifier of Array.from<any>(normal)) {
