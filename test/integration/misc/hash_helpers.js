...
describe('login helpers', () => {
  ...
  describe('node.js callback style', () => {
    describe('generate hash function', () => {
      it('expect a hash when given a password', () =>
        new Promise((done) => {
    ...
    describe('compare password function', () => {
      it('expect true when comparing valid password and hash', () =>
        new Promise((done) => {
      ...
      it('expect false when comparing bad password and hash', () =>
        new Promise((done) => {
  ...
  describe('promises style', () => {
    describe('generate hash function', () => {
      it('expect a hash when given a password', () =>
        loginHelpers.generateHash(password).then((hash) => {
          expect(hash).to.exist;
    ...
    describe('compare password function', () => {
      it('expect true when comparing valid password and hash', () =>
        loginHelpers.comparePassword(password, returnedHash).then((match) => {
          expect(match).to.be.true;
        }));

      it('expect false when comparing bad password and hash', () =>
        loginHelpers.comparePassword(password, invalidHash).then((match) => {
          expect(match).to.be.false;
        }));
    });
  });
