...
describe('starter ai scoring', () => {
  describe('spell tests', () => {
    ...
    it('Circle of Life', () => {
      ...
      var positionsScoresAndFollowups =
        ai._findFilteredTargetPositionsScoresAndFollowupsForCardByIntent(
          card,
          positions,
          useThreshold,
          true,
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla 3/2 with own general at 25 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla 5/5 with own general at 25 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla 5/6 with own general at 25 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla 5/6 with own general at 3 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla 3/2 with own general at 20 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }

      const ranged = UtilsSDK.applyCardToBoard(
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged 3/2 with own general at 25 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged 3/2 with own general at 20 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged 5/6 with own general at 20 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged 5/6 with own general at 3 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged 5/5 with own general at 3 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      const deathwatch = UtilsSDK.applyCardToBoard(
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a deathwatch 2/2 with own general at 25 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a deathwatch 6/6 with own general at 15 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a deathwatch 6/6 with own general at 1 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Sundrop Elixir', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla 5/6 with 1 damage taken',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla 5/6 with 3 damage taken',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla 5/6 with 5 damage taken',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged 5/6 with 1 damage taken',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged 5/6 with 3 damage taken',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged 5/6 with 5 damage taken',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a deathwatch 5/6 with 1 damage taken',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a deathwatch 5/6 with 3 damage taken',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a deathwatch 5/6 with 5 damage taken',
          ' = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Tempest', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla friendly 2/2 and a vanilla enemy 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla friendly 2/3 and a vanilla enemy 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
        expect(bestPositionAndScore.score).to.be.above(25);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla friendly 2/2 and a vanilla enemy 2/3',
          ' = ',
          bestPositionAndScore.score,
        );
        expect(bestPositionAndScore.score).to.be.below(0);
      ...
      const ranged1 = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.FireSpitter },
        0,
        1,
        gameSession.getPlayer1Id(),
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged friendly 2/2 and a ranged enemy 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged friendly 2/3 and a ranged enemy 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged friendly 2/2 and a ranged enemy 2/3',
          ' = ',
          bestPositionAndScore.score,
        );
        expect(bestPositionAndScore.score).to.be.below(0);
    ...
    it('Decimate', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla friendly 2/2 and a vanilla enemy 2/2 and enemy ranged 3/2',
          ' = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Martyrdom', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla friendly 4/3 with own general at 20 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 4/3 with enemy general at 20 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 2/2 with enemy general at 25 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 2/2 with enemy general at 15 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 10/10 with enemy general at 25 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 10/10 with enemy general at 15 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 10/10 with enemy general at 5 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla friendly 10/10 with own general at 15 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla friendly 1/10 with own general at 15 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla friendly 10/10 with own general at 1 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged enemy 2/2 with enemy general at 15 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged enemy 6/6 with enemy general at 15 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged enemy 10/10 with enemy general at 1 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged enemy 1/1 with enemy general at 25 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged friendly 2/2 with own general at 15 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged friendly 2/2 with own general at 1 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged friendly 2/24 with own general at 1 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a deathwatch enemy 2/2 with enemy general at 15 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a deathwatch enemy 2/2 with enemy general at 1 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a deathwatch enemy 6/6 with enemy general at 10 HP',
          ' = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Holy Immolation', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.HolyImmolation,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a full health 2/2 with an enemy deathwatch 2/2, enemy ranged 3/2, and 25 HP enemy general nearby',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a damaged 2/2 (originally 2/6) with an enemy deathwatch 2/2, enemy ranged 3/2, and 25 HP enemy general nearby',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a damaged 2/2 (originally 2/6) with an enemy deathwatch 2/2, enemy ranged 3/6, and 25 HP enemy general nearby',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a damaged 2/2 (originally 2/6) with an enemy deathwatch 2/5, enemy ranged 3/6, and 15 HP enemy general nearby',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a full health 2/6 with an enemy deathwatch 2/5, enemy ranged 3/6, and 5 HP enemy general nearby',
          ' = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Kage Lightning', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.KageLightning,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
    ...
    it('Onyx Bear Seal', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.OnyxBearSeal,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
    ...
    it('Ghost Lightning', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 2/2, ranged 3/2, and deathwatcher 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 2/1, ranged 3/2, and deathwatcher 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 2/1, ranged 3/1, and deathwatcher 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 2/1, ranged 3/1, and deathwatcher 2/1',
          ' = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Metamorphosis', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 2/1, ranged 3/2',
          ' = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Sunbloom', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a grow enemy 2/2 and deathwatch 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a grow enemy 5/5 and deathwatch 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a blast enemy 1/1, grow enemy 5/5, and deathwatch 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a blast enemy 5/5, grow enemy 5/5, and deathwatch 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged enemy 2/2 and a grow enemy 5/5',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged enemy 6/6 and a grow enemy 5/5',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a vanilla enemy 10/10 and a ranged enemy 6/6',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged enemy 1/1 and a grow enemy 5/5',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on only a deathwatch enemy 2/2',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on only a deathwatch enemy 10/1',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on only a deathwatch enemy 6/6',
          ' = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Siphon Energy', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.SiphonEnergy,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
    ...
    it('Mana Vortex', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a spiral technique in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 2 spiral techniques in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 2 spiral techniques in hand but only 5 mana = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 2 spiral techniques and 1 phoenix fire in hand but only 5 mana = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Flash Reincarnation', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.FlashReincarnation,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 2 minions in hand but only the mana to play 1 = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 2 minions in hand and the mana to play both = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 3 minions in hand and the mana to play any = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 4 minions in hand and the mana to play any = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 5 minions in hand and the mana to play any = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Heavens Eclipse', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.HeavensEclipse,
        }),
      );
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInDeckAction(gameSession, gameSession.getPlayer1Id(), {
    ...
    it('Aerial Rift', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 1 spell and 1 minion in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 1 spell and 2 minions in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 1 spell and 3 minions in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 1 spell and 4 minions in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with 1 spell and 5 minions in hand = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Amplification', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.Amplification,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
    ...
    it('Spirit of the Wild', () => {
      ...
      const grow1 = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction5.EarthWalker },
        7,
        4,
        gameSession.getPlayer1Id(),
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a grow 3/3, vanilla 3/2 x2, ranged 3/2 = ',
          bestPositionAndScore.score,
        );
      }
      ...
      const mechaz0r = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.Mechaz0r },
        6,
        0,
        gameSession.getPlayer1Id(),
      );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a grow 3/3, vanilla 3/2 x2, ranged 3/2, mechaz0r = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Bloodtear Alchemist (followup)', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 3/3 grow at x7 y4, and 2/2 deathwatch at x7 y3 = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/1 ranged at x7 y1, 3/3 grow at x7 y4, and 2/2 deathwatch at x7 y3 = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/10 ranged at x7 y1, 15/1 grow at x7 y4, and 2/2 deathwatch at x7 y3 = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
    ...
    it('Ephemeral Shroud (followup)', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          '2/1 blast at x6 y3, and 2/2 deathwatch at x7 y3 = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/1 ranged at x2 y2, 15/1 blast at x6 y3, and 2/2 deathwatch at x7 y3 = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      ...
      const deathwatch3 = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction4.ShadowWatcher },
        2,
        3,
        gameSession.getPlayer2Id(),
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/10 ranged at x2 y2, 15/1 blast at x6 y3, 2/2 deathwatch at x7 y3, and 2/2 deathwatch at x2 y3 = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
    ...
    it('Healing Mystic (followup)', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 10 health damaged friendly general at x0 y2, 10 health damaged enemy general at x8 y2, 1/1 ranged at x7 y1, 2/1 blast at x6 y3, and 2/2 deathwatch at x7 y3 = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          "with a 1/1 ranged at x7 y1, 3/15 blast who's been damaged 14 at x6 y3, and 2/2 deathwatch at x7 y3 = ",
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          "with a 1/10 ranged at x7 y1, 3/15 blast who's been damaged 14 at x6 y3, 2/2 deathwatch at x7 y3, and a 2/2 deathwatch at x6 y1= ",
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
    ...
    it('Primus Fist (followup)', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Neutral.PrimusFist,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      const positionsScoresAndFollowups =
        ai._findFilteredTargetPositionsScoresAndFollowupsForCardByIntent(
          card,
          positions,
          useThreshold,
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/1 ranged at x7 y1, 2/1 blast at x6 y3, and 2/2 deathwatch at x7 y3 = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
    ...
    it('Arclyte Sentinel (followup)', () => {
      ...
      const blast2 = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction3.StarfireScarab },
        0,
        3,
        gameSession.getPlayer2Id(),
      );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/1 ranged (1,1), 4/6 blast (0,3), and 2/2 deathwatch (1,3) = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/1 ranged (1,1), 15/1 blast (0,3), and 2/3 deathwatch (1,3) = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/10 ranged (1/1), 15/1 blast (0,3), and 2/3 deathwatchs (1,3) = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
    ...
    it('Blood Siren (followup)', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Faction4.DarkSiren,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/1 ranged (1,1), 2/1 blast (0,3), and 2/2 deathwatch (1,3) = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/1 ranged (1,1), 15/1 blast (0,3), and 2/2 deathwatch (1,3) = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/10 ranged (1,1), 15/1 blast (0,3), and 2 2/2 deathwatchs (1,3)(0,1) = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
    ...
    it('Nightsorrow Assassin (followup)', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Faction4.NightsorrowAssassin,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 3/2 ranged (1,1), 2/1 blast (0,3), and 2/2 deathwatch (1,3) = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 3/2 ranged (1,1), 15/1 blast (0,3), and 2/2 deathwatch (1,3) = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 3/2 ranged (1,1), 15/1 blast (0,3), and 2 2/2 deathwatchs (1,3)(0,1) = ',
          bestPositionAndScore.score,
          'w/ followup positions',
          positionsScoresAndFollowups.followupPositions[0],
        );
    ...
    it('Crossbones (followup)', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Neutral.Crossbones,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
    ...
    it('Shadow Watcher', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/2 and a 15/1 on board = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/2, 15/1, and 2 2/2s on board = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Shadow Dancer', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Faction4.SharianShadowdancer,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/2 on board with both generals full health = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/2 on board with own general at 5 health = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/2 on board with own general at 5 health and enemy general at 2 health = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/2 and a 15/1 on board both generals at full health = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 1/2, 15/1, and 2 2/2s on board both generals at full health = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Aspect of the Mountain', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a full health 6/6 with an enemy deathwatch 2/2, enemy ranged 3/2, and 25 HP enemy general nearby',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a ranged friendly 3/2 isolated',
          ' = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on an enemy deathwatch 2/2 isolated',
          ' = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Natural Selection', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.NaturalSelection,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a friendly 6/6 and enemy 6/6 on board',
          ' = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Daemonic Lure (followup)', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.DaemonicLure,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a 3/2 golem at x2, y2 with follow up location: ',
          positionsScoresAndFollowups.followupPositions[0],
          ' = ',
          bestPositionAndScore.score,
        );
    ...
    it('Orb Weaver (followup)', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on tile x1, y1 with follow up location: ',
          positionsScoresAndFollowups.followupPositions[0],
          ' = ',
          bestPositionAndScore.score,
        );
    ...
    it('Wraithling Swarm (followup)', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.WraithlingSwarm,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a tile x1, y1 with follow up locations: ',
          positionsScoresAndFollowups.followupPositions[0],
          ' = ',
          bestPositionAndScore.score,
        );
    ...
    it('Chrysalis Burst', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.ChrysalisBloom,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
    ...
    it('Roar', () => {
      ...
      const deathwatch1 = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction4.ShadowWatcher },
        4,
        2,
        gameSession.getPlayer1Id(),
    ...
    it('Afterglow', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a 1 point damaged 3/2 golem = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a 3 point damaged 6/6 ranged = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Arcane Heart', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.ArcaneHeart,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
    ...
    it('Shadow Spawn', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.Shadowspawn,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
    ...
    it('Abyssal Scar', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.AbyssalScar,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
    ...
    it('Seeking Eye', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with enemy general at 6 cards and own general at 3 = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Warbird', () => {
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'when it hits general and a 3/2 golem = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'when it hits general, a 3/2 golem, and a 1/1 ranged = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'when it hits general, a 3/2 golem, a 1/1 ranged, and a 6/6 deathwatch = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Kinetic Surge', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.KineticSurge,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 3/2 golem and 1/1 ranged in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'with a 3/2 golem, 1/1 ranged, and 2/2 shadowwatcher in hand = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Darkfire Sacrifice', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.DarkSacrifice,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a 3/2 golem with no minions in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a 3/2 golem with a Vorpal Reaver in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a wraithling with a Vorpal Reaver in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a wraithling with 2 Vorpal Reavers in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a wraithling with 5 Vorpal Reavers in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a 3/2 golem with 5 Vorpal Reavers in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a 5/12 Khymera with 5 Vorpal Reavers in hand = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on a 2/2 deathwatch shadowwatcher with 5 Vorpal Reavers in hand = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Keeper of the Vale', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Neutral.KeeperOfTheVale,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on tile x1, y1 with 0 dead friendly units = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on tile x1, y1 with 1 dead friendly 3/2 golem = ',
          bestPositionAndScore.score,
        );
      }
      ...
      if (bestPositionAndScore != null) {
        console.log(
          'Score for',
          card.getName(),
          'on tile x1, y1 with 1 dead friendly 3/2 golem and 1 dead friendly 5/12 Khymera = ',
          bestPositionAndScore.score,
        );
      }
    ...
    it('Nether Summoning', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.NetherSummoning,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);
    ...
    it('Summon Intent Tests', () => {
      ...
      var positionsScoresAndFollowups =
        ai._findFilteredTargetPositionsScoresAndFollowupsForCardByIntent(
          card,
          position_adjacentTo_enemyGeneral,
          useThreshold,
          true,
        );
      var scoreForPosition_adjacentTo_enemyGeneral =
        positionsScoresAndFollowups.positionsAndScores[0];
      console.log(
        'Good summon score for',
        card.getName(),
        ` at ${position_adjacentTo_enemyGeneral[0].x},${position_adjacentTo_enemyGeneral[0].y} (adjacent to enemy general) = `,
        scoreForPosition_adjacentTo_enemyGeneral.score,
      );
      ...
      var positionsScoresAndFollowups =
        ai._findFilteredTargetPositionsScoresAndFollowupsForCardByIntent(
          card,
          position_AwayFromEnemyGeneral,
          useThreshold,
          true,
        );
      var scoreForPosition_AwayFromEnemyGeneral = positionsScoresAndFollowups.positionsAndScores[0];
      console.log(
        'Bad summon score for',
        card.getName(),
        ` at ${position_AwayFromEnemyGeneral[0].x},${position_AwayFromEnemyGeneral[0].y} (away from everything) = `,
        scoreForPosition_AwayFromEnemyGeneral.score,
      );
      ...
      // expect
      expect(scoreForPosition_adjacentTo_enemyGeneral.score).to.be.above(
        scoreForPosition_AwayFromEnemyGeneral.score,
      );
      ...
      var positionsScoresAndFollowups =
        ai._findFilteredTargetPositionsScoresAndFollowupsForCardByIntent(
          card,
          position_adjacentTo_enemyGeneral_enemyUnit,
          useThreshold,
          true,
        );
      const scoreForPosition_adjacentTo_enemyGeneral_enemyUnit =
        positionsScoresAndFollowups.positionsAndScores[0];
      console.log(
        'Good summon score for',
        card.getName(),
        ` at ${position_adjacentTo_enemyGeneral_enemyUnit[0].x},${position_adjacentTo_enemyGeneral_enemyUnit[0].y} (adjacent to enemy general and enemy unit) = `,
        scoreForPosition_adjacentTo_enemyGeneral_enemyUnit.score,
      );
      ...
      // expect
      expect(scoreForPosition_adjacentTo_enemyGeneral_enemyUnit.score).to.be.above(
        scoreForPosition_adjacentTo_enemyGeneral.score,
      );
      expect(scoreForPosition_adjacentTo_enemyGeneral.score).to.be.above(
        scoreForPosition_AwayFromEnemyGeneral.score,
      ...
      // expect
      expect(scoreForPosition_adjacentTo_enemyGeneral.score).to.be.below(
        scoreForPosition_AwayFromEnemyGeneral.score,
      );
    ...
    it('Teleport Intent Tests', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Spell.Juxtaposition,
        }),
      );
      const deck = player1.getDeck();
      const card = deck.getCardInHandAtIndex(0);

      var golem = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.SkyrockGolem },
        0,
        0,
        gameSession.getPlayer1Id(),
      );
      var heartseeker = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction2.Heartseeker },
        7,
        1,
        gameSession.getPlayer1Id(),
      ...
      console.log(
        'Score for teleport on badly-positioned friendly melee unit ',
        golem.getName(),
        ` at ${position[0].x},${position[0].y} = `,
        scoreForPosition_bad_meleePosition.score,
      );
      ...
      console.log(
        'Score for teleport on badly-positioned friendly ranged unit ',
        heartseeker.getName(),
        ` at ${position[0].x},${position[0].y} = `,
        scoreForPosition_bad_rangedPosition.score,
      );
      ...
      console.log(
        'Score for teleport on well-positioned friendly melee unit ',
        golem.getName(),
        ` at ${position[0].x},${position[0].y} = `,
        scoreForPosition_good_meleePosition.score,
      );
      ...
      const scoreForPosition_good_rangedPosition =
        positionsScoresAndFollowups.positionsAndScores[0];
      console.log(
        'Score for teleport on well-positioned friendly ranged unit ',
        heartseeker.getName(),
        ` at ${position[0].x},${position[0].y} = `,
        scoreForPosition_good_rangedPosition.score,
      );

      expect(scoreForPosition_good_rangedPosition.score).to.be.below(
        scoreForPosition_bad_rangedPosition.score,
      );
      expect(scoreForPosition_good_meleePosition.score).to.be.below(
        scoreForPosition_bad_meleePosition.score,
      );
    });
  });
