...
describe('faction2', () => {
  describe('minions', () => {
    ...
    it('expect tusk boar to return to hand at start of next turn', () => {
      ...
      const tuskBoar = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction2.TuskBoar },
        1,
        1,
        gameSession.getPlayer1Id(),
      );
    ...
    it('expect celestial phantom to kill any unit it deals damage to', () => {
      ...
      const celestialPhantom = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction2.CelestialPhantom },
        1,
        1,
        gameSession.getPlayer1Id(),
      );
    ...
    it('expect gorehorn to gain +1/+1 on attack', () => {
      ...
      const goreHorn = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction2.GoreHorn },
        1,
        1,
        gameSession.getPlayer1Id(),
      );
    ...
    it('expect jade monk to deal 1 damage to random enemy minion upon taking damage', () => {
      ...
      const totalDamage =
        silverguardSquire.getDamage() +
        silverguardSquire2.getDamage() +
        silverguardSquire3.getDamage();
    ...
    it('expect four winds magi to deal 1 damage and heal your general for 1 on every allied spell cast', () => {
      ...
      const fourWindsMagi = UtilsSDK.applyCardToBoard(
    ...
    it('expect storm kage to give kage lightning on damaging spell cast', () => {
      ...
      const stormKage = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction2.StormKage },
        0,
        1,
        gameSession.getPlayer1Id(),
      );
