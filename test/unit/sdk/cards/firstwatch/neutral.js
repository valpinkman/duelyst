...
describe('first watch', () => {
  describe('neutral', () => {
    ...
    it('expect wild tahr to gain +3 attack until end of turn whenever an enemy attacks', () => {
      ...
      const wildTahr = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.WildTahr },
        4,
        2,
      ...
      const snowchaser2 = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction6.WyrBeast },
        7,
        2,
        gameSession.getPlayer1Id(),
    ...
    it('expect komodo hunter to spawn 2 komodo chargers for your opponent', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Neutral.KomodoHunter,
        }),
      );
    ...
    it('expect rokadoptera to put a 0 mana, deal 1 damage spell in your hand', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Neutral.Rokadoptera,
        }),
      );
    ...
    it('expect sinister silhouette to not be attackable by minions or general', () => {
      ...
      const sinister = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.SinisterSilhouette },
        1,
        2,
        gameSession.getPlayer2Id(),
      );
    ...
    it('expect minions that quahog defeats to return to their owners action bar', () => {
      ...
      const quahog = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.Quahog },
        1,
        2,
        gameSession.getPlayer2Id(),
      );
    ...
    it('expect matter shaper to destroy an enemy artifact and to put a random artifact from your faction in your hand', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer2Id(), {
          id: SDK.Cards.Neutral.MatterShaper,
        }),
      );
    ...
    it('expect thunderhorn to deal its damage to all joined enemies', () => {
      ...
      const terradon3 = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction5.Terradon },
        4,
        3,
        gameSession.getPlayer2Id(),
      );
      const terradon4 = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Faction5.Terradon },
        5,
        1,
        gameSession.getPlayer2Id(),
      ...
      const thunderhorn = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.Thunderhorn },
        1,
        2,
        gameSession.getPlayer1Id(),
      );
    ...
    it('expect spriggin to summon 3 spriggin kin nearby each general', () => {
      ...
      if (
        allySpriggans[0].getId() == SDK.Cards.Neutral.PartyAnimal1 ||
        allySpriggans[0].getId() == SDK.Cards.Neutral.PartyAnimal2 ||
        allySpriggans[0].getId() == SDK.Cards.Neutral.PartyAnimal3 ||
        allySpriggans[0].getId() == SDK.Cards.Neutral.PartyAnimal4
      ) {
      ...
      if (
        enemySpriggans[0].getId() == SDK.Cards.Neutral.PartyAnimal1 ||
        enemySpriggans[0].getId() == SDK.Cards.Neutral.PartyAnimal2 ||
        enemySpriggans[0].getId() == SDK.Cards.Neutral.PartyAnimal3 ||
        enemySpriggans[0].getId() == SDK.Cards.Neutral.PartyAnimal4
      ) {
    ...
    it('expect spriggin kin glub to gain +3/+3 whenever a spriggin dies', () => {
      ...
      const glub = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.PartyAnimal1 },
        1,
        2,
        gameSession.getPlayer1Id(),
      );
      const spriggin2 = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.Spriggin },
        3,
        2,
        gameSession.getPlayer2Id(),
      );
      const spriggin1 = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.Spriggin },
        4,
        2,
        gameSession.getPlayer1Id(),
    ...
    it('expect spriggin kin binky to heal your general for 2 whenever it damages a minion', () => {
      ...
      const binky = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.PartyAnimal2 },
        3,
        2,
        gameSession.getPlayer1Id(),
      );
    ...
    it('expect spriggin kin moro to have +3 attack as long as a spriggin lives', () => {
      ...
      const moro = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.PartyAnimal4 },
        1,
        2,
        gameSession.getPlayer1Id(),
      );
    ...
    it('expect bloodsworn gambler to have a chance of randomly activating and attacking again', () => {
      ...
      do {
        ...
        const gambler = UtilsSDK.applyCardToBoard(
          { id: SDK.Cards.Neutral.Gambler },
          1,
          2,
          gameSession.getPlayer1Id(),
        );
    ...
    it('expect letigress to summon a saberspine cub every time your general attacks', () => {
      ...
      const letigress = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.Letigress },
        4,
        2,
        gameSession.getPlayer1Id(),
      );
    ...
    it('expect magesworn to stop both players from casting spells that cost 2 or less', () => {
      ...
      const magesworn = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.Magesworn },
        4,
        2,
        gameSession.getPlayer1Id(),
      );
    ...
    it('expect dagona to not be summonable on spaces not occupied by minions', () => {
      ...
      UtilsSDK.executeActionWithoutValidation(
        new SDK.PutCardInHandAction(gameSession, gameSession.getPlayer1Id(), {
          id: SDK.Cards.Neutral.DagonaFish,
        }),
      );
    ...
    it('expect dagona to consume the minion it is summoned on and to spit it out when it dies', () => {
      ...
      var magesworn = UtilsSDK.applyCardToBoard(
        { id: SDK.Cards.Neutral.Magesworn },
        4,
        2,
        gameSession.getPlayer2Id(),
