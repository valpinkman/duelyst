...
var UtilityMainMenuTmpl = require('apps/client/ui/templates/item/utility_main_menu.hbs');
...
var QuestLogLayout = require('apps/client/ui/views2/quests/quest_log_layout');
