...
var DeckSlidingPanelItemView = require('apps/client/ui/views/item/deck_sliding_panel');
var DeckSelectTmpl = require('apps/client/ui/templates/composite/deck_select.hbs');
var DeckSelectEmptyTmpl = require('apps/client/ui/templates/item/deck_select_empty.hbs');
var DeckSelectEmptyStandardTmpl = require('apps/client/ui/templates/item/deck_select_empty_standard.hbs');
var RiftDeckSelectEmptyTmpl = require('apps/client/ui/templates/item/rift_deck_select_empty.hbs');
var ArenaDeckSelectEmptyTmpl = require('apps/client/ui/templates/item/arena_deck_select_empty.hbs');
...
var ChangeBattleMapItemView = require('apps/client/ui/views/item/change_battle_map_dialog');
var DuelystBackbone = require('apps/client/ui/extensions/duelyst_backbone');
var RiftRunDeckView = require('apps/client/ui/views2/rift/rift_run_deck');
var i18next = require('i18next');
var ArenaRunDeckView = require('apps/client/ui/views2/arena/arena_run_deck');
