...
var BuddiesTemplate = require('apps/client/ui/templates/layouts/buddies.hbs');
var BuddyListView = require('apps/client/ui/views/item/buddy_list');
var BuddySelectionEmptyView = require('apps/client/ui/views/item/buddy_selection_empty');
