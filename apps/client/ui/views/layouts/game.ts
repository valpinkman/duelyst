...
var GameTmpl = require('apps/client/ui/templates/layouts/game.hbs');
...
var GameFollowupItemView = require('apps/client/ui/views/item/game_followup');
...
var NetworkManager = require('apps/client/networkManager');
...
var GameTopBarCompositeView = require('apps/client/ui/views/composite/game_top_bar');
var GameBottomBarCompositeView = require('apps/client/ui/views/composite/game_bottom_bar');
var GameChooseHandItemView = require('apps/client/ui/views/item/game_choose_hand');
var GameStartingHandItemView = require('apps/client/ui/views/item/game_starting_hand');
var GamePlayerProfilePreview = require('apps/client/ui/views/composite/game_player_profile_preview');
