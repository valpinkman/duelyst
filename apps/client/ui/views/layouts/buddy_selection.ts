...
var BuddySelectionTemplate = require('../../templates/layouts/buddy_selection.hbs');
var ConversationCompositeView = require('../composite/conversation');
var ConfirmDialogItemView = require('../item/confirm_dialog');
