...
var BuddySelectionTemplate = require('apps/client/ui/templates/layouts/buddy_selection.hbs');
var ConversationCompositeView = require('apps/client/ui/views/composite/conversation');
var ConfirmDialogItemView = require('apps/client/ui/views/item/confirm_dialog');
var ProfileLayout = require('apps/client/ui/views2/profile/profile_layout');
