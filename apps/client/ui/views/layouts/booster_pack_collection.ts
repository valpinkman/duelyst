...
var BoosterPackOpeningLayer = require('../../../view/layers/booster/BoosterPackOpeningLayer');
var TransitionRegion = require('../regions/transition');
var BoosterPackCollectionLayoutTemplate = require('../../templates/layouts/booster_pack_collection.hbs');
var InventoryManager = require('../../managers/inventory_manager');
var BoosterPacksCompositeView = require('../composite/booster_packs');
var ActivityDialogItemView = require('../item/activity_dialog');
var NavigationManager = require('../../managers/navigation_manager');
var SoundEffectSequence = require('../../../audio/SoundEffectSequence');
