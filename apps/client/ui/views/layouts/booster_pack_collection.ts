...
var BoosterPackOpeningLayer = require('apps/client/view/layers/booster/BoosterPackOpeningLayer');
var TransitionRegion = require('apps/client/ui/views/regions/transition');
var BoosterPackCollectionLayoutTemplate = require('apps/client/ui/templates/layouts/booster_pack_collection.hbs');
var InventoryManager = require('apps/client/ui/managers/inventory_manager');
var BoosterPacksCompositeView = require('apps/client/ui/views/composite/booster_packs');
...
var SoundEffectSequence = require('apps/client/audio/SoundEffectSequence');
