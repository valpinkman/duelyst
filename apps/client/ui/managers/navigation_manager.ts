...
var NotificationsLayout = require('apps/client/ui/views/layouts/notifications');
var ConfirmDialogItemView = require('apps/client/ui/views/item/confirm_dialog');
var ConfirmPurchaseDialogView = require('apps/client/ui/views2/shop/confirm_purchase_dialog');
var LoadingDialogItemView = require('apps/client/ui/views/item/loading_dialog');
var MaintenanceAnnouncementItemView = require('apps/client/ui/views/item/maintenance_announcement');
