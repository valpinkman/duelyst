...
var NewPlayerFeatureLookup = require('@duelyst/sdk/progression/newPlayerProgressionFeatureLookup');
var NewPlayerProgressionStageEnum = require('@duelyst/sdk/progression/newPlayerProgressionStageEnum');
var NewPlayerProgressionModuleLookup = require('@duelyst/sdk/progression/newPlayerProgressionModuleLookup');
var NewPlayerProgressionHelper = require('@duelyst/sdk/progression/newPlayerProgressionHelper');
...
var NewPlayerManager = Manager.extend({
    ...
    this.onReady().then(
      function () {
        ...
        this.listenTo(
          ...
          this._onChallengeCompleted,
        );
        this.listenTo(
          ProgressionManager.getInstance(),
          EVENTS.challenge_attempted,
          this._onChallengeAttempted,
        );
  ...
  getCurrentCoreStage: function () {
    var coreModule =
      this.newPlayerModulesCollection &&
      this.newPlayerModulesCollection.get(NewPlayerProgressionModuleLookup.Core);
    return (
      (coreModule && NewPlayerProgressionStageEnum[coreModule.get('stage')]) ||
  ...
  canSeeSpiritOrbs: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.MainMenuSpiritOrbs,
      this.getCurrentCoreStage(),
    );
  },

  canSeeWatchSection: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.MainMenuWatch,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canSeeCodex: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.MainMenuCodex,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canSeeArmory: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.UtilityMenuShop,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canAccessCollection: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.MainMenuCollection,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canSeeQuests: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.UtilityMenuQuests,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canSeeDailyChallenge: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.UtilityMenuDailyChallenge,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canSeeFreeCardOfTheDay: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.UtilityMenuFreeCardOfTheDay,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canSeeProfile: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.UtilityMenuProfile,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canSeeCrates: function () {
    return (
      NewPlayerProgressionHelper.isFeatureAvailableAtStage(
        NewPlayerFeatureLookup.MainMenuCrates,
        this.getCurrentCoreStage(),
  ...
  canSeeFirstWinOfTheDay: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.FirstWinOfTheDay,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canPlayGauntlet: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.PlayModeGauntlet,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canPlayQuickMatch: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.PlayModeCasual,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canPlayRanked: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.PlayModeRanked,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canPlayNonTutorialChallenges: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.PlayModeSoloChallenges,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canPlayBossBattle: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.PlayModeBossBattle,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canPlaySandbox: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.PlayModeSandbox,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canPlayPractice: function () {
    return NewPlayerProgressionHelper.isFeatureAvailableAtStage(
      NewPlayerFeatureLookup.PlayModePractice,
      this.getCurrentCoreStage(),
    );
  },
  ...
  canPlayPlayMode: function (playMode) {
    if (playMode == SDK.PlayModes.Practice) {
      ...
      console.error(
        'NewPlayerManager:canPlayPlayMode Error - Unknown play mode identifier: ' + playMode,
      );
    }
  },
  ...
  getEmphasizeMatchmaking: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.Matchmaking) == this._moduleStages.unread
    );
  },

  getEmphasizeStarterDecksTab: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.StarterDeckTab) ==
      this._moduleStages.unread
    );
  },
  ...
  getEmphasizeBoosterUnlock: function () {
    ...
    return (
      InventoryManager.getInstance().walletModel.get('gold_amount') >= 100 &&
      this.getCurrentCoreStage().value < NewPlayerProgressionHelper.FinalStage.value
    );
  },
  ...
  setHasPurchasedBoosterPack: function () {
    ...
    if (
      this.getModuleStage(NewPlayerProgressionModuleLookup.BoosterUnlock) ==
      this._moduleStages.unread
    ) {
  ...
  getHasUsedRiftUpgrade: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.RiftUpgradeUsed) ==
      this._moduleStages.read
    );
  },
  ...
  setHasUsedRiftUpgrade: function (val) {
    if (
      ...
      this.setModuleStage(
        NewPlayerProgressionModuleLookup.RiftUpgradeUsed,
        this._moduleStages.read,
      );
    }
  },
  ...
  setNeedsToSeeStarterDecksTab: function (val) {
    ...
    if (
      val &&
      this.getModuleStage(NewPlayerProgressionModuleLookup.StarterDeckTab) ===
        this._moduleStages.inactive
    ) {
      this.setModuleStage(
        NewPlayerProgressionModuleLookup.StarterDeckTab,
        this._moduleStages.unread,
      );
    }
  },
  ...
  getHasSeenBloodbornSpellInfo: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.BloodbornSpellInfo) ==
      this._moduleStages.read
    );
  },
  ...
  setHasSeenBloodbornSpellInfo: function () {
    this.setModuleStage(
      NewPlayerProgressionModuleLookup.BloodbornSpellInfo,
      this._moduleStages.read,
    );
  },
  ...
  getHasSeenBattlePetInfo: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.BattlePetInfo) == this._moduleStages.read
    );
  },
  ...
  getHasSeenBattlePetReminder: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.BattlePetReminder) ==
      this._moduleStages.read
    );
  },
  ...
  setHasSeenBattlePetReminder: function () {
    this.setModuleStage(
      NewPlayerProgressionModuleLookup.BattlePetReminder,
      this._moduleStages.read,
    );
  },
  ...
  getHasSeenBattlePetActionNotification: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.BattlePetActionNotification) ==
      this._moduleStages.read
    );
  },
  ...
  setHasSeenBattlePetActionNotification: function () {
    this.setModuleStage(
      NewPlayerProgressionModuleLookup.BattlePetActionNotification,
      this._moduleStages.read,
    );
  },
  ...
  getHasReceivedCrateProduct: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.ReceivedCrate) == this._moduleStages.read
    );
  },
  ...
  getHasPlayedRanked: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.Matchmaking) == this._moduleStages.read
    );
  },
  ...
  getHasPlayedSinglePlayer: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.SinglePlayerPlayed) ==
      this._moduleStages.read
    );
  },
  ...
  setHasPlayedSinglePlayer: function (lastGameModel) {
    if (lastGameModel && lastGameModel.get('game_type') == SDK.GameType.SinglePlayer) {
      ...
      if (!this.getHasPlayedSinglePlayer()) {
        ...
        Analytics.track(
          'first single player game completed',
          {
            category: Analytics.EventCategory.FTUE,
            game_id: lastGameModel.get('id'),
            game_outcome: outcomeKey,
      ...
      if (
        ...
        return this.setModuleStage(
          NewPlayerProgressionModuleLookup.SinglePlayerPlayed,
          this._moduleStages.read,
        );
      }
    }
  ...
  getHasOpenedSpiritOrb: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.SpiritOrbOpened) ==
      this._moduleStages.read
    );
  },
  ...
  setHasOpenedSpiritOrb: function (val) {
    if (val) {
      this.setModuleStage(
        NewPlayerProgressionModuleLookup.SpiritOrbOpened,
        this._moduleStages.read,
      );
    }
  },
  ...
  getHasCraftedCard: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.SraftedCard) == this._moduleStages.read
    );
  },
  ...
  getHasSeenGameGoldTipConfirmation: function () {
    return (
      this.getModuleStage(NewPlayerProgressionModuleLookup.GameGoldTips) == this._moduleStages.read
    );
  },
  ...
  setModuleStage: function (moduleName, stage) {
    ...
    return Promise.resolve(
      ...
      if (moduleName == NewPlayerProgressionModuleLookup.Core) {
        var newModuleStageIndex = _.indexOf(
          _.map(NewPlayerProgressionStageEnum.enums, function (val) {
            return val.key;
          }),
          stage,
        );
  ...
  _onWalletChange: function () {
    ...
    if (
      ...
      if (this.canBuyBoosters()) {
        this.setModuleStage(
          NewPlayerProgressionModuleLookup.BoosterUnlock,
          this._moduleStages.unread,
        );
      }
    }
  ...
  updateCoreState: function () {
    ...
    if (this.getCurrentCoreStage() == NewPlayerProgressionStageEnum.Tutorial) {
      if (
        ProgressionManager.getInstance().hasCompletedChallengeCategory(
        ...
        return Promise.resolve(
          ...
          .then(
            function (response) {
              if (response && response.progressionData) {
                ...
                var module = this.newPlayerModulesCollection.get(
                ...
                if (module && module.get('stage') != progressionData.stage) {
                  ...
                  var secondsSinceRegistration = Math.floor(
                    (new Date().getTime() -
                      ProfileManager.getInstance().profile.getRegistrationDate()) /
                      1000.0,
                  );
                  ...
                  var newModuleStageIndex = _.indexOf(
                    ...
                    progressionData.stage,
                  );
                  if (newModuleStageIndex > 0) {
                    var completedModuleStage =
                      NewPlayerProgressionStageEnum.enums[newModuleStageIndex - 1];
                    Analytics.track(
                      'completed ftue stage',
                      {
                        category: Analytics.EventCategory.Marketing,
          ...
          .then(
            function (response) {
              ...
              var coreStageCodexUnlocks =
                NewPlayerProgressionHelper.featureToCoreStageMapping[
                  NewPlayerFeatureLookup.MainMenuCodex
                ];
  ...
  shouldStartGeneratingDailyQuests: function () {
    return (
      this.getCurrentCoreStage().value >=
  ...
  _completeProgression: function () {
    ...
    _.each(
      SDK.ChallengeFactory.getChallengesForCategoryType(SDK.ChallengeCategory.tutorial.type),
      function (challenge) {
