...
const FXEnergyBall = require('apps/client/view/nodes/fx/FXEnergyBallSprite');
const FXLensFlareSprite = require('apps/client/view/nodes/fx/FXLensFlareSprite');
const FXFireRing = require('apps/client/view/nodes/fx/FXFireRingSprite');
const TweenTypes = require('apps/client/view/actions/TweenTypes');
const ToneCurve = require('apps/client/view/actions/ToneCurve');
const Shake = require('apps/client/view/actions/Shake');
const CoreGemNode = require('apps/client/view/nodes/gem/CoreGemNode');
...
const InventoryManager = require('apps/client/ui/managers/inventory_manager');
