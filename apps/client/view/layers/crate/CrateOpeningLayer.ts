...
const LootCrateNode = require('apps/client/view/nodes/reward/LootCrateNode');
const GiftCrateNode = require('apps/client/view/nodes/reward/GiftCrateNode');
const FrostfireCrateNode = require('apps/client/view/nodes/reward/FrostfireCrateNode');
const FrostfirePremiumCrateNode = require('apps/client/view/nodes/reward/FrostfirePremiumCrateNode');
const MysteryCrateNode = require('apps/client/view/nodes/reward/MysteryCrateNode');
const MysteryT1CrateNode = require('apps/client/view/nodes/reward/MysteryT1CrateNode');
const MysteryT2CrateNode = require('apps/client/view/nodes/reward/MysteryT2CrateNode');
const MysteryT3CrateNode = require('apps/client/view/nodes/reward/MysteryT3CrateNode');
const MysteryBossCrateNode = require('apps/client/view/nodes/reward/MysteryBossCrateNode');
