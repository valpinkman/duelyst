...
class InventoryModule {
  ...
  static giveUserGold(trxPromise, trx, userId, goldAmount, memo, sourceId?) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `modifyWalletGoldByAmount() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify gold in wallet : invalid user ID - ${userId}`),
      );
    }
    ...
    if (!goldAmount) {
      Logger.module('InventoryModule').debug(
        `modifyWalletGoldByAmount() -> invalid gold amount - ${goldAmount}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify gold in wallet : invalid gold amount - ${goldAmount}`),
      );
    }
    ...
    Logger.module('InventoryModule').time(
      `giveUserGold() -> User ${userId.blue}`.green + ` received ${goldAmount} gold.`.green,
    );
    ...
    return Promise.all([
      ...
      knex('users')
        .where('id', userId)
        .update('wallet_updated_at', NOW_UTC_MOMENT.toDate())
        .transacting(trx),
      ...
      .then(function (fbRootRef) {
        ...
        return FirebasePromises.safeTransaction(
          fbRootRef.child('user-inventory').child(userId).child('wallet'),
          updateWalletData,
        );
      })
      .then(() =>
        Logger.module('InventoryModule').timeEnd(
          `giveUserGold() -> User ${userId.blue}`.green + ` received ${goldAmount} gold.`.green,
        ),
      );
  }
  ...
  static debitGoldFromUser(trxPromise, trx, userId, goldAmount, memo, sourceId?) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `debitGoldFromUser() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify gold in wallet : invalid user ID - ${userId}`),
      );
    ...
    if (!goldAmount) {
      Logger.module('InventoryModule').debug(
        `debitGoldFromUser() -> invalid gold amount - ${goldAmount}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify gold in wallet : invalid gold amount - ${goldAmount}`),
      );
    ...
    Logger.module('InventoryModule').time(
      `debitGoldFromUser() -> User ${userId.blue}`.green + ` received ${goldAmount} gold.`.green,
    );
    ...
    return knex('users')
      ...
      .then(() =>
        Logger.module('InventoryModule').timeEnd(
          `debitGoldFromUser() -> User ${userId.blue}`.green +
            ` received ${goldAmount} gold.`.green,
        ),
      );
  }
  ...
  static giveUserSpirit(trxPromise, trx, userId, spiritAmount, memo) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `modifyWalletSpiritByAmount() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify spirit in wallet : invalid user ID - ${userId}`),
      );
    }
    ...
    if (spiritAmount == null) {
      Logger.module('InventoryModule').debug(
        `modifyWalletSpiritByAmount() -> invalid spirit amount - ${spiritAmount}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify spirit in wallet : invalid spirit amount - ${spiritAmount}`),
      );
    }
    ...
    Logger.module('InventoryModule').time(
      `giveUserSpirit() -> User ${userId.blue}`.green + ` received ${spiritAmount} spirit.`.green,
    );
    ...
    return Promise.all([
      ...
      knex('users')
        .where('id', userId)
        .increment('total_spirit_earned', spiritAmount)
        .transacting(trx),
      knex('users')
        .where('id', userId)
        .update('wallet_updated_at', NOW_UTC_MOMENT.toDate())
      ...
      .then(function (fbRootRef) {
        const updateWalletData = function (walletData?) {
          ...
          if (walletData.spirit_amount == null) {
            walletData.spirit_amount = 0;
          }
          walletData.spirit_amount += spiritAmount;
          return walletData;
      ...
      .then(() =>
        Logger.module('InventoryModule').timeEnd(
          `giveUserSpirit() -> User ${userId.blue}`.green +
            ` received ${spiritAmount} spirit.`.green,
        ),
      );
  }
  ...
  static giveUserPremium(trxPromise, trx, userId, amount, memo) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `modifyWalletPremiumByAmount() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify premium currency in wallet : invalid user ID - ${userId}`),
      );
    }
    ...
    if (!amount) {
      Logger.module('InventoryModule').debug(
        `modifyWalletPremiumByAmount() -> invalid amount - ${amount}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify premium currency in wallet : invalid amount - ${amount}`),
      );
    }
    ...
    Logger.module('InventoryModule').time(
      `giveUserPremium() -> User ${userId.blue}`.green + ` received ${amount}.`.green,
    );
    ...
    return Promise.all(allPromises)
      ...
      .then(function (fbRootRef) {
        const updateWalletData = function (walletData?) {
          ...
          if (walletData.premium_amount == null) {
  ...
  static debitPremiumFromUser(trxPromise, trx, userId, amount, memo) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `debitPremiumFromUser() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify premium currency in wallet : invalid user ID - ${userId}`),
      );
    ...
    if (!amount) {
      Logger.module('InventoryModule').debug(
        `debitPremiumFromUser() -> invalid amount - ${amount}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify premium currency in wallet : invalid amount - ${amount}`),
      );
    ...
    Logger.module('InventoryModule').time(
      `debitPremiumFromUser() -> User ${userId.blue}`.green + ` received ${amount}.`.green,
    );
   ...
   */
  static giveUserNewPurchasableCosmetic(
    trxPromise,
    trx,
    userId,
    transactionType,
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `giveUserNewPurchasableCosmetic() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not give user new cosmetic: invalid user ID - ${userId}`),
      );
    }
    ...
    if (transactionType == null || transactionId == null) {
      Logger.module('InventoryModule').debug(
        `giveUserNewPurchasableCosmetic() -> invalid transaction details: type - ${transactionType} id - ${transactionId}.`
          .red,
      );
      return Promise.reject(
        new Error(
          `Can not give user new cosmetic: invalid transaction details: type - ${transactionType} id - ${transactionId}`,
        ),
      );
    }
    ...
    if (cosmeticType != null && !_.contains(_.values(SDK.CosmeticsTypeLookup), cosmeticType)) {
      Logger.module('InventoryModule').debug(
        `giveUserNewPurchasableCosmetic() -> invalid cosmetic type: type - ${cosmeticType} user ID - ${userId}.`
          .red,
      );
      return Promise.reject(
        new Error(
          `Can not give user new cosmetic: invalid cosmetic type: type - ${cosmeticType} user ID - ${userId}`,
        ),
      );
    }
    ...
    if (rarityId != null && !_.contains(_.values(SDK.Rarity), rarityId)) {
      Logger.module('InventoryModule').debug(
        `giveUserNewPurchasableCosmetic() -> invalid rarity type: type - ${rarityId} user ID - ${userId}.`
          .red,
      );
      return Promise.reject(
        new Error(
          `Can not give user new cosmetic: invalid rarity type: type - ${rarityId} user ID - ${userId}`,
        ),
      );
    }
    ...
    Logger.module('InventoryModule').time(
      `giveUserNewPurchasableCosmetic() -> User ${userId.blue}`.green +
        ` transactionType ${transactionType} cosmeticType ${cosmeticType} rarityId ${rarityId} .`
          .green,
    );
    ...
    if (cosmeticIdsOwned != null) {
      ...
      currentCosmeticInventoryPromise = currentCosmeticInventoryPromise.then(
        function (cosmeticRows) {
          cosmeticIdsOwned = [];
          if (cosmeticRows != null) {
            cosmeticIdsOwned = _.map(cosmeticRows, (cosmeticRow) =>
              parseInt(cosmeticRow.cosmetic_id),
            );
          }
    ...
    return currentCosmeticInventoryPromise
      .then(function (cosmeticIdsOwned) {
        ...
        if (cosmeticType != null && rarityId != null) {
          matchingPotentialCosmetics = SDK.CosmeticsFactory.cosmeticsForTypeAndRarity(
            cosmeticType,
            rarityId,
          );
        ...
        const purchasablePotentialCosmetics = _.filter(
          matchingPotentialCosmetics,
          (cosmeticData) => cosmeticData.purchasable === true && cosmeticData.enabled === true,
        );

        const unownedMatchingCosmetics = _.filter(
          purchasablePotentialCosmetics,
          (cosmeticData) => !_.contains(cosmeticIdsOwned, cosmeticData.id),
        );
        ...
        if (unownedMatchingCosmetics.length !== 0) {
          ...
          const sortedUnownedMatchingCosmetics = _.sortBy(
            unownedMatchingCosmetics,
            (cosmeticData) => cosmeticData.rewardOrder,
          );

          const targetRewardOrder = sortedUnownedMatchingCosmetics[0].rewardOrder;

          const lowestOrderUnownedCosmetics = _.filter(
            sortedUnownedMatchingCosmetics,
            (cosmeticData) => cosmeticData.rewardOrder === targetRewardOrder,
          );
      ...
      .then(function (cosmeticRewardData) {
        Logger.module('InventoryModule').timeEnd(
          `giveUserNewPurchasableCosmetic() -> User ${userId.blue}`.green +
            ` transactionType ${transactionType} cosmeticType ${cosmeticType} rarityId ${rarityId} .`
              .green,
  ...
  static giveUserCosmeticId(
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `giveUserCosmeticId() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not give user cosmetic id : invalid user ID - ${userId}`),
      );
    }
    ...
    if (cosmeticId == null) {
      Logger.module('InventoryModule').debug(
        `giveUserCosmeticId() -> invalid cosmetic id - ${cosmeticId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not give user cosmetic id : invalid cosmetic ID - ${cosmeticId}`),
      );
    }
    ...
    if (!cosmeticData.enabled) {
      Logger.module('InventoryModule').debug(
        `giveUserCosmeticId() -> disabled cosmetic id - ${cosmeticId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not give user cosmetic id : disabled cosmetic ID - ${cosmeticId}`),
      );
    }
    ...
    if (transactionType == null || transactionId == null) {
      Logger.module('InventoryModule').debug(
        `giveUserCosmeticId() -> invalid transaction details: type - ${transactionType} id - ${transactionId}.`
          .red,
      );
      return Promise.reject(
        new Error(
          `Can not give user cosmetic id : invalid transaction details: type - ${transactionType} id - ${transactionId}`,
        ),
      );
    }
    ...
    Logger.module('InventoryModule').time(
      `giveUserCosmeticId() -> User ${userId.blue}`.green +
        ` received ${cosmeticId} cosmetic id.`.green,
    );

    // First check if user already owns the cosmetic id
    return trx('user_cosmetic_inventory')
      .where('user_id', userId)
      .andWhere('cosmetic_id', cosmeticId)
      .first('cosmetic_id')
      .then(function (cosmeticRow) {
        if (cosmeticRow != null) {
          Logger.module('InventoryModule').debug(
            `giveUserCosmeticId() -> duplicate cosmetic id - ${cosmeticId}.`,
          );
          ...
          if (cosmeticRarityId != null) {
            spiritValue =
              SDK.RarityFactory.rarityForIdentifier(cosmeticRarityId).spiritRewardCosmetic;
          }
          ...
          if (manualSpiritOverrideAmount != null) {
            ...
            if (
              _.isFinite(manualSpiritOverrideAmount) &&
              manualSpiritOverrideAmount >= 0 &&
              manualSpiritOverrideAmount <= spiritValue
            ) {
              spiritValue = manualSpiritOverrideAmount;
            } else {
              // not _.isFinite(manualSpiritOverrideAmount) or not (manualSpiritOverrideAmount < spiritValue)
              return Promise.reject(
                new Errors.BadRequestError(
                  'Spirit Refund amount is higher than it should be for this rarity',
                ),
              );
            }
          }
          ...
          Logger.module('InventoryModule').debug(
            `giveUserCosmeticId() -> duplicate cosmetic id - ${cosmeticId} giving user - ${userId} spirit ${spiritValue}.`,
          );
          ...
          if (spiritValue > 0) {
            return InventoryModule.giveUserSpirit(
              ...
              userId,
              spiritValue,
              `dupe cosmetic ${cosmeticId} trans type ${transactionType} trans id ${transactionId}`,
            );
          } else {
            return Promise.resolve();
          }
            ...
            .then(function (fbRootRef) {
              ...
              return FirebasePromises.set(
                fbRootRef
                  ...
                  .child(_chainState.resValue.cosmetic_id),
                fbCosmeticData,
              );
            });
        } else {
    ...
    return Promise.all([
      ...
      for (var cardIdKey in cardIds) {
        ...
        if (levelRequiredForCard > 0) {
          var factionRequiredForCard =
            SDK.FactionProgression.factionRequiredForCard(nonSkinnedCardId);
          factionLevel = factionLevel_FactionId[factionRequiredForCard];
          var unlockedCardIds = SDK.FactionProgression.unlockedCardsUpToLevel(
            factionLevel,
            factionRequiredForCard,
          );
        ...
        if (!cardCollectionRow) {
          Logger.module('InventoryModule').error(
            `isAllowedToUseCards() -> no cards found in player inventory - ${userId.blue}.`.red,
          );
        ...
        if (
          !(cardCollectionRow != null ? cardCollectionRow.cards[cardIdKey] : undefined) ||
          !(
            (cardCollectionRow != null ? cardCollectionRow.cards[cardIdKey].count : undefined) >=
            numCards
          )
        ) {
          Logger.module('InventoryModule').error(
            `isAllowedToUseCards() -> player doesn't own enough copies of card (id:${cardIdKey}) - ${userId.blue}.`
              .red,
          );
      ...
      for (var cardIdKey in cardIds) {
        ...
        if (cardCollectionRow != null) {
          ...
          if (cardData != null) {
            var asc1, end1;
            for (
              i = 0, end1 = Math.min(cardData.count, numCards), asc1 = end1 >= 0;
              asc1 ? i < end1 : i > end1;
              asc1 ? i++ : i--
            ) {
              usableCards.push(cardId);
  ...
  static isAllowedToUseCosmetic(txPromise, tx, userId, cosmeticId) {
    ...
    return tx('user_cosmetic_inventory')
      .where('user_id', userId)
      .andWhere('cosmetic_id', cosmeticId)
      .first()
      .then(function (cosmeticRow?) {
  ...
  static isAllowedToUseCosmetics(txPromise, tx, userId, cosmeticIds, cosmeticType) {
    ...
    if (cosmeticIds.length <= 1) {
      ...
      if (cosmeticType != null) {
        query = query.andWhere('cosmetic_type', cosmeticType);
      }
      query = query.select('cosmetic_id');
      return query.then(function (cosmeticRows) {
        for (var cosmeticId of Array.from<any>(cosmeticIds)) {
          ...
          if (cosmeticData == null || !cosmeticData.enabled) {
            return Promise.reject(
              new Errors.NotFoundError("Can't use cosmetic that doesn't exist"),
            );
          }
          ...
          if (cosmeticData.purchasable || cosmeticData.unlockable) {
            ...
            if (!found) {
              return Promise.reject(
                new Errors.NotFoundError("Can't use cosmetics that you don't own"),
              );
            }
          }
        }
  ...
  static debitSpiritFromUser(trxPromise, trx, userId, spiritAmount, memo, sourceId?) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `debitSpiritFromUser() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify spirit in wallet : invalid user ID - ${userId}`),
      );
    ...
    if (!spiritAmount) {
      Logger.module('InventoryModule').debug(
        `debitSpiritFromUser() -> invalid spirit amount - ${spiritAmount}.`.red,
      );
      return Promise.reject(
        new Error(`Can not modify spirit in wallet : invalid spirit amount - ${spiritAmount}`),
      );
    ...
    Logger.module('InventoryModule').time(
      `debitSpiritFromUser() -> User ${userId.blue}`.green +
        ` received ${spiritAmount} spirit.`.green,
    );
    ...
    return knex('users')
      ...
      .then(function (userRow) {
        ...
        return Promise.all([
          knex('users')
            .where('id', userId)
            .increment('wallet_spirit', spiritAmount)
            .transacting(trx),
          knex('users')
            .where('id', userId)
            .update('wallet_updated_at', NOW_UTC_MOMENT.toDate())
  ...
  static buyBoosterPacksWithGold(userId, qty, cardSetId, sku) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `buyBoosterPacksWithGold() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not buy booster pack with gold : invalid user ID - ${userId}`),
      );
    }

    if (qty == null || isNaN(qty) || qty <= 0) {
      Logger.module('InventoryModule').debug(
        `buyBoosterPacksWithGold() -> invalid quantity - ${qty}.`.red,
      );
      return Promise.reject(
        new Error(`Can not buy booster pack with gold : invalid quantity - ${qty}`),
      );
    }
    ...
    if (cardSetData == null || !cardSetData.enabled || cardSetData.isPreRelease) {
      Logger.module('InventoryModule').debug(
        `buyBoosterPacksWithGold() -> invalid card set - ${cardSetId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not buy booster pack with gold : invalid card set - ${cardSetId}`),
      );
    }
    ...
    Logger.module('InventoryModule').debug(
      `buyBoosterPacksWithGold() -> user ${userId.blue} buying ${qty} ${qty > 1 ? 'packs' : 'pack'} from set ${cardSetId}`,
    );
    Logger.module('InventoryModule').time(
      `buyBoosterPacksWithGold() -> bought by user ${userId.blue}.`.green,
    );
        ...
        knex
          ...
          .then(function (userRow) {
            ...
            if (userRow.wallet_gold >= total_gold_cost) {
              ...
              final_wallet_gold = _chainState.final_wallet_gold =
                userRow.wallet_gold - total_gold_cost;
              ...
              Logger.module('InventoryModule').debug(
                `buyBoosterPacksWithGold() -> Cannot buy ${qty} booster ${qty > 1 ? 'packs' : 'pack'} because user ${userId.blue} due to insufficient funds`
                  .red,
              );
              return Promise.reject(
                new Errors.InsufficientFundsError(
                  `Insufficient funds in wallet to buy ${qty} booster ${qty > 1 ? 'packs' : 'pack'} for ${userId}`,
                ),
              );
            }
          })
          .then(function () {
            ...
            for (let i = 0, end = qty, asc = end >= 0; asc ? i < end : i > end; asc ? i++ : i--) {
              all.push(
                InventoryModule.addBoosterPackToUser(txPromise, tx, userId, cardSetId, 'soft'),
              );
            }
          ...
          .then(function (fbRootRef) {
            if (sku === 'STARTERBUNDLE_201604') {
              FirebasePromises.set(
                fbRootRef.child('users').child(userId).child('has_purchased_starter_bundle'),
                true,
              );
              FirebasePromises.safeTransaction(
                fbRootRef.child('user-purchase-counts').child(userId).child(sku),
                (purchaseCountRecord) => ({
                  count: 1,
                }),
              );
  ...
  static addBoosterPackToUser(
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `addBoosterPackToUser() -> invalid user ID - ${userId}.`.red,
      );
    ...
    if (cardSetData == null || !cardSetData.enabled) {
      Logger.module('InventoryModule').debug(
        `addBoosterPackToUser() -> invalid card set - ${cardSetId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not add booster pack : invalid card set - ${cardSetId}`),
      );
    }
    ...
    Logger.module('InventoryModule').time(
      `addBoosterPackToUser() -> added ${boosterId} to user ${userId.blue}.`.green,
    );
    ...
    return trx('user_spirit_orbs')
          ...
          orbCountTrackingPromise = trx
            ...
            .then(function (response) {
              if (
                ...
                response.rows[0][_chainState.orbCountKey] != null
              ) {
                ...
                if (orbCountAfter <= cardSetData.numOrbsToCompleteSet) {
                  ...
                  return Promise.reject(
                    new Errors.MaxOrbsForSetReachedError(
                      'Can not add booster pack : user already owns max orb count of this type',
                    ),
                  );
                }
              } else {
                return Promise.reject(
                  new Error(
                    `Can not add booster pack : invalid total sql orb count data for set - ${cardSetId}`,
                  ),
                );
              }
            });
      ...
      .then(function (fbRootRef) {
        ...
        const boosters = _chainState.fbRootRef
          .child('user-inventory')
          .child(userId)
          .child('spirit-orbs');
        const booster_data = {
  ...
  static buyRemainingSpiritOrbsWithSpirit(userId, cardSetId?, systemTime?) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `buyRemainingSpiritOrbsWithSpirit() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Errors.InvalidRequestError(
          `Can not add complete card set with spirit : invalid user ID - ${userId}`,
        ),
      );
    }
    ...
    if (cardSetId == null) {
      Logger.module('InventoryModule').debug(
        `buyRemainingSpiritOrbsWithSpirit() -> invalid card set ID - ${cardSetId}.`.red,
      );
      return Promise.reject(
        new Errors.InvalidRequestError(
          `Can not add complete card set with spirit : invalid card set ID - ${cardSetId}`,
        ),
      );
    }
    ...
    if (sdkCardSetData == null) {
      Logger.module('InventoryModule').debug(
        `buyRemainingSpiritOrbsWithSpirit() -> invalid card set data - ${cardSetId}.`.red,
      );
      return Promise.reject(
        new Errors.InvalidRequestError(
          `Can not add complete card set with spirit : invalid card set data - ${cardSetId}`,
        ),
      );
    }
    ...
    if (!sdkCardSetData.isUnlockableThroughOrbs || sdkCardSetData.fullSetSpiritCost == null) {
      Logger.module('InventoryModule').debug(
        `buyRemainingSpiritOrbsWithSpirit() -> invalid card set for spirit purchase - ${cardSetId}.`
          .red,
      );
      return Promise.reject(
        new Errors.InvalidRequestError(
          `Can not add complete card set with spirit : invalid card set for spirit purchase - ${cardSetId}`,
        ),
      );
    }
    ...
    return (txPromise = knex
      .transaction((tx) =>
        tx('users')
          .first(_chainState.orbCountKey, 'wallet_spirit')
          .where('id', userId)
          .then(function (userRow) {
            _chainState.setTotalOrbs = userRow[_chainState.orbCountKey] || 0; // Number of orbs user already has for this set
            _chainState.orbsRemaingToCompleteSet =
              sdkCardSetData.numOrbsToCompleteSet - _chainState.setTotalOrbs;

            if (userRow.wallet_spirit < sdkCardSetData.fullSetSpiritCost) {
              Logger.module('InventoryModule').debug(
                `buyRemainingSpiritOrbsWithSpirit() -> insufficient spirit for spirit purchase - ${cardSetId}.`
                  .red,
              );
              return Promise.reject(
                new Errors.InsufficientFundsError(
                  `Can not add complete card set with spirit : insufficient spirit for spirit purchase - ${cardSetId}`,
                ),
              );
            }
            ...
            return Promise.all([
              InventoryModule.debitSpiritFromUser(
                txPromise,
                tx,
                userId,
                -1.0 * sdkCardSetData.fullSetSpiritCost,
                `purchase full card set ${cardSetId}`,
                transactionId,
              ),
              InventoryModule.addRemainingOrbsForCardSetToUser(
                txPromise,
                tx,
                userId,
                cardSetId,
      ...
      .then(function () {
        Logger.module('InventoryModule').debug(
          `buyRemainingSpiritOrbsWithSpirit() -> user ${userId.blue} `.green +
            ` purchased remained of set ${cardSetId} with spirit`.green,
        );
   ...
   * @return  {Promise}    Promise that will post BOOSTER PACK DATA on completion.
   */
  static addRemainingOrbsForCardSetToUser(
    txPromise,
    tx,
    userId,
    cardSetId,
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `addRemainingOrbsForCardSetToUser() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not add complete card set : invalid user ID - ${userId}`),
      );
    }
    ...
    if (!tx) {
      Logger.module('InventoryModule').debug(
        `addRemainingOrbsForCardSetToUser() -> invalid tx - ${tx}.`.red,
      );
      return Promise.reject(
        new Error('Can not add complete card set : invalid transaction parameter'),
      );
    }
    ...
    if (cardSetData == null || !cardSetData.enabled) {
      Logger.module('InventoryModule').debug(
        `addRemainingOrbsForCardSetToUser() -> invalid card set - ${cardSetId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not add complete card set : invalid card set - ${cardSetId}`),
      );
    }

    if (
      cardSetData == null ||
      !cardSetData.isUnlockableThroughOrbs ||
      cardSetData.numOrbsToCompleteSet == null
    ) {
      Logger.module('InventoryModule').debug(
        `addRemainingOrbsForCardSetToUser() -> card set is not unlocked exclusively through orbs - ${cardSetId}.`
          .red,
      );
      return Promise.reject(
        new Error(
          `Can not add complete card set : card set is not unlocked exclusively through orbs - ${cardSetId}`,
        ),
      );
    }
    ...
    if (refundWithSpirit && cardSetData.orbSpiritRefund == null) {
      Logger.module('InventoryModule').debug(
        `addRemainingOrbsForCardSetToUser() -> card set cannot refund orbs with spirit - ${cardSetId}.`
          .red,
      );
    }
    ...
    Logger.module('InventoryModule').time(
      `addRemainingOrbsForCardSetToUser() -> added complete set for ${cardSetId} to user ${userId.blue}.`
        .green,
    );
    ...
    return tx('users')
      ...
      .then(function (userRow) {
        ...
        if (_chainState.orbsToGive <= 0) {
          Logger.module('InventoryModule').debug(
            `addRemainingOrbsForCardSetToUser() -> user already owns max orb count of this type - ${cardSetId}.`
              .red,
          );
          return Promise.reject(
            new Errors.MaxOrbsForSetReachedError(
              'Can not add complete card set : user already owns max orb count of this type',
            ),
          );
        }
        ...
        const allPromises = [];
        Logger.module('InventoryModule').debug(
          `addRemainingOrbsForCardSetToUser() -> adding ${_chainState.orbsToGive} orbs to ${userId.blue}`,
        );
        for (
          let i = 1, end = _chainState.orbsToGive, asc = end >= 1;
          asc ? i <= end : i >= end;
          asc ? i++ : i--
        ) {
          allPromises.push(
          ...
          if (refundWithSpirit && cardSetData.orbSpiritRefund != null) {
            allPromises.push(
              InventoryModule.giveUserSpirit(
                ...
                tx,
                userId,
                _chainState.setTotalOrbs * cardSetData.orbGoldRefund,
                transactionType,
              ),
            );
  ...
  static unlockBoosterPack(userId, boosterPackId, systemTime?) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `unlockBoosterPack() -> invalid user ID - ${userId.blue}.`.red,
      );
    ...
    Logger.module('InventoryModule').time(
      `unlockBoosterPack() -> user ${userId.blue} unlocked booster ${boosterPackId}.`.green,
    );
    ...
    return (txPromise = knex
      .transaction(function (tx) {
        Promise.all([
          ...
          .then(function ([userRow, boosterRow]) {
            if (boosterRow == null || boosterRow.user_id !== userId) {
              return Promise.reject(
                new Errors.NotFoundError(
                  'The booster pack ID you provided does not exist or belong to you.',
                ),
              );
            }

            // if none set assume card set is Core
            if (boosterRow.card_set == null) {
            ...
            if (
              _chainState.cardSetId === SDK.CardSet.Bloodborn ||
              _chainState.cardSetId === SDK.CardSet.Unity
            ) {
          ...
          .then(function (userCardsCollection) {
            ...
            if (
              userCardsCollection != null &&
              (userCardsCollection != null ? userCardsCollection.cards : undefined) != null
            ) {
            ...
            return new Promise((resolve, reject) => {
              ...
              try {
                ...
                let i, random;
                const randomCardFromCollectionWithoutDupes = function (
                  cardsArray,
                  notInCardsList,
                  prismaticChance?,
                  maxIterations?,
                ) {
                  if (prismaticChance == null) {
                    prismaticChance = 0.0;
                  }
                ...
                const randomUnownedCardFromCollection = function (
                  ownedCardsData,
                  potentialCardPool,
                ) {
                  ...
                  for (var cardId of Array.from<any>(shuffledCardPool)) {
                    if (
                      (ownedCardsData[cardId] != null ? ownedCardsData[cardId].count : undefined) &&
                      (ownedCardsData[cardId] != null ? ownedCardsData[cardId].count : undefined) >
                        0
                    ) {
                      continue;
                ...
                if (_chainState.cardSetId === SDK.CardSet.Core) {
                      ...
                      new_cards.push(
                        randomCardFromCollectionWithoutDupes(
                          SDK.GameSession.getCardCaches()
                            .getCardSet(_chainState.cardSetId)
                      ...
                      new_cards.push(
                        randomCardFromCollectionWithoutDupes(
                          SDK.GameSession.getCardCaches()
                            ...
                            .getCardIds(),
                          new_cards,
                          shimzarLegendaryPrismaticChance,
                          50,
                        ),
                      );
                    }
                  ...
                  const commonCardId = randomUnownedCardFromCollection(
                    _chainState.userCardsData,
                    SDK.GameSession.getCardCaches()
                      .getCardSet(_chainState.cardSetId)
                      .getRarity(SDK.Rarity.Common)
                      .getIsUnlockable(true)
                      .getIsPrismatic(false)
                      .getCardIds(),
                  );
                  ...
                  const rareCardId = randomUnownedCardFromCollection(
                    _chainState.userCardsData,
                    SDK.GameSession.getCardCaches()
                      .getCardSet(_chainState.cardSetId)
                      .getRarity(SDK.Rarity.Rare)
                  ...
                  const epicBloodbornCardIds = SDK.GameSession.getCardCaches()
                    .getCardSet(_chainState.cardSetId)
                    .getRarity(SDK.Rarity.Epic)
                    .getIsUnlockable(true)
                    .getIsPrismatic(false)
                    .getCardIds();
                  const legendaryBloodbornCardIds = SDK.GameSession.getCardCaches()
                    .getCardSet(_chainState.cardSetId)
                    .getRarity(SDK.Rarity.Legendary)
                    .getIsUnlockable(true)
                    .getIsPrismatic(false)
                    .getCardIds();
                  const epicAndLegBbCardIds =
                    epicBloodbornCardIds.concat(legendaryBloodbornCardIds);
                  const epicOrLegCardId = randomUnownedCardFromCollection(
                    _chainState.userCardsData,
                    epicAndLegBbCardIds,
                  );
                      ...
                      new_cards.push(
                        randomCardFromCollectionWithoutDupes(
                          SDK.GameSession.getCardCaches()
                            ...
                            .getCardIds(),
                          new_cards,
                          firstwatchCommonPrismaticChance,
                          50,
                        ),
                      );
                    } else if (random < 0.74 + 0.16) {
                      ...
                      new_cards.push(
                        randomCardFromCollectionWithoutDupes(
                          SDK.GameSession.getCardCaches()
                            ...
                            .getCardIds(),
                          new_cards,
                          firstwatchLegendaryPrismaticChance,
                          50,
                        ),
                      );
                    }
                      ...
                      new_cards.push(
                        randomCardFromCollectionWithoutDupes(
                          SDK.GameSession.getCardCaches()
                            ...
                            .getCardIds(),
                          new_cards,
                          wartechLegendaryPrismaticChance,
                          50,
                        ),
                      );
                    }
                      ...
                      new_cards.push(
                        randomCardFromCollectionWithoutDupes(
                          SDK.GameSession.getCardCaches()
                            ...
                            .getCardIds(),
                          new_cards,
                          combinedLegendaryPrismaticChance,
                          50,
                        ),
                      );
                    }
      ...
      .then(function () {
        Logger.module('InventoryModule').debug(
          `unlockBoosterPack() -> user ${userId.blue} `.green +
            ` unlocked cards ${util.inspect(_chainState.boosterRow.cards)} from booster ${_chainState.boosterRow.id}`
              .green,
        );
  ...
  static giveUserMissingCodexChapters(userId, systemTime?) {
    let txPromise;
    Logger.module('InventoryModule').time(
      `giveUserMissingCodexChapters() -> checking for missing codex chapters for user ID ${userId.blue}.`
        .green,
    );
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `giveUserMissingCodexChapters() -> invalid user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not check for missing codex chapters : invalid user ID - ${userId}`),
      );
    }
      ...
      .transaction(function (tx) {
        Promise.all([
          ...
          .then(function ([progressionRow, codexInventoryRows]) {
            ...
            const missingCodexChapterIds = _.filter(
              earnedCodexChapterIds,
              function (earnedCodexChapterId) {
                const correspondingCodexChapterRow = _.find(
                  codexInventoryRows,
                  (codexInventoryRow) => codexInventoryRow.chapter_id === earnedCodexChapterId,
                );
            ...
            if (missingCodexChapterIds.length === 0) {
              ...
              return PromiseUtils.map(missingCodexChapterIds, (missingCodexChapterId) =>
                InventoryModule.giveUserCodexChapter(
                  txPromise,
                  tx,
                  userId,
                  missingCodexChapterId,
                  NOW_UTC_MOMENT,
                ),
              );
            }
          ...
          .then(
            (results) =>
              (this_obj.awardedChapterIds = _.filter(results, (result) => result !== null)),
          )
          .then(tx.commit)
          .catch(function (e) {
            Logger.module('InventoryModule').debug(
              `giveUserMissingCodexChapters() -> ROLLBACK ... ${e != null ? e.message : undefined}`,
            );
            return tx.rollback();
          });
      })
  ...
  static giveUserCodexChapter(txPromise, tx, userId, chapterId, systemTime?) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `giveUserCodexChapter() -> invalid user ID - ${userId}.`.red,
      );
    ...
    if (!chapterId) {
      Logger.module('InventoryModule').debug(
        `giveUserCodexChapter() -> invalid chapter ID - ${chapterId} to user ID - ${userId}.`.red,
      );
      return Promise.reject(
        new Error(
          `Can not give codex chapter : invalid chapter ID - ${chapterId} to user ID - ${userId}`,
        ),
      );
    }
    ...
    if (!tx) {
      ...
      return Promise.reject(
        new Error('Can not give codex chapter : invalid transaction parameter'),
      );
    }
    ...
    if (!sdkCodexChapter) {
      Logger.module('InventoryModule').debug(
        `giveUserCodexChapter() -> unknown chapter ID - ${chapterId}.`.red,
      );
      return Promise.reject(
        new Error(`Can not give codex chapter : unknown chapter ID - ${chapterId}`),
      );
    }
    ...
    Logger.module('InventoryModule').time(
      `giveUserCodexChapter() -> added ${chapterId} to user ID ${userId.blue}.`.green,
    );

    // return the insert statement and attach it to the transaction
    return knex('user_codex_inventory')
      .where('user_id', userId)
      .select('chapter_id')
      .transacting(tx)
      .forUpdate()
      .then(function (codex_inventory_rows) {
        ...
        const existingCodexChapterRow = _.find(
          _chainState.codex_inventory_rows,
          (codexInventoryRow) => codexInventoryRow.chapter_id === chapterId,
        );

        if (existingCodexChapterRow) {
          _chainState.userAlreadyOwnedChapter = true;
          Logger.module('InventoryModule').debug(
            `giveUserCodexChapter() -> attempting to give an already owned chapter ID - ${chapterId} to user ID - ${userId.blue}.`
              .yellow,
          );
          return Promise.resolve();
        } else {
          ...
          txPromise.then(() =>
            DuelystFirebase.connect()
              ...
              .then((fbRootRef) =>
                Promise.all([
                  FirebasePromises.set(
                    fbRootRef.child('user-inventory').child(userId).child('codex').child(chapterId),
          ...
          return knex
            .insert(_chainState.new_codex_inventory_row)
            .into('user_codex_inventory')
            .transacting(tx);
        }
      })
      .then(function () {
  ...
  static disenchantCards(userId, cardIds, systemTime?) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `disenchantCards() -> invalid user ID - ${userId.blue}.`.red,
      );
    ...
    if (!cardIds) {
      Logger.module('InventoryModule').debug(
        `disenchantCards() -> invalid user card list - ${userId.blue}.`.red,
      );
      return Promise.reject(new Error(`Can not disenchant cards: invalid card list - ${userId}`));
    }

    Logger.module('InventoryModule').debug(
      `disenchantCards() -> user ${userId != null ? userId.blue : undefined}`.green +
        ` disenchanting cards ${util.inspect(cardIds)}`,
    );
    ...
    var txPromise = knex
      .transaction(function (tx) {
        InventoryModule._disenchantCards(txPromise, tx, userId, cardIds, NOW_UTC_MOMENT)
          .then(function (data) {
            return _.extend(_chainState, data);
          })
          .then(() => SyncModule._bumpUserTransactionCounter(tx, userId))
          .then(tx.commit)
          .catch(tx.rollback);
      ...
      .then(function () {
        Logger.module('InventoryModule').debug(
          `disenchantCards() -> user ${userId.blue}`.green +
            ` disenchanted cards ${util.inspect(cardIds)}`.green,
        );
  ...
  static _disenchantCards(trxPromise, trx, userId, cardIds, systemTime?) {
    ...
    const cardDataListReduced = _.reduce(
      cardIds,
      function (memo, cardId) {
        if (memo[cardId] == null) {
          memo[cardId] = {
            card_id: cardId,
            count: 0,
    ...
    return trx
      ...
      .then(function (fbRootRef) {
        ...
        const disenchantPromosRef = _chainState.fbRootRef
          .child('crafting')
          .child('promos')
          .child('disenchant');
      ...
      .then(function (cardCountRows) {
        ...
        for (var disenchantedCardId in cardDataListReduced) {
          ...
          var countRow = _.find(
            cardCountRows,
            (row) => parseInt(row.card_id) === parseInt(disenchantedCardId),
          );
          if (!countRow || countRow.count < disenchantedCardData.count) {
            throw new Errors.NotFoundError(
              'User does not have cards he/she is trying to disenchant.',
            );
          }
        }
        ...
        for (var cardId of Array.from<any>(cardIds)) {
          ...
          try {
            var cardData = SDK.GameSession.getCardCaches()
              .getIsCollectible(true)
              .getCardById(parseInt(cardId));

            if (cardData == null) {
              Logger.module('InventoryModule').debug(
                `disenchantCards() -> ERROR: ${userId} is trying to disenchant a non-collectible card ${cardId}`
                  .red,
              );
            ...
            if (
              cardData.getRarityId() === SDK.Rarity.Fixed ||
              cardData.getRarityId() === SDK.Rarity.TokenUnit
            ) {
              Logger.module('InventoryModule').debug(
                `disenchantCards() -> ERROR: ${userId} is trying to disenchant a fixed card ${cardId}`
                  .red,
              );
            ...
            if (
              cardData.getIsUnlockable() &&
              !cardData.getIsUnlockablePrismaticWithAchievement() &&
              !cardData.getIsUnlockablePrismaticWithSpiritOrbs()
            ) {
              Logger.module('InventoryModule').debug(
                `disenchantCards() -> ERROR: ${userId} is trying to craft an unlockable card ${cardId}`
                  .red,
              );
            ...
            if (
              _chainState.disenchantPromos &&
              _chainState.disenchantPromos[baseCardId.toString()] &&
              (!_chainState.disenchantPromos[baseCardId.toString()].expires_at ||
            ...
            Logger.module('InventoryModule').debug(
              `disenchantCards() -> ERROR calculating bonuses ... user ${userId.blue}`.red,
              e,
            );
            throw e;
          }
      ...
      .then(function (rewards) {
        _chainState.final_wallet_spirit =
          _chainState.userRow.wallet_spirit + _chainState.total_spirit_gained;

        return InventoryModule.giveUserSpirit(
          trxPromise,
          trx,
          userId,
          _chainState.total_spirit_gained,
          'disenchant',
        );
      })
      .then(function () {
        ...
        for (var deCardId in cardDataListReduced) {
          ...
          var countRow = _.find(
            _chainState.cardCountRows,
            (row) => parseInt(row.card_id) === parseInt(deCardId),
          );
          ...
          if (updateParams.count === 0) {
            allQueries.push(
              knex('user_cards')
                .where({ user_id: userId, card_id: deCardId })
                .delete()
                .transacting(trx),
            );
          } else {
      ...
      .then(function () {
        return InventoryModule._refreshUserCardCollection(
          trxPromise,
          trx,
          userId,
          _chainState.cardCountRows,
  ...
  static disenchantDuplicateCards(userId, systemTime?) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `disenchantDuplicateCards() -> invalid user ID - ${userId.blue}.`.red,
      );
      return Promise.reject(new Error(`Can not disenchant cards: invalid user ID - ${userId}`));
    }
    ...
    var txPromise = knex
      .transaction(function (tx) {
        knex('users')
          ...
          .then(function (collectionRow) {
            _chainState.cardIds = [];
            const cardsCache = SDK.GameSession.getCardCaches()
              .getIsCollectible(true)
              .getIsUnlockable(false);
            for (var cardId in collectionRow.cards) {
              ...
              if (cardData.count > 3) {
                if (cardsCache.getCardById(parseInt(cardId)) != null) {
                  for (
                    var i = 3, end = cardData.count, asc = end >= 3;
                    asc ? i < end : i > end;
                    asc ? i++ : i--
                  ) {
            ...
            return Logger.module('InventoryModule').debug(
              `disenchantDuplicateCards() -> ${userId.blue} disenchanting ${util.inspect(_chainState.cardIds)}.`,
            );
          })
          .then(function () {
            return InventoryModule._disenchantCards(
              txPromise,
              tx,
              userId,
              _chainState.cardIds,
      ...
      .then(function () {
        Logger.module('InventoryModule').debug(
          `disenchantDuplicateCards() -> user ${userId.blue}`.green +
            ` disenchanted cards ${util.inspect(_chainState.cardIds)}`.green,
        );
  ...
  static craftCard(userId, cardId) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `craftCard() -> invalid user ID - ${userId.blue}.`.red,
      );
      return Promise.reject(new Error(`Can not disenchant cards: invalid user ID - ${userId}`));
    }
    ...
    if (!cardId) {
      Logger.module('InventoryModule').debug(
        `craftCard() -> invalid user cardId - ${userId.blue}.`.red,
      );
    ...
    Logger.module('InventoryModule').time(
      `craftCard() -> user ${userId.blue} `.green + ` crafted card ${cardId}`.green,
    );

    // if there is no collectible card with the cardId, just abort the whole process
    if (cardData == null) {
      Logger.module('InventoryModule').debug(
        `craftCard() -> ERROR: ${userId} is trying to craft a an unknown card ${cardId}`.red,
      );
    ...
    if (!cardData.getIsAvailable()) {
      Logger.module('InventoryModule').debug(
        `craftCard() -> ERROR: ${userId} is trying to craft a an unavailable card ${cardId}`.red,
      );
      return Promise.reject(
        new Errors.BadRequestError(`Could not craft card ${cardId}. It's not yet available.`),
      );
    }
    ...
    if (
      ...
      Logger.module('InventoryModule').debug(
        `craftCard() -> ERROR: ${userId} is trying to craft a fixed card ${cardId}`.red,
      );
    ...
    if (
      ...
      Logger.module('InventoryModule').debug(
        `craftCard() -> ERROR: ${userId} is trying to craft an unlockable card ${cardId}`.red,
      );
    ...
    var txPromise = knex
      .transaction(function (tx) {
        tx('users')
          .first('wallet_spirit', 'wallet_gold')
          .where('id', userId)
          .forUpdate()
          .then(function (userRow) {
            _chainState.userRow = userRow;
            ...
            if (requiresBaseCardIdToCraft) {
              ...
              return tx('user_cards')
                .first()
                .where({ user_id: userId, card_id: baseCardId })
                .then(function (baseCardRow) {
                  if (baseCardRow == null || baseCardRow.count == null || baseCardRow.count <= 0) {
                    Logger.module('InventoryModule').debug(
                      `craftCard() -> ERROR: user ${userId.blue} `.red +
                        ` has not unlocked achievement for normal version to craft prismatic card ${cardId}`
                          .red,
                    );
                    return Promise.reject(
                      new Errors.BadRequestError(
                        'You cannot craft UNLOCKABLE prismatic cards until the normal version is unlocked',
                      ),
                    );
                  }
                });
          ...
          .then(function () {
            if (_chainState.userRow.wallet_spirit < spirit_cost) {
              Logger.module('InventoryModule').debug(
                `craftCard() -> ERROR: user ${userId.blue} `.red +
                  ` has insufficient spirit (${_chainState.userRow.wallet_spirit}) to craft card ${cardId}`
                    .red,
              );
              return Promise.reject(
                new Errors.InsufficientFundsError(
                  `Insufficient resources in wallet to craft ${cardId} - ${userId}`,
                ),
              );
            }
  ...
  static craftCosmetic(userId, cosmeticId) {
    ...
    if (!cosmeticId) {
      Logger.module('InventoryModule').debug(
        `craftCosmetic() -> user - ${userId.blue} invalid cosmeticId - ${cosmeticId}.`.red,
      );
      return Promise.reject(
        new Error(
          `Can not craft cosmetic: user - ${userId.blue} invalid cosmeticId - ${cosmeticId}`,
        ),
      );
    }
    ...
    Logger.module('InventoryModule').time(
      `craftCosmetic() -> user ${userId.blue} `.green + ` crafted cosmetic ${cosmeticId}`.green,
    );

    // if there is no collectible cosmetic with the cosmeticId, just abort the whole process
    if (cosmeticData == null) {
      Logger.module('InventoryModule').debug(
        `craftCosmetic() -> ERROR: ${userId} is trying to craft a an unknown cosmetic ${cosmeticId}`
          .red,
      );
      return Promise.reject(
        new Errors.BadRequestError(`No collectible cosmetic with ID: ${cosmeticId}.`),
      );
    }
    ...
    if (cosmeticData.rarityId == null) {
      Logger.module('InventoryModule').debug(
        `craftCosmetic() -> ERROR: ${userId} is trying to craft a cosmetic without rarity ${cosmeticId}`
          .red,
      );
      return Promise.reject(
        new Errors.BadRequestError(
          `Could not craft cosmetic ${cosmeticId}. It's not yet available.`,
        ),
      );
    }
      ...
      .transaction((tx) =>
        tx
          ...
          .then(function (cosmeticRow) {
            ...
            if (cosmeticRow != null) {
              return Promise.reject(
                new Errors.AlreadyExistsError(`User ${userId} already owns cosmetic ${cosmeticId}`),
              );
            }

            const { userRow } = _chainState;

            if (userRow.wallet_spirit < spiritCost) {
              Logger.module('InventoryModule').debug(
                `craftCosmetic() -> ERROR: user ${userId.blue} `.red +
                  ` has insufficient spirit (${userRow.wallet_spirit}) to craft cosmetic ${cosmeticId}`
                    .red,
              );
              return Promise.reject(
                new Errors.InsufficientFundsError(
                  `Insufficient resources in wallet to cosmetic ${cosmeticId} - by user ${userId}`,
                ),
              );
            }
  ...
  static giveUserCards(trxPromise, trx, userId, cardIds, sourceType, sourceId?, memo?) {
    ...
    if (cardIds == null) {
      Logger.module('InventoryModule').debug(
        `giveUserCards() -> cardIds does not exist. User ${userId.blue}`.red,
      );
    ...
    for (cardId of Array.from<any>(cardIds)) {
      if (SDK.Cards.getIsSkinnedCardId(cardId)) {
        Logger.module('InventoryModule').debug(
          `giveUserCards() -> attempted to give skinned card id (${cardId}) to user ${userId.blue}`
            .red,
        );
      ...
      .then(function ([cardCountRows]) {
        ...
        for (cardId in cardDataListReduced) {
          ...
          if (cardRow) {
            ...
            updateCardPromise = knex('user_cards')
              .where({ user_id: userId, card_id: card.card_id })
              .update({
                count: cardRow.count,
                updated_at: NOW_UTC_MOMENT.toDate(),
  ...
  static addEmoteToUser(trxPromise, trx, userId, transactionType, emoteId, factionId) {
    ...
    if (userId == null || transactionType == null || emoteId == null || factionId == null) {
      Logger.module('UsersModule').debug(
        `addEmoteToUser() -> invalid request - ${userId}, ${transactionType}, ${emoteId}, ${factionId}.`
          .red,
      );
      return Promise.reject(
        new Error(
          `Can not add emote: invalid request - ${userId}, ${transactionType}, ${emoteId}, ${factionId}.`,
        ),
      );
    }

    Logger.module('InventoryModule').time(
      `addEmoteToUser() -> user ${userId.blue} `.green + ` received emote ${emoteId}`.green,
    );
    ...
    return knex
      ...
      .then(function (collectionRow?) {
        ...
        for (var cardRow of Array.from<any>(cardCountRows)) {
          if (cardRow.count > 0) {
            if (collectionRow.cards[cardRow.card_id] == null) {
      ...
      .then(function (fbRootRef) {
        if (updateFirebase) {
          const card_collection = fbRootRef
            .child('user-inventory')
            .child(userId)
  ...
  static markCardAsReadInUserCollection(userId, cardId) {
    ...
    Logger.module('InventoryModule').time(
      `markCardAsReadInUserCollection() -> user ${userId.blue} `.green +
        ` marking card ${cardId} as READ`.green,
    );

    return knex('user_cards')
      .where('user_id', userId)
      ...
      .catch(function (error) {
        Logger.module('InventoryModule').debug(
          'markCardAsReadInUserCollection() -> ERROR'.red,
          error,
        );
        throw error;
      });
  ...
  static markAllCardsAsReadInUserCollection(userId) {
    ...
    Logger.module('InventoryModule').time(
      `markAllCardsAsReadInUserCollection() -> user ${userId.blue} `.green +
        ' marking all cards as READ'.green,
    );
    ...
    return knex('user_cards')
      ...
      .catch(function (error) {
        Logger.module('InventoryModule').debug(
          'markAllCardsAsReadInUserCollection() -> ERROR'.red,
          error,
        );
        throw error;
      });
  ...
  static markCardLoreAsReadInUserCollection(userId, cardId) {
    ...
    Logger.module('InventoryModule').time(
      `markCardLoreAsReadInUserCollection() -> user ${userId.blue} `.green +
        ` marking card ${cardId} lore as READ`.green,
    );
    ...
    const txPromise = knex
        ...
        knex
          ...
          .then(function (cardLoreCountRows) {
            ...
            if (cardLoreData != null) {
              ...
              return knex('user_card_lore_inventory')
                .where({ user_id: userId, card_id: cardId })
                .update({ is_unread: false, updated_at: cardLoreData.updated_at })
                .transacting(tx);
            } else {
              // create new entry
              cardLoreData = {
      ...
      .then(function (fbRootRef) {
        ...
        return FirebasePromises.set(
          fbRootRef.child('user-inventory').child(userId).child('card-lore').child(cardId),
          cardLoreDataFB,
        );
      })
      .then(() =>
      ...
      .catch(function (error) {
        Logger.module('InventoryModule').debug(
          'markCardLoreAsReadInUserCollection() -> ERROR'.red,
          error,
        );
        throw error;
      });
  ...
  static softWipeUserCardInventory(userId, systemTime?) {
    ...
    if (!NOW_UTC_MOMENT.isBefore(InventoryModule.SOFTWIPE_AVAILABLE_UNTIL)) {
      Logger.module('InventoryModule').error(
        `softWipeUserCardInventory() -> soft wipe period expired. u: ${userId.blue}`.red,
      );
      return Promise.reject(
        new Errors.BadRequestError('Account soft wipe is not presently available.'),
      );
    }
    ...
    var txPromise = knex
      .transaction(function (tx) {
        tx('users')
          .first('id', 'wallet_spirit', 'soft_wipe_count')
          .where('id', userId)
          .forUpdate()
          .then(function (userRow) {
            _chainState.userRow = userRow;
            if (userRow.soft_wipe_count >= InventoryModule.MAX_SOFTWIPE_COUNT) {
              Logger.module('InventoryModule').error(
                `softWipeUserCardInventory() -> max number of soft wipes already reached. u: ${userId.blue}`
                  .red,
              );
          ...
          .then(function (cardLogRows) {
            ...
            for (cardLog of Array.from<any>(cardLogRows)) {
              ...
              if (
                cardLog.source_type === 'spirit orb' ||
                cardLog.source_type === 'craft' ||
                cardLog.source_type === 'disenchant'
              ) {
                Logger.module('InventoryModule').debug(
                  `softWipeUserCardInventory() -> reversing card ${cardLog.card_id} log type: ${cardLog.source_type} ${userId.blue}`,
                );
            ...
            if (!anyWiped) {
              throw new Errors.BadRequestError(
                'User does not appear to have any cards that need to be wiped.',
              );
            }
            ...
            Logger.module('InventoryModule').debug(
              `softWipeUserCardInventory() -> card counts for ${userId.blue}`,
              cardCounts,
            );
          ...
          .then(function (wipedCount) {
            const allPromises = [];
            Logger.module('InventoryModule').debug(
              `softWipeUserCardInventory() -> adding ${wipedCount} orbs to ${userId.blue}`,
            );
            for (
              let i = 1, end = wipedCount, asc = end >= 1;
              asc ? i <= end : i >= end;
              asc ? i++ : i--
            ) {
              allPromises.push(
                InventoryModule.addBoosterPackToUser(txPromise, tx, userId, 1, 'soft-wipe'),
              );
            }
            return Promise.all(allPromises);
          })
          .then(function () {
            if (_chainState.userRow.wallet_spirit > 0) {
              Logger.module('InventoryModule').debug(
                `softWipeUserCardInventory() -> removing ${-_chainState.userRow.wallet_spirit} spirit for ${userId.blue}`,
              );
              return InventoryModule.debitSpiritFromUser(
                txPromise,
                tx,
                userId,
                -_chainState.userRow.wallet_spirit,
                'soft wipe',
              );
            }
          })
      ...
      .then(() =>
        Logger.module('InventoryModule').timeEnd(
          `softWipeUserCardInventory() -> for user ${userId.blue}`,
        ),
      )
      .catch(function (error) {
  ...
  static claimFreeCardOfTheDay(userId, systemTime?) {
    ...
    const cardId = _.sample(
      SDK.GameSession.getCardCaches()
        .getCardSet(randomCardSet)
        .getRarity(SDK.Rarity.Common)
        .getIsCollectible(true)
        .getIsUnlockable(false)
        .getIsPrismatic(false)
    ...
    Logger.module('InventoryModule').time(
      `claimFreeCardOfTheDay() -> ${userId.blue} claiming ${cardId}`,
    );

    var txPromise = knex
      .transaction((tx) =>
        tx('users')
          .first('free_card_of_the_day_claimed_at', 'free_card_of_the_day_claimed_count')
          .where('id', userId)
          .forUpdate()
          .then(function (userRow) {
            ...
            Logger.module('InventoryModule').debug(
              `claimFreeCardOfTheDay() -> today's day: ${startOfToday.format()} ... last claimed day: ${lastClaimedAtDay.format()}`,
            );

            if (!lastClaimedAtDay.isBefore(startOfToday)) {
              throw new Errors.BadRequestError(
                "You've already claimed a free card of the day today.",
              );
            }
            ...
            return Promise.all([
              InventoryModule.giveUserCards(
                ...
                'FCOTD',
                null,
                startOfToday.format('YYYY-MM-DD'),
              ),
              tx('users')
                .where('id', userId)
                .update({
                  free_card_of_the_day_claimed_count:
                    userRow.free_card_of_the_day_claimed_count + 1,
          ...
          .then((fbRootRef) =>
            FirebasePromises.set(
              fbRootRef.child('users').child(userId).child('free_card_of_the_day_claimed_at'),
              NOW_UTC_MOMENT.valueOf(),
            ),
          )
          .then(() => SyncModule._bumpUserTransactionCounter(tx, userId))
          .then(function () {
            return _chainState.cardId;
          }),
      )
      .then(function () {
        Logger.module('InventoryModule').timeEnd(
  ...
  static addArenaTicketToUser(trxPromise, trx, userId, transactionType, transactionId = null) {
    ...
    if (!userId) {
      Logger.module('InventoryModule').debug(
        `addArenaTicketToUser() -> invalid user ID - ${userId}.`.red,
      );
    ...
    return knex
      ...
      .then(function () {
        Logger.module('GauntletModule').debug(
          `addArenaTicketToUser() -> added ${ticketId} to user ${userId.blue}.`.green,
        );
        return Promise.resolve(ticketId);
      });
  }
