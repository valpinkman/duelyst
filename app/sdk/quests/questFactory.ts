...
class QuestFactory {
  ...
  static questForIdentifier(identifier) {
    ...
    for (var quest of Array.from<any>(this._questCache)) {
  ...
  static randomQuestForSlotExcludingIds(slotIndex, excludedQuestIds) {
    ...
    for (var questChanceTuple of Array.from<any>(questChancesForSlot)) {
    ...
    for (var questTuple of Array.from<any>(normalizedQuestChanceTuples)) {
