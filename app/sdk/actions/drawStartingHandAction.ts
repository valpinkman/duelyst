...
class DrawStartingHandAction extends Action {
  declare mulliganIndices: any;
  declare mulliganedHandCardsData: any;
  declare newHandCardsData: any;
      ...
      if (
        ...
        if (this.mulliganedHandCardsData.length > 0) {
          ...
          if (this.mulliganedHandCardsData.length > cardIndicesToChooseFrom.length) {
            for (var mulliganedCardData of Array.from<any>(this.mulliganedHandCardsData)) {
