...
class Action extends SDKObject {
  declare changedByModifierIndices: any;
  declare isDepthFirst: any;
  declare fxResource: any;
  declare index: any;
  declare isAutomatic: any;
  declare manaCost: any;
  declare ownerId: any;
  declare parentActionIndex: any;
  declare resolveParentActionIndex: any;
  declare resolveSubActionIndices: any;
  declare sourceIndex: any;
  declare sourcePosition: any;
  declare subActionsOrderedByEventType: any;
  declare targetIndex: any;
  declare targetPosition: any;
  declare timestamp: any;
  declare triggeringModifierIndex: any;
  ...
  deserialize(data) {
    ...
    if (subActionsOrderedByEventType != null) {
      ...
      return (() => {
        const result = [];
        for (var subActionsData of Array.from<any>(subActionsOrderedByEventType)) {
