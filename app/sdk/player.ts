...
class Player extends SDKObject {
  declare deck: any;
  declare hasResigned: any;
  declare hasStartingHand: any;
  declare isCurrentPlayer: any;
  declare isRanked: any;
  declare rank: any;
  declare isWinner: any;
  declare lastMaximumMana: any;
  declare lastActionTakenAt: any;
  declare lastRemainingMana: any;
  declare maximumMana: any;
  declare playerId: any;
  declare remainingMana: any;
  declare signatureCardIndices: any;
  declare signatureCardActive: any;
  declare startingMana: any;
  declare totalDamageDealt: any;
  declare totalDamageDealtToGeneral: any;
  declare totalMinionsKilled: any;
  declare totalSpellsCast: any;
  declare totalSpellsPlayedFromHand: any;
  declare totalMinionsPlayedFromHand: any;
  declare totalMinionsSpawned: any;
