...
const EndOfSeasonLayer = RewardLayer.extend({
  ...
  ctor(seasonModel) {
    ...
    this._willShowLootCrate = RankFactory.willGetRewardsForReachingRank(
      this._previousTopRank,
      this._seasonModel.get('starting_at'),
    );
  ...
  getRequiredResources() {
    ...
    const previousRankMedalSpriteResource =
      RSX[`season_rank_${RankFactory.rankedDivisionAssetNameForRank(this._previousTopRank)}`];
    resources.push(previousRankMedalSpriteResource);
    const previousRankMedalGlowOutlineResource =
      RSX[
        `season_rank_${RankFactory.rankedDivisionAssetNameForRank(this._previousTopRank)}_glow_outline`
      ];
    resources.push(previousRankMedalGlowOutlineResource);
    const rankMedalSpriteResource =
      RSX[
        `season_rank_${RankFactory.rankedDivisionAssetNameForRank(GamesManager.getInstance().getCurrentRank())}`
      ];
  ...
  _animateReward() {
    return new Promise((resolve, reject) => {
      ...
      const divisionName = RankFactory.rankedDivisionNameForRank(
        this._previousTopRank,
      ).toUpperCase();
      ...
      var rankMedalSpriteImage =
        RSX[`season_rank_${RankFactory.rankedDivisionAssetNameForRank(this._previousTopRank)}`].img;
      ...
      const rankMedalGlowOutlineImage =
        RSX[
          `season_rank_${RankFactory.rankedDivisionAssetNameForRank(this._previousTopRank)}_glow_outline`
        ].img;
      ...
      // division label
      this.divisionLabel = new cc.LabelTTF(
        divisionText.toUpperCase(),
      ...
      this.divisionLabel.setPosition(
        cc.p(
          centerAnchorPosition.x,
          this.rankMedalSprite.getPositionY() -
            this.rankMedalSprite.getBoundingBox().height * 0.5 -
            this.divisionLabel.getBoundingBox().height * 0.5 -
            divisionDistanceBelowMedal,
        ),
      );
      this.addChild(this.divisionLabel);

      // rank label
      this.rankLabel = new cc.LabelTTF(
        rankText,
        RSX.font_light.name,
        24,
        cc.size(300, 26),
      ...
      this.rankLabel.setPosition(
        cc.p(
          centerAnchorPosition.x,
          this.divisionLabel.getPositionY() -
            this.divisionLabel.getBoundingBox().height * 0.5 -
            this.rankLabel.getBoundingBox().height * 0.5 -
            rankDistanceBelowDivision,
        ),
      );
      this.addChild(this.rankLabel);

      // season month label
      this.seasonMonthlabel = new cc.LabelTTF(
        seasonMonthText.toUpperCase(),
        RSX.font_light.name,
        20,
        cc.size(1200, 20),
        cc.TEXT_ALIGNMENT_CENTER,
      ...
      this.seasonMonthlabel.setPosition(
        cc.p(
          centerAnchorPosition.x,
          this.rankMedalSprite.getPositionY() +
            this.rankMedalSprite.getBoundingBox().height * 0.5 +
            this.seasonMonthlabel.getBoundingBox().height * 0.5 +
            smDistanceAboveMedal,
        ),
      );
      ...
      this.titleLabel.setPosition(
        cc.p(
          centerAnchorPosition.x,
          this.seasonMonthlabel.getPositionY() +
            this.seasonMonthlabel.getBoundingBox().height * 0.5 +
            titleDistanceAboveSMLabel,
        ),
      );
      ...
      this.chevronSprite.setPosition(
        ...
        this.titleLabel.getPositionY() +
          this.titleLabel.getBoundingBox().height * 0.5 +
          this.chevronSprite.getBoundingBox().height * 0.5 +
          chevronDistanceAboveTitle,
      );
      ...
      this.chevronsQuantityLabel = new cc.LabelTTF(
        `${this._numChevronsRewarded}`,
        RSX.font_regular.name,
        25,
        cc.size(1200, 26),
        cc.TEXT_ALIGNMENT_CENTER,
      ...
      this.chevronsQuantityLabel.setPosition(
        cc.p(
          centerAnchorPosition.x,
          this.bonusChevronsSprite.getPositionY() -
            this.bonusChevronsSprite.getBoundingBox().height * 0.5 -
            this.chevronsQuantityLabel.getBoundingBox().height * 0.5 -
            quantityDistanceBelowChevronSprite,
        ),
      );
      ...
      this.chevronsHeaderLabel = new cc.LabelTTF(
        i18next.t('rank.last_season_ranked_earned_message'),
        RSX.font_regular.name,
        25,
        cc.size(1200, 26),
        cc.TEXT_ALIGNMENT_CENTER,
      ...
      this.chevronsHeaderLabel.setPosition(
        cc.p(
          centerAnchorPosition.x,
          this.bonusChevronsSprite.getPositionY() +
            this.bonusChevronsSprite.getBoundingBox().height * 0.5 +
            this.chevronsHeaderLabel.getBoundingBox().height * 0.5 +
            headerDistanceAboveSprite,
        ),
      );
      ...
      this.chevronsBonusLabel = new cc.LabelTTF(
        i18next.t('rank.bonus_chevrons_message'),
        RSX.font_regular.name,
        32,
        cc.size(1200, 34),
        cc.TEXT_ALIGNMENT_CENTER,
      ...
      this.chevronsBonusLabel.setPosition(
        cc.p(
          centerAnchorPosition.x,
          this.chevronsQuantityLabel.getPositionY() -
            this.chevronsQuantityLabel.getBoundingBox().height * 0.5 -
            this.chevronsBonusLabel.getBoundingBox().height * 0.5 -
            footerDistanceBelowSprite,
        ),
      );
      ...
      this.newSeasonLabel = new cc.LabelTTF(
        i18next.t('rank.season_has_begun_message', {
      ...
      var headerDistanceAboveSprite = 25;
      this.newSeasonLabel.setPosition(
        cc.p(
          centerAnchorPosition.x,
          this.newRankMedalSprite.getPositionY() +
            this.newRankMedalSprite.getBoundingBox().height * 0.5 +
            this.newSeasonLabel.getBoundingBox().height * 0.5 +
            headerDistanceAboveSprite,
        ),
      );
      ...
      // new rank label
      this.newRankLabel = new cc.LabelTTF(
        i18next.t('rank.current_rank_message', {
          rank: GamesManager.getInstance().getCurrentRank(),
        }),
        RSX.font_regular.name,
        32,
        cc.size(1200, 34),
      ...
      var footerDistanceBelowSprite = 25;
      this.newRankLabel.setPosition(
        cc.p(
          centerAnchorPosition.x,
          this.newRankMedalSprite.getPositionY() -
            this.newRankMedalSprite.getBoundingBox().height * 0.5 -
            this.newRankLabel.getBoundingBox().height * 0.5 -
            footerDistanceBelowSprite,
        ),
      );
      ...
      this.runAction(
        cc.sequence(
          ...
          cc.targetedAction(
            this.rankMedalGlowOutlineSprite,
            cc.spawn(
              ...
              cc.callFunc(() => {
                audio_engine
                  .current()
                  .play_effect(RSX.sfx_division_crest_outline_reveal.audio, false);
              }),
            ),
          ),
          cc.spawn(
          ...
          cc.spawn(
            ...
            cc.targetedAction(
              ...
              cc.spawn(
                cc.fadeIn(CONFIG.ANIMATE_MEDIUM_DURATION),
                cc
                  .moveBy(CONFIG.ANIMATE_MEDIUM_DURATION, cc.p(0, 20))
                  .easing(cc.easeCubicActionOut()),
              ),
            ),
            cc.targetedAction(
              this.seasonMonthlabel,
              cc.spawn(
                cc.fadeIn(CONFIG.ANIMATE_MEDIUM_DURATION),
                cc
                  .moveBy(CONFIG.ANIMATE_MEDIUM_DURATION, cc.p(0, 20))
          ...
          cc.callFunc(() => {
            ...
            this.continueNode.setTitleForState(
              i18next.t('common.next_button_label'),
      ...
      cc.sequence(
        ...
        cc.callFunc(() => {
          if (this._willShowLootCrate) {
            ...
            var cleanupAction = cc.sequence(cc.delayTime(CONFIG.ANIMATE_MEDIUM_DURATION));
  ...
  _beginShowLootCrate(cleanupAction) {
    return new Promise<void>((resolve, reject) => {
      ...
      .then(() => this._lootCrateNode.showReveal())
  ...
  _onOpenPressed() {
    ...
    const seasonRewardModelsPromise = GamesManager.getInstance().claimRewardsForSeason(
      this._seasonModel,
    );
  ...
  _animateLootCrate() {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      .then(() => this._lootCrateNode.showOpeningAndRewards())
      .then(() => {
        this.runAction(
          cc.sequence(
            cc.callFunc(() => {
              // update continue button
              this.continueNode.setTitleForState(
                i18next.t('common.done_button_label'),
                cc.CONTROL_STATE_NORMAL,
              );
              this.continueNode.setTitleForState(
                i18next.t('common.done_button_label'),
  ...
  _onDonePressed(cleanupAction) {
    ...
    const lootCratePromise = this._willShowLootCrate
      ? this._lootCrateNode.cleanupLootCrate()
      : Promise.resolve();
