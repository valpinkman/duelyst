...
const EmoteRewardNode = RewardNode.extend({
  ...
  getRequiredResources() {
    ...
    const emoteResources =
      this._emoteId != null
        ? SDK.CosmeticsFactory.cosmeticResourcesForIdentifier(this._emoteId)
        : [];
      ...
      new Promise<void>((resolve) => {
        ...
        if (showLabel) {
          ...
          const labelText = _.isString(showLabel)
            ? showLabel
            : i18next.t('cosmetics.cosmetic_type_emote').toLocaleUpperCase();
                  ...
                  if (looping) {
                    ...
                    emoteSprite.runAction(
                      cc
                        .sequence(
                          cc
                            .rotateTo(CONFIG.ANIMATE_FAST_DURATION * 2.0, 5.0)
